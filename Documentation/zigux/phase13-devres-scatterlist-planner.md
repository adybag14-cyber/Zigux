...
- routes `planManagedScatterlistTableTeardown(...)` through initialized-table, release-record, and mapped-count gating so helper-first `sg_table` free eligibility stays reviewable without claiming live `sg_table` side effects
