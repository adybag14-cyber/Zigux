...
- `zigux/tests/phase13_devres_scatterlist.zig` owns the retained-release-record, freed-release-record, missing-release-record, and exact-release-match fixture coverage for `planManagedScatterlistMap(...)`, `scatterlistReleaseMatches(...)`, and `planManagedScatterlistUnmap(...)`
