...
- helper-owned wording keeps `security/landlock/syscalls.zig` framed as a small planning-only helper rather than as a full syscall-parity implementation
