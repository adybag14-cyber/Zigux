...
- the broader Phase 12 tranche is still anchored by the same three bounded complex-driver starters at current `master` head `573861cbcb0cbe86ee784ddf8642951c223de71c`: `drivers/net/virtio_net.zig`, `drivers/scsi/virtio_scsi.zig`, and `drivers/nvme/host/pci.zig`, so NVMe PCI should keep being compared against peer driver starters rather than against survey scaffolding or unrelated lane churn.
