...
- the broader Phase 12 tranche is still anchored by the same three bounded complex-driver starters at current `master` head `3ddee1c99d39505dfe37e8aed0d2c259e6fdfd55`: `drivers/net/virtio_net.zig`, `drivers/scsi/virtio_scsi.zig`, and `drivers/nvme/host/pci.zig`, so NVMe PCI should keep being compared against peer driver starters rather than against survey scaffolding or unrelated lane churn.
