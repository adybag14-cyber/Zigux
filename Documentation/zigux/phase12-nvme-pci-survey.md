...
- the broader Phase 12 tranche was last surveyed at `master` snapshot `94d501c6a1e23dedfb31d2cc7da8b7a388f63ceb`, where the same three bounded complex-driver starters were already present: `drivers/net/virtio_net.zig`, `drivers/scsi/virtio_scsi.zig`, and `drivers/nvme/host/pci.zig`, so NVMe PCI should keep being compared against peer driver starters rather than against survey scaffolding or unrelated lane churn.
