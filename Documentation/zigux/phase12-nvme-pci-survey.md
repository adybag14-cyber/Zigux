...
- `PHASE12_SURVEYED_COMMIT=3335e835a788c6977d58197bc96232f38751fd26`
...
- current `master` snapshot `3335e835a788c6977d58197bc96232f38751fd26` passed the shared Phase 12 replay with `Build Summary: 17/17 steps succeeded; 51/51 tests passed`, including `phase12-nvme-pci-tests 9 pass (9 total)` and `phase12-nvme-pci-survey-tests 1 pass (1 total)`.
