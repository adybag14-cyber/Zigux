...
- do not claim live GPIO descriptor lookup, `watchdog_set_drvdata()` execution, watchdog-core registration, reboot integration, or hardware-backed execution until the Zig surface and tests for those behaviors exist
