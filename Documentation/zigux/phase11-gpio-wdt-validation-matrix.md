...
- which remaining descriptor, platform-registration, and reboot blockers are already explicit as a parked failure summary rather than implied by the request surface alone
...
- keep the explicit remaining blocker surface tied to the parked request boundary until a real descriptor-backed or reboot-glue widening exists
