...
Current repo rereads for this contributor lane rematerialize the directly readable bcm2835, gpio, HVC, and DesignWare driver-local Phase 11 validation matrices on current `master`: `Documentation/zigux/phase11-bcm2835-wdt-validation-matrix.md`, `Documentation/zigux/phase11-gpio-wdt-validation-matrix.md`, `Documentation/zigux/phase11-hvc-console-validation-matrix.md`, and `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`. Keep those four returned driver-local matrix notes explicit while treating the DesignWare validation-matrix note as direct current-head evidence alongside the returned DesignWare owner packet and the narrower HVC continuity packet as adjacent shared evidence.
...
- keep the validation-matrix gap survey, the returned bcm2835, gpio, HVC, and DesignWare driver-local matrix notes, the current DesignWare owner packet with its returned validation-matrix note, and the narrower HVC continuity build inventory aligned with the direct readback boundary without using that broader reminder packet to overclaim shared replay or live platform-backed execution
