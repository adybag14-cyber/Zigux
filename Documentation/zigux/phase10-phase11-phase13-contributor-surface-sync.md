...
- keep `zigux/tests/README.md` framed as the next broader shared-surface follow-through for Phase 13 rather than as independently shipped packet evidence until current `master` materializes a dedicated tests-root Phase 13 summary there
