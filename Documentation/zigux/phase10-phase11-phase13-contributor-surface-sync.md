...
Current direct contents reads in this contributor lane do not rematerialize `Documentation/zigux/phase11-bcm2835-wdt-validation-matrix.md` or `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`, so keep those two driver-local matrix note paths framed as repo-reality gaps while `Documentation/zigux/phase11-gpio-wdt-validation-matrix.md` and `Documentation/zigux/phase11-hvc-console-validation-matrix.md` remain the directly readable driver-local Phase 11 matrix notes on current `master`.
