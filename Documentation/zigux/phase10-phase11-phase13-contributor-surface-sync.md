...
- keep the validation-matrix gap survey authoritative for the returned four-matrix driver-local packet together with the narrower HVC continuity build inventory, without using that broader matrix packet to overclaim shared replay or live platform-backed execution
