...
- unpacking `agent_files/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc (1).tar.xz` into `/workspace/.toolchains/p14-l10/` succeeded without extra environment overrides
- `/workspace/.toolchains/p14-l10/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig version` returned `0.17.0-dev.877+a3ae499dc`
- `/workspace/.toolchains/p14-l10/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig env` reported `.lib_dir = ".toolchains/p14-l10/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/lib"`, `.global_cache_dir = "/root/.cache/zig"`, `.version = "0.17.0-dev.877+a3ae499dc"`, and `.target = "x86_64-linux.6.12.47...6.12.47-gnu.2.39"`
...
- `/workspace/.toolchains/p14-l12/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig version` returned `0.17.0-dev.877+a3ae499dc`
- `/workspace/.toolchains/p14-l12/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig env` reported `.zig_exe = "/workspace/.toolchains/p14-l12/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig"`, `.lib_dir = ".toolchains/p14-l12/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/lib"`, `.std_dir = ".toolchains/p14-l12/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/lib/std"`, `.global_cache_dir = "/root/.cache/zig"`, and `.version = "0.17.0-dev.877+a3ae499dc"`
