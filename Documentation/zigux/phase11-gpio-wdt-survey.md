...
- `Documentation/zigux/phase11-gpio-wdt-validation-matrix.md` now records the bounded validation posture for the landed starter, the drvdata checkpoint, the register-device request surface, and the still-deferred kernel-facing follow-up
