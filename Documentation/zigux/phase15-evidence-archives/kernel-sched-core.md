...
- reopen triggers:
  - a narrower scheduler seam inventory exists and answers `blocked_no_bounded_scheduler_seam`
  - linked validation, benchmark, or blocker evidence becomes stale or contradictory
