...
Treat the shared `zigux/tests/phase9_build.zig` bitmap route names as rerun handles for the visible sample, survey, and top-bit packet only while the loader, module, diff, and manifest surfaces stay absent on the trusted path; they do not prove the broader shared runtime-loader packet returned.
