...
7. `zig build phase9-runtime-bitmap-top-bit-tests --build-file zigux/tests/phase9_build.zig`
8. `zig build phase9-runtime-bitmap-tests --build-file zigux/tests/phase9_build.zig`
