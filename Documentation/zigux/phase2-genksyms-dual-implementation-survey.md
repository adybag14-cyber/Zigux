...
- `scripts/zigux/check-phase2-genksyms-survey-alignment.py` now fail-closes the survey note against the current helper, checker, expanded fixture packet, workflow, make-wrapper, and validator packet without widening into parser behavior or closure-note churn.
