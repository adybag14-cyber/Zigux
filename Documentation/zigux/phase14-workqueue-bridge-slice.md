...
- the delayed-work timer expiry, timer rearm, CPU affinity, and immediate requeue fallthrough stay explicitly in C through the delayed-work governance packet.
