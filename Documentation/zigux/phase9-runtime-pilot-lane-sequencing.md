...
2. Do not borrow a pilot-family note as substitute proof that the shared loader lane is healthy when the shared loader-facing files themselves drift or disappear.
