...
2. bitmap lane: next if the goal is to refine the already-landed top-bit or bitmap-specific replay packet
3. atomic64, trace-events, or kretprobe lanes: only when the change stays inside that family’s sample, loader, module, diff, or survey evidence
