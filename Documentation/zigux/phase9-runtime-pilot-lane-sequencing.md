...
- surviving companion boundary inside the same narrow packet: the unregistered function-thread fail-closed replay in `samples/zigux/runtime_trace_events_unregistered_gate.zig` plus its initialized-before/after and selftest_complete-before/after summary-stability checks around those rejected function-thread calls
