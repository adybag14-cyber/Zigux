...
Current repo reality for this lane is intentionally narrow:
  ...
  * `scripts/zigux/check-phase13-devres-packet-alignment.py` remains the shipped lane-local checker name, but its paired survey, manifest, and direct replay packet are not fully materialized in this checkout
