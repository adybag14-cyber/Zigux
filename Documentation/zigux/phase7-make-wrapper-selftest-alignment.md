...
Fresh repo inspection now shows the older docs-root, tests-root, samples-root, and scripts-root follow-through is already complete: `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, `samples/zigux/README.md`, `scripts/zigux/README.md`, and the dedicated alignment checker already keep this note plus the full `make -C zigux phase7-validate` and `make -C zigux phase7` review route explicit inside the parked Phase 7 packet. Keep this lane parked unless a concrete new Phase 7 parity or shared-surface gap appears; if the packet reopens, prefer one tiny note, checker, validator, or manifest truthfulness repair before widening into helper code or fixture churn.
