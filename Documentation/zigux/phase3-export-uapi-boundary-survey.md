...
- `PHASE3_UAPI_VERSION_BLOB_SHA=41bce8e7df659608dabb212a7b03a29758cd882d`
...
- `PHASE3_ABI_SLICE_DOC_BLOB_SHA=fef84848fad670e3be0cc6397609199ab108ba37`
...
- `zigux/kernel/export_shim.zig` now re-exports that same named arbitrary-version boundary replay helper through `versionedHeader(size, version, flags)` alongside the existing header-compatibility helpers, so callers can keep version-mismatch probes reviewable without falling back to ad hoc struct literals
