...
- `PHASE3_SURVEYED_COMMIT=9c18c890275eb9d9a51fed80077fe11cf0b6c2af`
...
This survey is pinned to verified `master` head `9c18c890275eb9d9a51fed80077fe11cf0b6c2af` for the directly coupled export/UAPI packet, so the note stays tied to one inspected boundary snapshot instead of a floating branch label.
