...
- `PHASE3_EXPORT_SHIM_BLOB_SHA=eb4ce0294706bfb051979e17487c81d242ebc032`
...
- `PHASE3_UAPI_VERSION_BLOB_SHA=22d74363a523d1797f3796ffe8aef4b5bb1ce9ac`
...
- `PHASE3_EXPORT_UAPI_TEST_BLOB_SHA=2197da45ad56317be19e975857212676c3d6fb36`
...
- `zigux/kernel/export_shim.zig` exposes explicit `canonicalHeader`, `header`, `ok`, `errno`, `isOk`, `normalize`, `isCompatibleHeader`, and `isCanonicalHeader` helpers around the curated `ExportStatus` and `BoundaryHeader` ABI types
