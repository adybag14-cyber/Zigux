...
- `scripts\zigux/check_phase13_devres_dmam_alloc_coherent_planner.zig` is the packet-local fail-closed checker and should stay aligned with the helper, planner note, manifest, and replay
