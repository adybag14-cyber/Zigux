...
- shared control-surface packet, lane `P7-Y05`:
  ...
  - parked shared reminder path: `scripts\zigux/check_phase7_make_wrapper.zig`
...
- cmdline packet, lane `P7-L08`:
  ...
  - scheduled maintenance note: recurring scheduled lane `P7-L10` is same-family cmdline cleanup follow-through; keep cmdline-local review-noise, survey-build-checker-manifest drift, and the no-sample boundary narrowed to the cmdline-focused section of this sequencing note, `Documentation/zigux/phase7-cmdline-slice.md`, `zigux/tests/phase7_cmdline_survey.zig`, `zigux/tests/phase7_cmdline_manifest.json`, `zigux/tests/phase7_cmdline_survey_build.zig`, `scripts\zigux/check_phase7_cmdline_packet.zig`, or `samples/zigux/README.md` instead of treating that lane as a second helper owner or shared-control drift
...
- `P7-L09` owns only argv-split helper-local parity, survey, manifest, fixture, checker, or reminder drift; because the current slot could directly reread `Documentation/zigux/phase7-argv-split-slice.md`, `lib/argv_split.zig`, `zigux/tests/phase7_argv_split.zig`, `zigux/tests/phase7_argv_split_survey.zig`, `zigux/tests/phase7_argv_split_manifest.json`, `zigux/tests/fixtures/phase7_argv_split_vectors.zig`, and `scripts\zigux/check_phase7_argv_split_packet.zig`, keep same-lane work inside those returned surfaces.
- `P7-L08` owns only cmdline helper-local parity, survey, manifest, checker, or reminder drift; because the current slot could directly reread `Documentation/zigux/phase7-cmdline-slice.md`, `lib/cmdline.zig`, `zigux/tests/phase7_cmdline.zig`, `zigux/tests/phase7_cmdline_survey.zig`, `zigux/tests/phase7_cmdline_manifest.json`, `zigux/tests/phase7_cmdline_survey_build.zig`, `scripts\zigux/check_phase7_cmdline_packet.zig`, and the cmdline no-sample boundary in `samples/zigux/README.md`, keep same-lane work inside those returned surfaces.
- Treat recurring lane `P7-L10` as same-family cmdline cleanup follow-through, not as a second helper owner; keep it narrowed to the cmdline-focused section of `Documentation/zigux/phase7-helper-lane-sequencing.md`, `Documentation/zigux/phase7-cmdline-slice.md`, `zigux/tests/phase7_cmdline_survey.zig`, `zigux/tests/phase7_cmdline_manifest.json`, `zigux/tests/phase7_cmdline_survey_build.zig`, `scripts\zigux/check_phase7_cmdline_packet.zig`, or the no-sample boundary in `samples/zigux/README.md` when helper-local review-noise or truthfulness drift reopens.
- `P7-L13` owns only rbtree slice-note, direct-anchor-note, runtime-root helper, dedicated replay, survey, manifest, parity-checker, JSON fixture, C-harness, or missing-wrapper reminder drift; because the current slot could directly reread `Documentation/zigux/phase7-rbtree-slice.md`, `Documentation/zigux/phase7-rbtree-direct-anchor-note.md`, `scripts\zigux/check_phase7_rbtree_parity.zig`, `lib/rbtree.zig`, `zigux/tests/phase7_rbtree.zig`, `zigux/tests/phase7_rbtree_survey.zig`, `zigux/tests/phase7_rbtree_manifest.json`, `zigux/tests/fixtures/phase7_rbtree.json`, and `zigux/tests/fixtures/phase7_rbtree_c_harness.c` while `tools/lib/rbtree.zig` remains readable only as legacy non-owner companion evidence, keep same-lane work inside that returned helper-local packet and keep the legacy companion plus broader shared-control routes framed as non-owner vocabulary.
...
- If the drift is a string_helpers helper-local surface, keep the change inside `Documentation/zigux/phase7-string-helpers-slice.md`, `lib/string_helpers.zig`, `zigux/tests/phase7_string_helpers.zig`, `zigux/tests/phase7_string_helpers_survey.zig`, `zigux/tests/phase7_string_helpers_manifest.json`, `zigux/tests/phase7_string_helpers_sample_boundary.zig`, or `scripts\zigux/check_phase7_string_helpers_packet.zig`; treat recurring helper-local lane `P7-Y01` as same-family follow-through inside that one packet rather than as a separate helper family, and route shared validator, Makefile, workflow, docs-root, tests-root, sample-root, and shared-build reminders back to `P7-Y05`.
- If the drift is a partially returned `argv_split` surface, keep the change inside `Documentation/zigux/phase7-argv-split-slice.md`, `lib/argv_split.zig`, `zigux/tests/phase7_argv_split.zig`, `zigux/tests/phase7_argv_split_survey.zig`, `zigux/tests/phase7_argv_split_manifest.json`, `zigux/tests/fixtures/phase7_argv_split_vectors.zig`, or `scripts\zigux/check_phase7_argv_split_packet.zig` while the helper-local packet stays the lane owner.
- If the drift is a partially returned `cmdline` surface, keep the change inside the cmdline-focused section of `Documentation/zigux/phase7-helper-lane-sequencing.md`, `Documentation/zigux/phase7-cmdline-slice.md`, `lib/cmdline.zig`, `zigux/tests/phase7_cmdline.zig`, `zigux/tests/phase7_cmdline_survey.zig`, `zigux/tests/phase7_cmdline_manifest.json`, `zigux/tests/phase7_cmdline_survey_build.zig`, `scripts\zigux/check_phase7_cmdline_packet.zig`, or `samples/zigux/README.md` while the helper-local packet stays the lane owner.
- If the drift is the current `rbtree` helper-local packet, keep the change inside `Documentation/zigux/phase7-rbtree-slice.md`, `Documentation/zigux/phase7-rbtree-direct-anchor-note.md`, `scripts\zigux/check_phase7_rbtree_parity.zig`, `lib/rbtree.zig`, `zigux/tests/phase7_rbtree.zig`, `zigux/tests/phase7_rbtree_survey.zig`, `zigux/tests/phase7_rbtree_manifest.json`, `zigux/tests/fixtures/phase7_rbtree.json`, or `zigux/tests/fixtures/phase7_rbtree_c_harness.c` while `tools/lib/rbtree.zig` stays the readable legacy non-owner companion; route broader shared validator, Makefile, workflow, or build-route drift back to `P7-Y05`.
