...
- those Linux-style Phase 2 validator and replay routes keep the dedicated note tied to the same kbuild-facing surface named by the shared validators, the closure note, and the shared review checklist
