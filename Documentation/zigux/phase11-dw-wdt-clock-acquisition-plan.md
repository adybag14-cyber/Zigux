...
- no claim that the broader direct driver, verify-helper, driver-test, slice, or teardown-note stack has returned on this direct contents bridge without a fresh reread
