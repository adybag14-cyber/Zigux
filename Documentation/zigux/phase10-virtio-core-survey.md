...
- the live manifest records lane `P10-L01`, surveyed commit `c11221dc7a68d7511ae1c69d64b3f08528287ed8`, roadmap destinations `drivers/virtio/*.zig`, `zigux/kernel/`, and `zigux/helpers/`, `preexisting_phase10_test_files: 11`, and a current starter packet that explicitly names `phase10-driver-id-helper`, `phase10-driver-id-coverage-disposition-helper`, `phase10-lifecycle-guard-bookkeeping-helper`, `phase10-reset-replay-bookkeeping-helper`, `phase10-core-lab-validation-evidence`, `phase10-interrupt-compound-ack-gate`, `phase10-core-slice-note`, `phase10-virtio-core-survey-gate`, and `phase10-virtio-core-survey-note`
