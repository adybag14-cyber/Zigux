...
- `zigux/kernel/export_shim.zig` keeps the export status surface explicit
...
Those slices are real repo state, but they should not be confused with closure of the original roadmap anchors.
