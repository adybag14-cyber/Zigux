...
- first, reread `scripts/zigux/README.md`, `zigux/tests/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/check-phase11-shared-replay-contract.py` together, starting with `zigux/tests/README.md` still summarizing the shared Phase 11 support packet without the dedicated `scripts/zigux/check-phase11-dw-wdt-packet.py` archival route even though `Documentation/zigux/phase11-shared-replay-contract.md`, `Documentation/zigux/phase11-dw-wdt-survey.md`, and `scripts/zigux/README.md` already keep that DesignWare checker explicit, so the shared Phase 11 support packet keeps the parked gpio, bcm2835, DesignWare, HVC, and header-boundary companions truthful across tests-root, scripts-root, checklist, and checker-local wording
