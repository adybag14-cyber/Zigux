...
This note keeps the shared Phase 2 closure packet parked while making the current `genksyms` evidence explicit and replayable from directly readable `master` surfaces.
