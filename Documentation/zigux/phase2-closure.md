...
This note keeps the current Phase 2 closure-side packet aligned to the directly readable toolchain, local-first archive, installer, cross-route, kconfig-bridge, helper-local allconfig guard, closure-side tests-root summary and gap guards, genksyms bridge, fixdep, make-wrapper, manifest-guard, and validator surfaces on current `master`.
...
- `scripts/zigux/check-phase2-tests-root-summary-route-gap.py`
- `scripts/zigux/check-phase2-closure-validator-gap.py`
...
- `python3 scripts/zigux/check-phase2-tests-root-summary-route-gap.py --self-test`
- `python3 scripts/zigux/check-phase2-tests-root-summary-route-gap.py`
- `python3 scripts/zigux/check-phase2-closure-validator-gap.py --self-test`
- `python3 scripts/zigux/check-phase2-closure-validator-gap.py`
