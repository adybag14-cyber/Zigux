...
- `PHASE2_GENKSYMS_BRIDGE_CASES=minimal,debug_reference_types,long_options,abbreviated_long_options,ambiguous_long_option,quiet_overrides_warning,explicit_option_terminator,positional_passthrough,lone_dash_passthrough,help,version_then_short_help,version_then_long_help,version_then_invalid_option,abbreviated_help,unexpected_help_argument,version,abbreviated_version,invalid_option,missing_reference_argument,missing_dump_types_argument,unsupported_long_option,missing_long_reference_argument,missing_long_dump_types_argument,too_many_reference_files`
...
- `PHASE2_GENKSYMS_BRIDGE_PROCESS_PACKET=ambiguous_long_option_expected.json,help_expected.json,version_then_help_expected.json,version_then_invalid_option_expected.json,unexpected_help_argument_expected.json,version_expected.json,abbreviated_version_expected.json,invalid_option_expected.json,missing_reference_argument_expected.json,missing_dump_types_argument_expected.json,unsupported_long_option_expected.json,missing_long_reference_argument_expected.json,missing_long_dump_types_argument_expected.json,too_many_reference_files_expected.json`
- `PHASE2_GENKSYMS_BRIDGE_NORMALIZED_STDERR_PACKET=ambiguous_long_option_expected.json,version_then_invalid_option_expected.json,unexpected_help_argument_expected.json,invalid_option_expected.json,missing_reference_argument_expected.json,missing_dump_types_argument_expected.json,unsupported_long_option_expected.json,missing_long_reference_argument_expected.json,missing_long_dump_types_argument_expected.json,too_many_reference_files_expected.json`
...
- bridge-process coverage stays anchored by the ambiguous-long-option fixture, the help, version-then-help, version-then-invalid-option, and abbreviated-help fixtures, the unexpected-help-argument failure fixture, the version side-effect fixtures including `abbreviated_version_expected.json`, and the normalized invalid-option, missing-reference-argument, missing-dump-types-argument, and too-many-reference error fixtures in the same bounded packet
