...
- config-write plan freshness, planning, and disposition stay planning-only and keep the config window unchanged while surfacing generation drift and byte-level deltas
