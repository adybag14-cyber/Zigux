...
- the broader Phase 15 governance family now includes `Documentation/zigux/freeze-map.md`, `Documentation/zigux/phase15-freeze-map-governance.md`, `Documentation/zigux/phase15-architecture-council-review-process.md`, `Documentation/zigux/phase15-parity-scorecard-survey.md`, `Documentation/zigux/phase15-parity-scorecard.md`, `Documentation/zigux/phase15-indefinite-c-policy.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, `Documentation/zigux/phase15-readiness-gate-survey.md`, and `Documentation/zigux/phase15-governance-lane-sequencing.md`, and the shared-summary follow-through for the parity-scorecard-survey reminder now belongs to the checker-backed `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/README.md` packet instead of a stale docs-root-closed or tests-root-underflow assumption.
- current `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/README.md` now keep the parity-scorecard-survey reminder, readiness and handoff notes, governance-sequencing note, and shipped `make -C zigux phase15-validate` plus `make -C zigux phase15-test` routes explicit on `master`, so the shared-summary lane is parked again unless a fresh reread opens a new docs-root, checklist, or scripts-root truthfulness gap.
...
- the live machine-readable parity-scorecard companion inside that same parked governance packet is `zigux/tests/phase15_parity_scorecard.json`, while `zigux/tests/phase15_parity_scorecard.zig` remains the shipped direct Zig replay surface for the dedicated parity-scorecard packet.
...
- any future shared-summary follow-through should now be read through `scripts/zigux/check-phase15-shared-summary-gap.py`: if a fresh reread reopens docs-root, checklist, or scripts-root drift, that checker-backed reminder packet owns the first repair while `zigux/tests/README.md` stays scoped to the sequencing-marker plus replay-route packet instead of a duplicate parity-scorecard-survey reminder.
...
- `shared-summaries` owns `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md`; current `master` keeps the docs-root, checklist, and scripts-root Phase 15 shared-summary packet aligned with the parity-scorecard-survey, readiness, handoff, governance-sequencing, and validator-route markers, so `shared-summaries` should stay parked unless a fresh reread opens a docs-root, checklist, or scripts-root truthfulness gap, while `zigux/tests/README.md` stays governed by the sequencing-marker plus replay-route packet instead of duplicate packet-local docs reminders.
...
- `parity-scorecard` owns `Documentation/zigux/phase15-parity-scorecard.md`, `zigux/tests/phase15_parity_scorecard.json`, and `zigux/tests/phase15_parity_scorecard.zig`; this handoff lane should not consume blocker-evidence or aggregate-metric repairs.
