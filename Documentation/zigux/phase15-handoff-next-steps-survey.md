...
- the current handoff summary now keeps the parked governance owner-map and blocker-evidence replays explicit beside the validator-first route instead of leaving them implicit in adjacent notes and tests-root guidance
