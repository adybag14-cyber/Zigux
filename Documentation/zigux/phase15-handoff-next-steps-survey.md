...
- current `master` keeps the fuller readiness, handoff, sequencing, validator-route, and manifest reminder set explicit in `Documentation/zigux/README.md`, `scripts/zigux/README.md`, and `Documentation/zigux/phase15-governance-lane-sequencing.md`; `Documentation/zigux/review-checklist.md` remains part of that shared-summary packet as the reviewer-facing governance gate rather than the most exhaustive reminder surface.
