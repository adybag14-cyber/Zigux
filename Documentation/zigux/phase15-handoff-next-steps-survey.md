...
- the broader Phase 15 governance family now includes `Documentation/zigux/freeze-map.md`, `Documentation/zigux/phase15-freeze-map-governance.md`, `Documentation/zigux/phase15-architecture-council-review-process.md`, `Documentation/zigux/phase15-parity-scorecard-survey.md`, `Documentation/zigux/phase15-parity-scorecard.md`, `Documentation/zigux/phase15-indefinite-c-policy.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, `Documentation/zigux/phase15-readiness-gate-survey.md`, `Documentation/zigux/phase15-governance-lane-sequencing.md`, `Documentation/zigux/review-checklist.md`, and the shared-summary follow-through for the parity-scorecard-survey reminder now belongs to the checker-backed `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/README.md` packet instead of a stale docs-root-closed or tests-root-underflow assumption.
...
- the older docs-root and validator-inventory drift is closed on current `master`, but the scripts-root `phase15-validate` route sentence still undercounts the shipped validator-first route: `zigux/Makefile`, `.github/workflows/zigux-bootstrap.yml`, and `scripts/zigux/validate-phase15.py` rerun `check-phase15-docs-readme-alignment.py`, `check-phase15-scripts-readme-alignment.py`, `check-phase15-review-process-handoff.py`, and `check-phase15-shared-summary-gap.py`, while `scripts/zigux/README.md` still describes only `validate-phase15.py`, `check-phase15-scripts-readme-alignment.py`, and `check-phase15-review-process-handoff.py` inside `phase15-validate`.
- remaining shared-summary follow-through should now be read through `scripts/zigux/check-phase15-shared-summary-gap.py`: the checker-backed reminder packet owns whether `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, or `scripts/zigux/README.md` still undercounts `Documentation/zigux/phase15-parity-scorecard-survey.md`, while `zigux/tests/README.md` stays scoped to the sequencing-marker plus replay-route packet instead of duplicating that survey reminder. On current `master`, the reopened shared-summary drift is already narrowed to the scripts-root `phase15-validate` route sentence in `scripts/zigux/README.md`, while `Documentation/zigux/README.md` and `Documentation/zigux/review-checklist.md` remain aligned.
- current `master` keeps the fuller readiness, handoff, sequencing, validator-route, and manifest reminder set explicit in `Documentation/zigux/README.md` and `Documentation/zigux/phase15-governance-lane-sequencing.md`; `scripts/zigux/README.md` remains part of that shared-summary packet, but its `phase15-validate` route sentence is still the first bounded repair, while `Documentation/zigux/review-checklist.md` remains the reviewer-facing governance gate rather than the most exhaustive reminder surface.
