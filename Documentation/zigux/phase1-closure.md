...
- `tools/lib/rbtree.zig` direct Zig unit coverage also keeps `find` and `findFirst` lookup behavior aligned, including the leftmost duplicate match for equal keys.
