...
Without this matrix, the slice, survey, manifest, shared review surfaces, dedicated teardown companion, and new platform scaffold summary would not agree on how far the current starter goes before real clock, reset, IRQ, and MMIO work begins.
