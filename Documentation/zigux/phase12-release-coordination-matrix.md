...
- adjacent shared support companions: `scripts/zigux/check-build-only-phase12-surface.py` and `scripts/zigux/check-phase12-virtio-scsi-libbpf-boundary.py` stay explicit beside that validator-first bundle so the compact PMO summary does not undercount the current shared support packet
