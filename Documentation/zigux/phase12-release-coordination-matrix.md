...
| `tools/lib/bpf/libbpf.c` | BPF Tooling Lane | `Documentation/zigux/phase12-libbpf-segment-survey.md`, `Documentation/zigux/phase12-libbpf-heavy-consumer-lane-sequencing.md` (parked shared-helper survey plus anti-overlap map with landed bridge-local helper foundations kept separate from deferred bridge and object-model work) |
