...
- survey checkpoint: refreshed against inspected `master` head `47f4f5c4f7d86eedc339c541326249cf76d7bbc8`
- product boundary:
...
- provenance and anchor alignment rechecked against inspected `master` head `47f4f5c4f7d86eedc339c541326249cf76d7bbc8`
- focused Zig replay rerun against inspected `master` head `47f4f5c4f7d86eedc339c541326249cf76d7bbc8`
- `zig test zigux/tests/phase8_libbpf_segments.zig`
...
- `zig build test --build-file zigux/tests/phase8_build.zig --summary all`
  - `Build Summary: 22/22 steps succeeded; 73/73 tests passed`
