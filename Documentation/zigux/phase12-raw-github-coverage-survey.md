...
- exact coverage evidence checked on `2026-05-23`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `33f168540ef5f2a7070346528b0f50ad85ae231c`, `scripts/zigux/check-phase12-complex-driver-lane-packet.py` at blob `50bc5556cacfee94371397a210722294711a7a4f`, `scripts/zigux/check-phase12-libbpf-snapshot.py` at blob `1417191a6c6b82e1735c83ce759c5c63224b952f`, `scripts/zigux/check-phase12-libbpf-heavy-consumer-packet.py` at blob `846d84e18f331c0998a0617fadc992851de5280d`, `scripts/zigux/validate-phase12.py` at blob `f69c00ef6b5e57244bfd482a6822ba2d539c1a5d`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `7d71496958979ad108eb6eed0cc6776d21868312`, `.github/workflows/zigux-bootstrap.yml` at blob `5d07f69d341f667c96f59a26cd6957870c54997f`, `scripts/zigux/README.md` at blob `6115d6f087f461d4a2aaa77b528815f7e6c6a970`, `zigux/Makefile` at blob `0c742bb7e78aa97a19edb4a5749666e765675173`, and `zigux/tests/phase12_build.zig` at blob `c338d24f4d12317c6a58d25708bbc14a5006852c`
- exact runtime-reality evidence checked on `2026-05-23`: the raw-URL-backed direct replay catalog, the current-master NVMe gap-note companion, the contents-bridge-backed build-only anchor pair, and the contents-bridge-backed shared support bundle are distinct evidence states in this runtime, so keep the mixed fallback story explicit instead of flattening the direct replay catalog, the driver-local gap-note companion, the directly readable build-only pair, or the broader shared support packet into one proof class
