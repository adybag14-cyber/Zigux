...
- exact coverage evidence checked on `2026-05-18`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `bd07243aa47ed7367141e3d859d40e2f6dc52d5d`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `2f294e4309410407d840fe3bf527dc27b0f09a61`, `.github/workflows/zigux-bootstrap.yml` at blob `ba2cafb068ad3277fb70069e3049d3126dfdc541`, `scripts/zigux/README.md` at blob `959324875cf07bfd66c03d892ed3e91f9e3e562e`, and `zigux/Makefile` at blob `ffba748161a322c86ec8f935c98c845635d87631`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
