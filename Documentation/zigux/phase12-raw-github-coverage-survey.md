...
- exact coverage evidence checked on `2026-05-21`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `81a71a9bfe2c263120ea102d8b9cf361121c472a`, `scripts/zigux/validate-phase12.py` at blob `385ddd9dae8b7aa28a7f7e8c93803d125cc20d2c`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `307db8913794a368fc65eec047fb36e0d079eda9`, `.github/workflows/zigux-bootstrap.yml` at blob `d33dbde416395f8d7cd0e79da73d90b6e5dea3bb`, `scripts/zigux/README.md` at blob `45657b4fcccb26e0dcaebc2de6cf3abccdf93539`, `zigux/Makefile` at blob `001155e688ededb7cbf96c814741cd4dc2867f64`, and `zigux/tests/phase12_build.zig` at blob `c338d24f4d12317c6a58d25708bbc14a5006852c`
