...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `02921b02d9013b0b144119d7fcfff6c0bd27ebce`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `f4b3825f62744583e897a2e633728df6a0349234`, `.github/workflows/zigux-bootstrap.yml` at blob `851338ecd643e0b77328c0a7aabe6f322b28461c`, `scripts/zigux/README.md` at blob `4593e99eef3fb1af7353e507a71d061761057647`, and `zigux/Makefile` at blob `15f46b4a69e0ecec55985da900705f8a85f7f5c0`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
