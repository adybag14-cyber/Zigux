...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `75d44841a129095c19be3c0a58159a40f428d8f6`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `c4642b474e2d980cd4ad56399b85e97d6e39fe6d`, `.github/workflows/zigux-bootstrap.yml` at blob `851338ecd643e0b77328c0a7aabe6f322b28461c`, `scripts/zigux/README.md` at blob `e5249636d5538dcd5aed9061238bb0a4f187f063`, and `zigux/Makefile` at blob `118a0f8938865553eaaa1c73678e7aa854ec0310`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
