...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `fe5ac6f0b9774f40141d61c87ee9a0852a586da7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `0cb4f670107c0f6cefae9a0c57a679b2c7858416`, `.github/workflows/zigux-bootstrap.yml` at blob `570cf8ff2bbd21b83af0f327afad73cf651d417b`, and `scripts/zigux/README.md` at blob `09fb3cdd32877f5addddfe695298cc52433f50fa`, while direct contents reads for `zigux/tests/phase12_build.zig` and `zigux/Makefile` still return 404 through the same current `master` bridge
