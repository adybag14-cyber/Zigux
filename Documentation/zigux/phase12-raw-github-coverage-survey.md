...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `fd56457fe5a3c754fcb716b279c22af618e92f1b`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `6dc8df18c5fb7de4887b6a4d8a3bc6fd46647e76`, `.github/workflows/zigux-bootstrap.yml` at blob `b6eb42a392a27fe1c0bbbf1a39c35104882b4796`, `scripts/zigux/README.md` at blob `e736c3f0446e7e90ee6edadd881672090167f09b`, and `zigux/Makefile` at blob `93aebf412639ccc1122a74b87201f57f6e7bfc99`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
