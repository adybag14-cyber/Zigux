...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `0f229c4e656b17b88e572e7ab2de9af0c2d67215`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `79c784a93e5c48f00038bba98bde17863bdbfd6a`, `.github/workflows/zigux-bootstrap.yml` at blob `fc494ca282347e892eb769957abd3e84504c4bc9`, `scripts/zigux/README.md` at blob `09a4af487ffb9d4891c786e565f3d680a8843c25`, and `zigux/Makefile` at blob `9dc9ce36c2a3bb1eee2ecc3b8084576a003e1577`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
