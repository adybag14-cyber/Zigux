...
- exact coverage evidence checked on `2026-05-18`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `bd07243aa47ed7367141e3d859d40e2f6dc52d5d`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `2f294e4309410407d840fe3bf527dc27b0f09a61`, `.github/workflows/zigux-bootstrap.yml` at blob `1edcf70701ab7ffa783f7d87bb1981563b2d028b`, `scripts/zigux/README.md` at blob `3e863f0e7cc509199c633c09c9fca89508634848`, and `zigux/Makefile` at blob `1f0f59365360b7ca9f0125ca3e2d59a364e3978c`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
