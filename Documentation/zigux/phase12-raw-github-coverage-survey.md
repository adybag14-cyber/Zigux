...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `fe5ac6f0b9774f40141d61c87ee9a0852a586da7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `79015a085435644ec7052e05b2ddc13641122b37`, `.github/workflows/zigux-bootstrap.yml` at blob `b0b486678803a8240857ab5c9691cb0bd0346a22`, and `scripts/zigux/README.md` at blob `b48d3817ea098d8f48ffd087be735f6d5bae2049`, while direct contents reads for `zigux/tests/phase12_build.zig` and `zigux/Makefile` still return 404 through the same current `master` bridge
