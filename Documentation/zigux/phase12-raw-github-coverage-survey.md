...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `fe5ac6f0b9774f40141d61c87ee9a0852a586da7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `a0b138d22368be59b5b4b7b74864429e22a273a6`, `.github/workflows/zigux-bootstrap.yml` at blob `614e26e1a98497d9486d2fa707492c20b5451bc7`, and `scripts/zigux/README.md` at blob `5d5ac6f2773ea174489eb5b44b5f17f94e6aef14`, while direct contents reads for `zigux/tests/phase12_build.zig` and `zigux/Makefile` still return 404 through the same current `master` bridge
