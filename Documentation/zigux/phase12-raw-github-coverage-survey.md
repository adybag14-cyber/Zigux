...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `eedbceffa6a2b25f7babbfa26613a97e32c2e718`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `eef5c17189b4172566c8463ecaac07279632d94f`, `.github/workflows/zigux-bootstrap.yml` at blob `4528840fbf4753432ca6dce332a2ca5836b07b20`, `scripts/zigux/README.md` at blob `a2a363613107adaa66e5ae7e25a18c7b01487abf`, and `zigux/Makefile` at blob `93aebf412639ccc1122a74b87201f57f6e7bfc99`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
