...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `5603edf89a320933da023716cae7d4eddb507433`, `.github/workflows/zigux-bootstrap.yml` at blob `c60ab4828befd575b5b5a9b4e71ece52d5e7b62d`, and `scripts/zigux/README.md` at blob `0407e9f700718626393e2099b0251cedce21c45a`, while direct contents reads for `zigux/tests/phase12_build.zig`, `zigux/Makefile`, and `scripts/zigux/check-phase12-release-readiness-packet.py` still return 404 through the same current `master` bridge
