...
- exact coverage evidence checked on `2026-05-13`: the current-master NVMe gap-inventory companion is currently present on `master` as `Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md` at blob `43d5f7699143534b7c39056bd46ba9bf85fbf788`, while the bounded shipped foothold it describes is now `drivers/nvme/host/pci.zig` at blob `2844c0ae8162c65ba73d8a0b84b6f1bb105f0e19`, `drivers/nvme/host/pci_verify.zig` at blob `4e66712d57db672fe6ca355a8ec3d20398a43f37`, `zigux/tests/phase12_nvme_pci.zig` at blob `649d28b20bcb4b5d9e7b45ed4490668a8af6a628`, and `zigux/tests/phase12_nvme_pci_manifest.json` at blob `adba8b2b7b3e8804f5496fa0c82f466da451b4e9`
