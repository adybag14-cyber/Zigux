...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `e8a10d7611a066c07de56721e4e02cb44fda5078`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `eef5c17189b4172566c8463ecaac07279632d94f`, `.github/workflows/zigux-bootstrap.yml` at blob `76019df486d2582d3197a15cd00e7a050edcc766`, `scripts/zigux/README.md` at blob `35a83a31fde3435fc3b9c6563e70982d8f760cc2`, and `zigux/Makefile` at blob `93aebf412639ccc1122a74b87201f57f6e7bfc99`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
