...
- exact coverage evidence checked on `2026-05-19`: the current-master NVMe gap-inventory companion is still publicly raw-readable on current `master` as `Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md`
