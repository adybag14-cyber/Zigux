...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `fd56457fe5a3c754fcb716b279c22af618e92f1b`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `eef5c17189b4172566c8463ecaac07279632d94f`, `.github/workflows/zigux-bootstrap.yml` at blob `76019df486d2582d3197a15cd00e7a050edcc766`, `scripts/zigux/README.md` at blob `d6b28600e6f0e6971c993e37644d4c1865575ed2`, and `zigux/Makefile` at blob `93aebf412639ccc1122a74b87201f57f6e7bfc99`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
