...
- exact coverage evidence checked on `2026-05-19`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `357672f2ceafce38b4b0ba5cc0b3077634798630`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `8ecea341ec3981486dabfc20d6003d9ed42339a7`, `.github/workflows/zigux-bootstrap.yml` at blob `e07b69eaf4070b83f943e1ad41cf1a47bdc532fa`, `scripts/zigux/README.md` at blob `aaa6a09db5aea5ec07085dfb255c6a4051929021`, and `zigux/Makefile` at blob `d3bd9346513af925a9a2e0fc8dcc079f84ef8bce`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
