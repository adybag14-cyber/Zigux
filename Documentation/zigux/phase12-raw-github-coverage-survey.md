...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `ff9e8cb122b55c81ec561a6d1525d1a0004e4bd0`, `.github/workflows/zigux-bootstrap.yml` at blob `6e67d036d6b5f931a2ea869e792a9f4990079be2`, and `scripts/zigux/README.md` at blob `cc5b37b3d0c6e58d489e6d46fe7901135c41836a`, while direct contents reads for `zigux/tests/phase12_build.zig`, `zigux/Makefile`, and `scripts/zigux/check-phase12-release-readiness-packet.py` still return 404 through the same current `master` bridge
