...
- exact coverage evidence checked on `2026-05-17`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `fe5ac6f0b9774f40141d61c87ee9a0852a586da7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `a0b138d22368be59b5b4b7b74864429e22a273a6`, `.github/workflows/zigux-bootstrap.yml` at blob `2fb15615df4dc29ba99c8b63c38421d0c20268b0`, and `scripts/zigux/README.md` at blob `a2409e73c7b8b5657fc49f3583b5a8fc386fbe66`, while direct contents reads for `zigux/tests/phase12_build.zig` and `zigux/Makefile` still return `404` through the same current `master` bridge
