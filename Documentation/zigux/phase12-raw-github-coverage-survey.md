...
- driver-local current-master gap inventory companion:
  - `Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md` as the truthful current-master gap map for the shipped NVMe starter-plus-verifier-plus-direct-test-plus-survey-note packet plus manifest anchor while the dedicated `nvme_pci` slice and survey-gate packet remains absent
