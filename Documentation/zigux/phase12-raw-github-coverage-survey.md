...
## Exact Coverage Evidence
  ...
  * exact coverage evidence checked on `2026-05-17`: direct contents reads now succeed for `scripts/zigux/check-build-only-phase12-surface.py` at blob `fe5ac6f0b9774f40141d61c87ee9a0852a586da7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `219868f1775cd320561b81e513ffd4de8158719a`, `.github/workflows/zigux-bootstrap.yml` at blob `b6c14f96c0fb6ef657dfef5ccab41aa7db2eaf71`, and `scripts/zigux/README.md` at blob `5831d051eda1f59071919c5a3046508ba7366621`, while direct contents reads for `zigux/tests/phase12_build.zig` and `zigux/Makefile` still return 404 through the same current `master` bridge
