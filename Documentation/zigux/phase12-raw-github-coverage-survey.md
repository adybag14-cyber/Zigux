...
- exact coverage evidence checked on `2026-05-18`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `ba17ed8765472cb814d241cad301c709eed0de6c`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `13bf09d84b6946486cabcd7ad99b9733ea439be8`, `.github/workflows/zigux-bootstrap.yml` at blob `046f5ea160e61c260109a521de2b66786c46bc24`, `scripts/zigux/README.md` at blob `9d40d4157e5ff67bccb543969671a14ead437571`, and `zigux/Makefile` at blob `d28835d8a4fcaed4b7281301a733ea6927d8bc88`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
