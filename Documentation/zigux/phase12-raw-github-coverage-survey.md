...
- exact coverage evidence checked on `2026-05-18`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `bd07243aa47ed7367141e3d859d40e2f6dc52d5d`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `2f294e4309410407d840fe3bf527dc27b0f09a61`, `.github/workflows/zigux-bootstrap.yml` at blob `4809de3c4fe64e949a32ce190f22bfacc6d061a7`, `scripts/zigux/README.md` at blob `cf2082beeeade0a0d8f1726eff4fb9c941beefd3`, and `zigux/Makefile` at blob `ffba748161a322c86ec8f935c98c845635d87631`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
