...
- exact coverage evidence checked on `2026-05-29`: the current GitHub contents bridge directly reads the degraded-mode support bundle `scripts/zigux/check-build-only-phase12-surface.py` `43d911ac5f3f584480b576dcbbeedbb30819085e`, `scripts/zigux/check-phase12-build-inventory.py` `e6b26705206492e37fb1997671eed6d4d8dfbf6e`, `scripts/zigux/check-phase12-virtio-net-manifest-presence.py` `a838cbff10834dca925bf8d4dee70199e56896d7`, `scripts/zigux/check-phase12-complex-driver-lane-packet.py` `8031e054d5dcec202ec0cd992e62c0b07dea4099`, `scripts/zigux/check-phase12-nvme-packet-coherence.py` `f54a65ee114f5ceb4d3eceb6039ce83c337890d6`, `scripts/zigux/check-phase12-cross-compile-smoke.py` `ba5c4a432f5dbfffc5056faedd3ee67d380ce95c`, `scripts/zigux/check-phase12-virtio-scsi-rollback-coverage.py` `2b7a7ec95555341807de9367fd0871a539d33abf`, `scripts/zigux/check-phase12-virtio-scsi-libbpf-boundary.py` `28f5230f500489506ba15d95bc72a86d9ab4581f`, `scripts/zigux/check-phase12-libbpf-snapshot.py` `277554397ab1a236c71f1dac9061ffe4cfbeaf67`, `scripts/zigux/check-phase12-libbpf-lane-marker.py` `7be88fe75bda8cc9d71eba627cb3309d8d6a0ccf`, `scripts/zigux/check-phase12-libbpf-heavy-consumer-packet.py` `ca8f583b564e3c024a6e64643cd0928340e72028`, `scripts/zigux/check-phase12-release-readiness-packet.py` `bc3d72db9e449f84478ebb027a2281e2dfea9576`, `scripts/zigux/validate-phase12.py` `8b64ad4545a1f4de35294a25d5ff01217d533394`, `scripts/zigux/README.md` `a02fdfc61839b215715856fd932eb3e9020c43b1`, `.github/workflows/zigux-bootstrap.yml` `5bdb136b8b6710c08c19566879d5a9da42b63445`, `zigux/Makefile` `f49b44b6f70ce70b8f0c7b04b8fb88c805ba40c9`, and `zigux/tests/phase12_build.zig` `eacfc63df9670ba22fd1f88e4ee33212d1818e29` on current `master`.
- exact recovery evidence checked on `2026-05-29`: `scripts/zigux/check-phase12-cross-compile-smoke.py` at blob `ba5c4a432f5dbfffc5056faedd3ee67d380ce95c` fail-closes on `.github/workflows/zigux-bootstrap.yml` self-test and normal-run hooks for that checker, so the contents-bridge support bundle records the workflow-side recovery guard instead of only the note, Makefile, and validator markers.
...
- compare those doc-side results beside contents-bridge reads of `scripts/zigux/check-build-only-phase12-surface.py`, `scripts/zigux/check-phase12-build-inventory.py`, `scripts/zigux/check-phase12-virtio-net-manifest-presence.py`, `scripts/zigux/check-phase12-complex-driver-lane-packet.py`, `scripts/zigux/check-phase12-nvme-packet-coherence.py`, `scripts/zigux/check-phase12-cross-compile-smoke.py`, `scripts/zigux/check-phase12-virtio-scsi-rollback-coverage.py`, `scripts/zigux/check-phase12-virtio-scsi-libbpf-boundary.py`, `scripts/zigux/check-phase12-libbpf-snapshot.py`, `scripts/zigux/check-phase12-libbpf-lane-marker.py`, `scripts/zigux/check-phase12-libbpf-heavy-consumer-packet.py`, `scripts/zigux/check-phase12-release-readiness-packet.py`, `scripts/zigux/validate-phase12.py`, `.github/workflows/zigux-bootstrap.yml`, `scripts/zigux/README.md`, `zigux/Makefile`, and `zigux/tests/phase12_build.zig` before widening fallback claims.
