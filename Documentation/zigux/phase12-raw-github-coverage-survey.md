...
- exact coverage evidence checked on `2026-05-18`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `bd07243aa47ed7367141e3d859d40e2f6dc52d5d`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `2f294e4309410407d840fe3bf527dc27b0f09a61`, `.github/workflows/zigux-bootstrap.yml` at blob `a0e6840beac459ff63b81a0370ea249ca5ae0ea1`, `scripts/zigux/README.md` at blob `58c5c4a98fc01e0aab156eb150e5d95689d847e2`, and `zigux/Makefile` at blob `835c0513f6de9868eaf5b2838fe09fcb177d29ed`, while a direct contents read for `zigux/tests/phase12_build.zig` still returns `404` through the same current `master` bridge
