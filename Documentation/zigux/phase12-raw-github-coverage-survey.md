...
- exact coverage evidence checked on `2026-05-11`: the shared-tree-only anchors are currently present on `master` as `Documentation/zigux/phase12-virtio-net-survey.md` at blob `755165e68713029e2da983e05aa60b14cc7434be` and `Documentation/zigux/phase12-libbpf-segment-survey.md` at blob `3da97816df567e85309a38948ceb158d2b47efae`
- exact coverage evidence checked on `2026-05-11`: the shared raw-read anchors remain `scripts/zigux/check-build-only-phase12-surface.py` at blob `b5256c446e62443bab720a9c277cd7ee885f6105` and `zigux/tests/phase12_build.zig` at blob `6edc61b8cb6508fe017461c38388454587c20181`; the build file now exposes the shipped `smoke` and `test` steps through `smoke_step.dependOn(&run_syntax_tests.step);`, `smoke_step.dependOn(&run_repeated_replan_tests.step);`, `test_step.dependOn(&run_contract_tests.step);`, `test_step.dependOn(&run_syntax_tests.step);`, and `test_step.dependOn(&run_repeated_replan_tests.step);`
