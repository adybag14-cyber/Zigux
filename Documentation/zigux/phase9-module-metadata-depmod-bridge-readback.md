...
- there is no surviving dedicated `Documentation/zigux/phase9-module-metadata-depmod-bridge-survey.md`, `zigux/tests/runtime_module_metadata_manifest.json`, `zigux/tests/runtime_module_metadata_survey.zig`, or `scripts/zigux/check-phase9-module-metadata-packet.py` packet on the trusted current-master path
