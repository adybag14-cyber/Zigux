...
- Keep `scripts/zigux/validate-phase7.py` and `phase7-validate` framed as a returned narrow validation foothold only; they do not by themselves prove that the broader shared Phase 7 build shard, aggregate wrapper routes, or workflow-backed test route have returned.
