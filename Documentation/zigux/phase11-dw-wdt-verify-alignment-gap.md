...
- `scripts/zigux/check-phase11-dw-wdt-verify-alignment.py` should keep this narrower current-head packet fail-closed around the returned validation matrix, verify helper, and PM helper rather than asserting direct readability for the broader direct-driver stack
