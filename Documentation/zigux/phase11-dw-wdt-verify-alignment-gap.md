...
- `scripts/zigux/check-phase11-dw-wdt-verify-alignment.py` keeps the resolved matrix-versus-manifest alignment and the current verify-helper scope fail-closed
