...
- Treat `Documentation/zigux/phase11-shared-replay-contract.md`, `scripts\zigux/check_phase11_build_inventory.zig`, and `scripts\zigux/check_phase11_header_boundary_packet.zig` as returned reminder-only continuity evidence unless the missing shared replay files rematerialize beside them.
