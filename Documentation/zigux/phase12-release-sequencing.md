...
- rerun `python3 scripts/zigux/check-build-only-phase12-surface.py --self-test` and `python3 scripts/zigux/check-build-only-phase12-surface.py`, then reread `zigux/tests/README.md`, `Documentation/zigux/phase12-release-closure-checklist.md`, `Documentation/zigux/phase12-raw-github-coverage-survey.md`, `Documentation/zigux/phase12-complex-driver-lane-sequencing.md`, `Documentation/zigux/review-checklist.md`, and this sequencing note together to confirm the live PMO packet still names the same smoke-first release order, two-artifact-plus-two-anchor fallback split, driver-only anti-overlap boundary, and tests-root reminders
- if that reread stays clean, keep this sequencing note, `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase12-raw-github-coverage-survey.md`, `Documentation/zigux/phase12-complex-driver-lane-sequencing.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` in drift-control sync before widening into any new PMO claim
...
- if the lane reopens for another degraded-workflow drift after that reread stays clean, start by diffing `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase12-raw-github-coverage-survey.md`, `Documentation/zigux/phase12-complex-driver-lane-sequencing.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` against this sequencing note plus `Documentation/zigux/phase12-release-closure-checklist.md` before widening into any new PMO claim
