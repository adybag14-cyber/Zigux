...
- if that reread finds another PMO truthfulness gap, prefer the smallest one-surface repair among `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase12-raw-github-coverage-survey.md`, `Documentation/zigux/phase12-release-coordination-matrix.md`, `Documentation/zigux/phase12-complex-driver-lane-sequencing.md`, `scripts/zigux/README.md`, or `zigux/tests/README.md` rather than widening into driver-local or checker-local work
