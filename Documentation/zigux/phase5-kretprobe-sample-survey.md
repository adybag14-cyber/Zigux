...
- does the sample keep the Linux `struct my_data`-style private entry timestamp explicit and reviewable instead of burying that one-word anchor shape in unstructured state?
