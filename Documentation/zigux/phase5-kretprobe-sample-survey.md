...
- `PHASE5_SURVEYED_COMMIT=5f52d0a8f548429b197cc0db1a72da8d51f5238f`
...
- inspected `master` head: `5f52d0a8f548429b197cc0db1a72da8d51f5238f`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=5f52d0a8f548429b197cc0db1a72da8d51f5238f` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
