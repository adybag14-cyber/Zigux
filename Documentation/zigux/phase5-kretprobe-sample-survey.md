...
- `PHASE5_SURVEYED_COMMIT=6a16b694b0e4622aa0a251940ad26a73e181e8eb`
...
- inspected `master` head: `6a16b694b0e4622aa0a251940ad26a73e181e8eb`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=6a16b694b0e4622aa0a251940ad26a73e181e8eb` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
