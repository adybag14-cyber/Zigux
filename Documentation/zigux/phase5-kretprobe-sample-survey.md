...
- inspected `master` head: `966c21e8227372fa3498e18bc0eeb988906de853`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=966c21e8227372fa3498e18bc0eeb988906de853` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
