...
- `PHASE5_SURVEYED_COMMIT=0300260002cbf9e5e65bbe116befc6e3df12983b`
...
- inspected `master` head: `0300260002cbf9e5e65bbe116befc6e3df12983b`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=0300260002cbf9e5e65bbe116befc6e3df12983b` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
