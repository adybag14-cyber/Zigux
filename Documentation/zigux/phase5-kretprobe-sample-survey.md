...
- `PHASE5_SURVEYED_COMMIT=862549d2649f3eb780e2b822addc9c7fd8be693f`
...
- inspected `master` head: `862549d2649f3eb780e2b822addc9c7fd8be693f`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=862549d2649f3eb780e2b822addc9c7fd8be693f` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
