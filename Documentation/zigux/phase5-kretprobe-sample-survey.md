...
- `PHASE5_SURVEYED_COMMIT=6c13a36a17528818ba2240f278236e628ec5446f`
...
- inspected `master` head: `6c13a36a17528818ba2240f278236e628ec5446f`
...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=6c13a36a17528818ba2240f278236e628ec5446f` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
