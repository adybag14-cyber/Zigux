...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=e7baa882e8243d5278481c95b616f41a33059198` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
