...
- this approved probe-lifecycle idiom is now pinned to `PHASE5_SURVEYED_COMMIT=e74aac998b9970939f8c045ec595a95c18ab1064` so the survey note, manifest-backed checks, shared sample-root catalog, and shared review checklist all point at the same inspected `master` head
