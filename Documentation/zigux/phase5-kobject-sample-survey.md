...
- `PHASE5_SURVEYED_COMMIT=99d6b1c7e8aa9ff4a9ee79da7fe4e90055a7c336`
...
Current sample behavior was re-verified against `master` commit `99d6b1c7e8aa9ff4a9ee79da7fe4e90055a7c336` on 2026-04-30 with the attached Zig toolchain.
...
- this approved ownership-and-lifetime idiom is now pinned to `PHASE5_SURVEYED_COMMIT=99d6b1c7e8aa9ff4a9ee79da7fe4e90055a7c336` so the survey note, manifest-backed checks, shared sample-root catalog, shared review checklist, and contributor review path all point at the same inspected `master` head
