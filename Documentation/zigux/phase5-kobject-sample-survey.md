...
If the lane reopens soon, start with `Documentation/zigux/phase5-kobject-sample-survey.md`, then compare `Documentation/zigux/README.md` and `scripts\zigux/check_phase5_review_guide_surface.zig` against `Documentation/zigux/phase5-sample-lane-sequencing.md`, `Documentation/zigux/phase5-sample-review-guide.md`, `Documentation/zigux/review-checklist.md`, `samples/zigux/README.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md`. Repair only the smallest shared-guard or docs-root reminder drift that still overstates `samples/zigux/kobject_example.zig` as direct authenticated proof, and leave sample behavior, runtime families, and freeze-map boundaries untouched.
