...
- `PHASE5_SURVEYED_COMMIT=6c5103272f508303558af05005da5c3cc53cff68`
...
Current sample behavior was re-verified against `master` commit `6c5103272f508303558af05005da5c3cc53cff68` on 2026-05-01 with the attached Zig toolchain.
...
- this approved ownership-and-lifetime idiom is now pinned to `PHASE5_SURVEYED_COMMIT=6c5103272f508303558af05005da5c3cc53cff68` so the survey note, manifest-backed checks, shared sample-root catalog, shared review checklist, and contributor review path all point at the same inspected `master` head
