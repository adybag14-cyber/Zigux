...
1. confirm the Phase 5 anchor is still the Linux kobject example
   - `rg -n "samples/kobject/kobject-example.c|PHASE5_LANE_KEY=P5-L20|PHASE5_SURVEYED_COMMIT=545d33b54e22d50ca0aa32565bd73738d9634e24|Phase 5" Documentation/zigux samples`
