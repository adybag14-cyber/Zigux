...
- does `zigux/tests/README.md` still keep the focused attr-group replay and survey-guard companions explicit for the same bounded kobject packet instead of collapsing that evidence back to sample-root-only guidance?
