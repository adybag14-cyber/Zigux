...
- this approved ownership-and-lifetime idiom is now pinned to `PHASE5_SURVEYED_COMMIT=13653f4147fba0a6c73a5066dfb569f552dae263` so reviewers can see which inspected `master` head closed the roadmap gap
