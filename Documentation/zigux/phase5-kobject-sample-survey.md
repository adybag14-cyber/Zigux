...
- the shared docs-root, sample-root, scripts-root, and tests-root contributor packet should stay explicit here too whenever those broader guidance surfaces move together with the landed kobject packet.
