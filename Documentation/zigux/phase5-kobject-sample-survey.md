...
- the honest Phase 5 move remains to make the directory name, attribute dispatch, attribute-array order, shared `0664` attribute mode pattern, and lifetime boundaries reviewable in memory while keeping sysfs creation, kernel object registration, and module wiring out of scope.
