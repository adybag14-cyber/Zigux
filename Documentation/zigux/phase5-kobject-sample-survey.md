...
- `PHASE5_SURVEYED_COMMIT=1242055b51c2786d30c256990e28d2522e95521a`
...
Current sample behavior was re-verified against `master` commit `1242055b51c2786d30c256990e28d2522e95521a` on 2026-04-30 with the attached Zig toolchain.
...
- this approved ownership-and-lifetime idiom is now pinned to `PHASE5_SURVEYED_COMMIT=1242055b51c2786d30c256990e28d2522e95521a` so the survey note, manifest-backed checks, shared sample-root catalog, shared review checklist, and contributor review path all point at the same inspected `master` head
