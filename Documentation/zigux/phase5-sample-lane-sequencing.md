...
Keep `samples/zigux/runtime_bitmap_cold_stage_guard.zig` explicit beside that same reminder packet as a separate current direct sample-root companion rather than extra Phase 5 proof.
