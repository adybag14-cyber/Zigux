...
- the manifest-backed support replay, the newer survey gate and survey note, the repeated-rollback gate, and the shared Phase 12 support-bundle surfaces keep this slice reviewable without claiming broader Phase 12 closure, `scsi_host` registration, or live DMA-backed request flow
