...
- the earlier docs-root parity-scorecard-survey omission and the later scripts-root validator-route undercount are no longer the active shared-summary problem; the fresh 2026-05-15 reread shows `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/README.md` all keep the parity survey, the readiness and handoff notes, the governance-lane sequencing note, and the shipped `make -C zigux phase15-validate` plus `make -C zigux phase15-test` routes explicit, and `scripts/zigux/README.md` now records that `phase15-validate` reruns `validate-phase15.py`, `check-phase15-docs-readme-alignment.py`, `check-phase15-scripts-readme-alignment.py`, `check-phase15-review-process-handoff.py`, and `check-phase15-shared-summary-gap.py`; shared-summary follow-through should therefore stay parked unless a future reread finds a new drift, while `zigux/tests/README.md` stays governed by the sequencing-marker plus replay-route packet instead of duplicating packet-local docs reminders
