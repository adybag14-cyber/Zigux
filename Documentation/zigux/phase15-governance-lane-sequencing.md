...
- the earlier compact docs-root omission around `Documentation/zigux/phase15-readiness-gate-survey.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, and `Documentation/zigux/phase15-governance-lane-sequencing.md` is no longer the active shared-summary problem; the live shared-summary checker now scopes the open reminder drift to whether `Documentation/zigux/phase15-parity-scorecard-survey.md` stays explicit in `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `scripts/zigux/README.md`, while `zigux/tests/README.md` stays governed by the sequencing-marker plus replay-route packet instead of a duplicate parity-scorecard-survey reminder
