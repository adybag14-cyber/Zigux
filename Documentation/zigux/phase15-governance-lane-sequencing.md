...
- the earlier docs-root parity-scorecard-survey omission is no longer the active shared-summary problem; the live 2026-05-14 reread shows `Documentation/zigux/README.md` already keeps the parity survey, the readiness and handoff notes, the governance-lane sequencing note, and the shipped `make -C zigux phase15-validate` plus `make -C zigux phase15-test` routes explicit, so the shared-summary lane should stay parked unless a fresh reread opens a new docs-root, checklist, or scripts-root truthfulness drift, while `zigux/tests/README.md` stays governed by the sequencing-marker plus replay-route packet instead of duplicating packet-local docs reminders
...
- if a shared-summary truthfulness drift appears first instead, reread `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` against `Documentation/zigux/phase15-freeze-map-governance.md`, `Documentation/zigux/phase15-architecture-council-review-process.md`, `Documentation/zigux/phase15-parity-scorecard-survey.md`, `Documentation/zigux/phase15-parity-scorecard.md`, `Documentation/zigux/phase15-indefinite-c-policy.md`, `Documentation/zigux/phase15-readiness-gate-survey.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, `Documentation/zigux/phase15-governance-lane-sequencing.md`, `scripts/zigux/validate-phase15.py`, `scripts/zigux/check-phase15-shared-summary-gap.py`, `zigux/tests/phase15_handoff_next_steps_manifest.json`, and `zigux/tests/phase15_readiness_gate_manifest.json`, then run `python3 scripts/zigux/check-phase15-shared-summary-gap.py` and `python3 scripts/zigux/validate-phase15.py` first, and keep the repair scoped to the first summary surface that actually drifted on current `master`; with the live 2026-05-14 packet, `Documentation/zigux/README.md` already keeps `Documentation/zigux/phase15-readiness-gate-survey.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, `Documentation/zigux/phase15-governance-lane-sequencing.md`, and the shipped `make -C zigux phase15-validate` plus `make -C zigux phase15-test` routes explicit, so shared-summary follow-through should stay parked unless a fresh reread reopens one of those markers, keep `Documentation/zigux/review-checklist.md` aligned in the same bounded shared-summary packet when its survey reminder drifts, and treat `zigux/tests/README.md` follow-through as a separate sequencing-marker or replay-route repair instead of widening it into duplicate docs-root packet-local reminders
