...
- `scripts\zigux/check_phase3_rbtree_root_starter_packet.zig` fail-closes the docs note, binding, helper, starter replay, build shard, and manifest so the packet does not drift back into an untracked helper.
