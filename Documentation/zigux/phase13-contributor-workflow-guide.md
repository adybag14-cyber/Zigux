...
If a broad docs-root or shared-summary reminder still names `make -C zigux phase13`, restate in the same sentence or bullet that it is blocked convenience wiring while `zigux/tests/phase13_build.zig` remains absent; do not present that broader route as independently shipped current-`master` evidence.
...
3. If a broad reminder changes, reread the shared surfaces together, explicitly including `Documentation/zigux/README.md`, `Documentation/zigux/phase13-release-coordination-matrix.md`, `scripts/zigux/check-phase13-shared-summary-surfaces.py`, and `scripts/zigux/check-phase13-shared-summary-surfaces.py`, before adding packet-local prose.
...
- Does the wording keep the compact PMO coordination companion explicit through `Documentation/zigux/phase13-release-coordination-matrix.md` beside `Documentation/zigux/phase13-release-notes-survey.md` and `Documentation/zigux/phase13-roadmap-traceability.md` instead of leaving the active release-coordination surface implicit?
