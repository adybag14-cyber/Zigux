...
3. If a broad reminder changes, reread the shared surfaces together, including `Documentation/zigux/phase13-release-coordination-matrix.md`, before adding packet-local prose.
...
8. Keep `Documentation/zigux/phase13-release-coordination-matrix.md` explicit beside `Documentation/zigux/phase13-release-notes-survey.md` and `Documentation/zigux/phase13-roadmap-traceability.md` whenever a broad shared reminder describes the active Phase 13 packet.
9. Record Phase 13 as still active and reviewable; do not imply closure or a frozen packet.
