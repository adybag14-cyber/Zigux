...
The older scripts-root follow-up also needs to be narrowed on current `master`: `scripts/zigux/README.md` already keeps `include/zigux/abi.h`, `include/zigux/notifier_abi.h`, `zigux/helpers/list_view.zig`, and `zigux/helpers/hlist_view.zig` explicit in its broad Phase 13 reminder. The remaining same-lane drift is smaller: that shared scripts-root reminder still leaves `drivers/tty/hvc/hvc_console.h` implicit even though `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/README.md`, and this guide already keep that mixed-interop notifier evidence explicit beside the notifier survey, checker, manifest, reviewability, ABI, and helper footholds. Refresh that one scripts-root reminder next, then reread `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/README.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` together to confirm the shared packet still uses the same nouns for the same adjacent evidence.
