...
Do not quietly erase these active Phase 13 limits from manifests, notes, or contributor guidance:
  ...
  * `Documentation/zigux/phase13-landlock-syscalls-governance.md`, `zigux/tests/phase13_landlock_syscalls_reviewability.zig`, and `zigux/tests/phase13_landlock_syscalls_manifest.json` stay coupled as the current syscall-owned truthfulness trio until `master` ships a dedicated syscall-packet checker
...
Before calling a Phase 13 change ready, confirm all of the following:
  ...
  * `Documentation/zigux/phase13-landlock-syscalls-governance.md`, `zigux/tests/phase13_landlock_syscalls_reviewability.zig`, and `zigux/tests/phase13_landlock_syscalls_manifest.json` still move together as the current syscall-owned truthfulness trio until a dedicated checker lands
