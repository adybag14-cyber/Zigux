...
The next contributor-facing follow-up is therefore narrower: `scripts/zigux/README.md` still leaves `include/zigux/abi.h`, `include/zigux/notifier_abi.h`, and `make -C zigux phase13-validate` implicit in its broad shared Phase 13 reminder even though `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/README.md`, and this guide already keep those adjacent notifier and validator-first surfaces explicit. Refresh that one scripts-root reminder next, then reread `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/README.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` together to confirm the shared packet still uses the same nouns for the same adjacent evidence.
