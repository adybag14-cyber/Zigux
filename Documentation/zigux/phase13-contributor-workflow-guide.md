...
The next contributor-facing follow-up is therefore to reread `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/README.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` together for the next one-surface wording drift while keeping the syscall-owned truthfulness trio and the adjacent notifier evidence explicit.
