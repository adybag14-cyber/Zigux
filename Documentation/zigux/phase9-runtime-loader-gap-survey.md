...
If the shared loader packet drifts again, tighten only this packet's survey evidence,
gating, or rollback wording. Fresh readback now shows `scripts/zigux/README.md`
and `zigux/tests/README.md` already defer the shared owner map correctly, while
`Documentation/zigux/README.md` still summarizes the Phase 9 packet without
naming `Documentation/zigux/phase9-runtime-pilot-lane-sequencing.md` as the
owner of the exact shared-loader inventory and blocked publication boundary.
Keep the exact shared owner map in
