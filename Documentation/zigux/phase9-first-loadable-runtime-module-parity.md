...
- the bitmap side still exposes only a partial trusted-path packet around the direct sample, loader, top-bit companion, survey gate, and bounded build bundle
