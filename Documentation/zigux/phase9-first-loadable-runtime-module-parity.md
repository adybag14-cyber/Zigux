...
- scope: cross-family repo-reality survey for the bounded atomic64 direct packet, the still-partial bitmap reminder packet with restored module and diff proof, and the shared loader contract surfaces only

## Current Repo Reality
Trusted current-tree reads on 2026-05-23 now show a split Phase 9 pilot picture: the atomic64 side returns a direct packet, the bitmap side remains partial but now includes direct module and diff proof, and the shared loader contract surfaces are readable without proving shipped loader parity.
