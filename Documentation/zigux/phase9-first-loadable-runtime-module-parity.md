...
- `PHASE9_SURVEYED_COMMIT=2026-05-23-first-loadable-parity-bitmap-cold-stage-direct-packet`
- scope: cross-family repo-reality survey for the bounded atomic64 direct packet without a returned family-local loader scaffold, the still-partial bitmap reminder packet with restored cold-stage guard, module, and diff proof, and the shared loader contract surfaces only

## Current Repo Reality
Trusted current-tree reads on 2026-05-23 now show a split Phase 9 pilot picture: the atomic64 side returns a direct packet without a returned family-local loader scaffold, the bitmap side remains partial but now includes direct cold-stage guard, module, and diff proof, and the shared loader contract surfaces are readable without proving shipped loader parity.
