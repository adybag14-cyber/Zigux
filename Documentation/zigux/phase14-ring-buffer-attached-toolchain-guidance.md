...
## Attached bundle
- attached archive name: `agent_files/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc (1).tar.xz`
- lane-local extraction command example: `mkdir -p /workspace/.toolchains/p14-l08 && tar -xf "/workspace/agent_files/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc (1).tar.xz" -C /workspace/.toolchains/p14-l08`
- run-local extraction example: `/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc`
- compiler version expected after extraction: `0.17.0-dev.877+a3ae499dc`
...
- `/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig version`
- `/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig env`
- `/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig env | rg -n "zig_exe|lib_dir|std_dir|global_cache_dir|version|target"`
