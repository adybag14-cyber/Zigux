...
- surveyed against dated current-master readback marker `current-master-readback-2026-05-16` on 2026-05-16 after a fresh live reread confirmed the stay-in-C exception posture, maintenance handoff, and blocked deep-core posture still match the current review-process, readiness, and parity-scorecard packet
