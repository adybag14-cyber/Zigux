...
- anchor packets in the current smoke bundle:
  - workqueue: `zigux/tests/phase14_workqueue_bridge_manifest.json`, lane `P14-L04`, surveyed commit `542acd7b12c52211ef9a8bd790fa2e2b3367cbf0`, ready-next `phase14-workqueue-delayed-timer-handoff-followup`, blocked `phase14-workqueue-live-execution-blocker`
