...
- anchor packets in the current smoke bundle:
  - workqueue: `zigux/tests/phase14_workqueue_bridge_manifest.json`, lane `P14-L01`, surveyed commit `64f315b1e0536983ec5bdf620d720d10972d9551`, ready-next `phase14-workqueue-disable-delayed-followup`, blocked `phase14-workqueue-live-execution-blocker`
