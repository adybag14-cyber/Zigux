...
- `zigux/tests/phase14_build.zig` now exposes one dedicated shared `phase14-smoke` shard for the shared smoke survey, while all four anchor-local artifacts still replay only through the heavier `test` bundle.
