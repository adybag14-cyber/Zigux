...
- anchor packets in the current smoke bundle:
  ...
  - ring buffer: `zigux/tests/phase14_ring_buffer_manifest.json`, lane `P14-L08`, surveyed commit `946d5c73fdb763ba860a20879b05da54e1896e8c`, ready-next none currently recorded, blocked `phase14-ring-buffer-zig-port-blocker`
