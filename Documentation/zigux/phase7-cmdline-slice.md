...
- scope: keep the Phase 7 cmdline lane limited to the slice anchor, dedicated replay, dedicated survey, dedicated manifest, dedicated checker, and the no-standalone-cmdline-sample boundary
