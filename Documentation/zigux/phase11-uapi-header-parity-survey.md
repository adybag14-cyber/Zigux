...
- It now also records the adjacent cleanup and targetless-unregister companion routes as already-landed current-head continuity without promoting them into a restored shared replay roster.
