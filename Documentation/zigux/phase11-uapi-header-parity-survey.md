...
- lane: `P11-L18`
- scope: keep the maintained shared UAPI header parity packet reviewable for `watchdog_info`, `winsize`, and the exported `hvc_console.h` constants and helper declarations without widening into tty-core or watchdog core ownership
