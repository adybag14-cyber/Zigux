...
- No additional wider same-lane packet member needs to be called out here while the current docs-root, tests-root, and scripts-root summaries stay aligned with the returned bitmap/cpumask, list/hlist, header-family, and abi.h follow-through.
