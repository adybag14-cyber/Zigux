...
Fresh same-lane readback also keeps `zigux/tests/phase7_rbtree_manifest.json` directly readable as the surviving companion anchor for the current rbtree packet.
...
Do not widen this note into broader validator, checker, fixture, or make-wrapper claims without a fresh same-lane reread of those sibling review surfaces.