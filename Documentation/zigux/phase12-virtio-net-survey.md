...
- this checkpoint has now been re-verified against surveyed `master` snapshot `8b69e4dfd04553afeb08c0ecbf3060f800e7ecd1`, with the same probe snapshot, queue-recovery, queue-resume, `hdr_len`, receive-path, and mergeable-refill helpers still defining the live bounded footing.
