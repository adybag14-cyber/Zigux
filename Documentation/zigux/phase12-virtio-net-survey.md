...
- this checkpoint has now been re-verified against surveyed `master` snapshot `92b48d9b9192716393eb6d38cd8c0bb8d3a1a36d`, with the same probe snapshot, queue-recovery, queue-resume, `hdr_len`, and receive-path helpers still defining the live bounded footing.
