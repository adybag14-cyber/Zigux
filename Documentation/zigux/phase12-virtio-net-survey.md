...
- this checkpoint has now been re-verified against current `master` head `5de1ee1d348ba9afb2cdcf1099141ed249a2c7d5`, with the same probe snapshot, queue-recovery, and `hdr_len` helpers still defining the live bounded footing.
