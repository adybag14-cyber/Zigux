...
Keep this lane parked unless fresh repo inspection finds directly coupled drift in the landed probe snapshot, syntax-lab, queue-recovery, receive-refill, control-queue-restore, recovery-ownership, mergeable-buffer-length, or segmented-rollout-boundary packet, or current `master` lands the still-ready transmit-recycle follow-up.
