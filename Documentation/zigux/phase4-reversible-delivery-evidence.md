...
- `PHASE4_REVERSIBLE_DELIVERY_GATE_EVIDENCE_BLOB_SHA=d9868eeae4712a6569d51c8807b2b96e1c325ada`
...
- `PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=35`
...
- the parked `kprobe_example` packet remains adjacent but separate, and the shared handoff note should only name its dedicated note, manifest, survey, current local replay route, and direct validation entrypoint instead of restating packet-local behavior from memory.
