...
The recovered broader note pair still overstates those bitmap-side companions as if they were current-head shipped evidence, so treat this narrower handoff as the authoritative Phase 4 rollback record until a future same-family lane either republishes the missing bitmap packet or retires the older broader claims.
