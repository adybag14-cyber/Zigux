...
- keep the missing Phase 13 route family and the adjacent notifier follow-through parked as separate same-lane or helper-local work, while treating the shipped Landlock syscalls survey-plus-replay packet as active shared-helper evidence rather than as a still-missing companion bucket
