...
- roadmap-traceability guard: `python3 scripts/zigux/check-phase13-roadmap-traceability.py`
...
10. `python3 scripts/zigux/check-phase13-roadmap-traceability.py`
11. `Documentation/zigux/phase13-shared-summary-guard-gap.md`
12. `Documentation/zigux/phase13-notifier-summary-gap.md`
13. `python3 scripts/zigux/check-phase13-shared-summary-surfaces.py`
14. `python3 scripts/zigux/check-phase13-tests-readme-alignment.py`
15. `python3 scripts/zigux/validate-phase13-release.py`
...
4. rerun `python3 scripts/zigux/check-phase13-roadmap-traceability.py` when roadmap-facing release wording, the four-anchor owner map, or the packet's shared helper split changes
5. rerun `python3 scripts/zigux/validate-phase13-release.py` when the shared release packet changes so the PMO coordination note stays aligned with the shipped release-discipline validator
...
- leave the docs-root Phase 13 reminder packet parked unless `Documentation/zigux/phase13-release-packet-index.md`, `Documentation/zigux/README.md`, `Documentation/zigux/phase13-contributor-workflow-guide.md`, `Documentation/zigux/phase12-phase13-release-handoff.md`, `Documentation/zigux/phase13-roadmap-traceability.md`, `scripts/zigux/check-phase13-roadmap-traceability.py`, `Documentation/zigux/phase13-release-notes-survey.md`, `Documentation/zigux/phase13-shared-helper-lane-sequencing.md`, `scripts/zigux/README.md`, or `zigux/tests/README.md` drifts again
- if one of those shared reminder surfaces moves, reread the same packet first and land only the smallest reminder-side truthfulness repair, then rerun `python3 scripts/zigux/check-phase13-shared-summary-surfaces.py`, `python3 scripts/zigux/check-phase13-tests-readme-alignment.py`, `python3 scripts/zigux/check-phase13-roadmap-traceability.py`, and `python3 scripts/zigux/validate-phase13-release.py`
