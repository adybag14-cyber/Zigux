...
- shared-summary reread target: `scripts/zigux/README.md`, this matrix, the docs-root Phase 13 companions, and the tests-root companion now agree on the shipped Landlock packet and adjacent notifier evidence on current `master`; keep those shared surfaces reread together before the next broad Phase 13 summary change instead of reviving the older scripts-root-gap claim.
