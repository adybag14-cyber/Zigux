...
- shared-summary reread target: `scripts/zigux/README.md` still needs a same-tranche refresh because its current Phase 13 scripts-root summary keeps the shipped `Documentation/zigux/phase13-landlock-ruleset-slice.md`, `Documentation/zigux/phase13-landlock-ruleset-survey.md`, `Documentation/zigux/phase13-landlock-syscalls-slice.md`, `Documentation/zigux/phase13-landlock-syscalls-survey.md`, and `zigux/tests/phase13_landlock_*.zig` packet framed as repo-reality gaps; until that scripts-root reminder is repaired, treat this matrix plus the docs-root and tests-root Phase 13 companions as the authoritative shared-summary packet.
