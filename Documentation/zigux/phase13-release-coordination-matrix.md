...
- shared-summary reread target: `Documentation/zigux/README.md` still needs a same-tranche refresh because its current Phase 13 docs-root summary keeps the shipped `Documentation/zigux/phase13-landlock-ruleset-slice.md` path framed as a repo-reality gap; until that docs-root reminder is repaired, treat this matrix plus the scripts-root and tests-root Phase 13 companions as the authoritative shared-summary packet.
