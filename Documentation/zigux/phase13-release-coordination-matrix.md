...
- roadmap-traceability guard: `zig run check_phase13_roadmap_traceability.zig`
...
10. `zig run check_phase13_roadmap_traceability.zig`
11. `Documentation/zigux/phase13-shared-summary-guard-gap.md`
12. `Documentation/zigux/phase13-notifier-summary-gap.md`
13. `zig run check_phase13_shared_summary_surfaces.zig`
14. `zig run check_phase13_tests_readme_alignment.zig`
15. `zig run validate_phase13_release.zig`
...
2. rerun `zig run check_phase13_shared_summary_surfaces.zig`
3. rerun `zig run check_phase13_tests_readme_alignment.zig` when the tests-root reminder packet changes or when shared wording could drift into `zigux/tests/README.md`
4. rerun `zig run check_phase13_roadmap_traceability.zig` when roadmap-facing release wording, the four-anchor owner map, or the packet's shared helper split changes
5. rerun `zig run validate_phase13_release.zig` when the shared release packet changes so the PMO coordination note stays aligned with the shipped release-discipline validator
