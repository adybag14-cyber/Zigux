...
- workflow companion gap: `Documentation/zigux/phase13-contributor-workflow-guide.md` is still absent on current `master`
...
- shared-summary reread target: `zigux/tests/README.md`, this matrix, the docs-root Phase 13 companions, and the tests-root companion note are the shared surfaces to reread together while `scripts/zigux/README.md` remains absent on current `master`; specifically reread `Documentation/zigux/phase13-shared-helper-lane-sequencing.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, and `zigux/tests/README.md` before widening shared-summary wording.

Current `master` now keeps the docs-root, sequencing, tests-root, checklist, shared contributor-sync, tests-root companion, and this compact PMO coordination packet aligned around the shipped `Documentation/zigux/phase13-libfs-survey.md` plus manifest-backed `libfs` packet, the shipped devres and Landlock packets, and adjacent notifier evidence, while `scripts/zigux/README.md` remains a missing scripts-root companion rather than shipped packet evidence.

The older workflow-companion and shared-summary-guard wording is no longer current repo reality: `Documentation/zigux/phase13-contributor-workflow-guide.md` and `scripts/zigux/check-phase13-shared-summary-surfaces.py` still do not materialize on `master`, so shared-summary follow-through should keep them framed as repo-reality gaps until they land again.
...
- reread this matrix beside `Documentation/zigux/phase13-release-notes-survey.md`, `Documentation/zigux/phase13-roadmap-traceability.md`, `Documentation/zigux/phase13-shared-helper-lane-sequencing.md`, `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/phase13-notifier-list-survey.md`, `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `scripts/zigux/check-phase13-notifier-priority-signal.py`, and `zigux/tests/README.md` whenever shared Phase 13 wording changes, keep `Documentation/zigux/phase13-contributor-workflow-guide.md`, `scripts/zigux/check-phase13-shared-summary-surfaces.py`, and `scripts/zigux/README.md` framed as repo-reality gaps unless current `master` readback proves they materialize again, and keep the next same-lane follow-through parked unless one of those shared reminder surfaces drifts again instead of replaying the already-closed scripts-root undercount or the already-aligned tests-root companion check
