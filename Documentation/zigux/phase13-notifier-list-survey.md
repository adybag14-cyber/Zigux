...
- `zigux/tests/phase13_notifier_list_manifest.json` blob `04ba1256e10cb0dd1e0ee1caa49c795817ca93a3`, `zigux/tests/phase13_notifier_list_reviewability.zig` blob `af563c39c0010700f1655d093b143ce279f6a00c`, `scripts/zigux/check-phase13-notifier-packet.py` blob `240704910abd1751b4971d0d0ccea6fca7f6b2c9`, and `scripts/zigux/validate-phase13-release.py` blob `ea3088e5bf457f1ff522a5fd513f14e046827d3e` still gate the adjacent packet and still frame the missing notifier-chain helper, dedicated notifier ABI header, shared Phase 13 build shard, and Makefile route names as repo-reality gaps rather than shipped evidence.
