...
- `zigux/tests/phase13_notifier_list_manifest.json` blob `7e6620a0e0f8f685593c5f8e19bba39e62fa11e6`, `zigux/tests/phase13_notifier_list_reviewability.zig` blob `833226bc6d81ac1f9e6e2b009ede4b10ecc0b559`, `scripts/zigux/check-phase13-notifier-packet.py` blob `be20b2bbd5c0b6bf73f0a5b1b03ea2d15bf06875`, and `scripts/zigux/validate-phase13-release.py` blob `31c8bb1fb9be5fb023dfb429a02ff9014965042e` still gate the adjacent packet and still frame the dedicated notifier ABI header, shared Phase 13 build shard, and Makefile route names as repo-reality gaps rather than shipped evidence.
