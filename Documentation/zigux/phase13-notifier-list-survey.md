...
- `zigux/tests/phase13_notifier_list_manifest.json` blob `038453a8cf58191f6c074d9ebf05f7e1e204b5c5`, `zigux/tests/phase13_notifier_list_reviewability.zig` blob `6aad487a082e238f1a5b8b3be3e3b41e416fae7f`, `scripts/zigux/check-phase13-notifier-packet.py` blob `23475a657a2dc7e6801a0f5f66d3cc5ed488e79b`, and `scripts/zigux/validate-phase13-release.py` blob `31c8bb1fb9be5fb023dfb429a02ff9014965042e` still gate the adjacent packet and still frame the dedicated notifier ABI header, shared Phase 13 build shard, and Makefile route names as repo-reality gaps rather than shipped evidence.
...
The shipped adjacent `include/zigux/abi.h` foothold mirrors that same bounded posture for C-side callers that only need read-only notifier ordering or list-link truthfulness.
