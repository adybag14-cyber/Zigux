...
- scope: one review-process note plus its dedicated manifest and Zig test; the current packet also points at the directly coupled review-checklist, parity-scorecard, indefinite-C policy, and shared Phase 15 build surfaces that must stay aligned with this lane's required review fields, decision buckets, reopen-trigger catalog, and no-approval posture without treating those support surfaces as review-process-owned maintenance lanes
