...
The next honest bounded step inside the same Phase 11 lane is now one tiny timeout-property or drvdata-order checkpoint that stays immediately adjacent to the new descriptor preflight and the existing registration handoff, before any live GPIO or broader platform glue lands.
