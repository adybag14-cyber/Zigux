...
- `drivers/virtio/virtio_driver_id.zig`, `zigux/tests/phase10_virtio_driver_id.zig`, and `zigux/tests/phase10_virtio_ring.zig` remain repo-reality gaps or last-known packet members rather than shipped current-`master` evidence.
