...
Do not restate the still-missing broader `zigux/tests/phase10_virtio_ring.zig` replay as directly materialized evidence until a fresh reread proves it has returned on current `master`.