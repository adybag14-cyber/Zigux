...
Do not restate the still-missing verify replay or dedicated survey gate as directly materialized evidence until a fresh reread proves they have returned on current `master`.
