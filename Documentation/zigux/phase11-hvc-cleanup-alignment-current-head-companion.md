...
direct starter, current survey note, current companion, returned verify helper,
verify-helper boundary note, validation matrix, build-inventory checker,
...
witness likewise stays directly readable through
...
missing manifest and teardown note as returned, and do not push the returned
verify helper back into missing-helper wording while the sysrq helper, focused
