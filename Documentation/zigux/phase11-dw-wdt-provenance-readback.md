...
- the honest survey-lane move is to keep the continuity trail truthful about both what current `master` materializes and which read path actually exposes it in this environment.
