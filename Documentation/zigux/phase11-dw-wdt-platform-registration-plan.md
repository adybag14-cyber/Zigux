...
Keep the live driver, verify, direct replay, registration-scaffold, and owner-lane continuity packet explicit while the next implementation step stays inside `zigux/tests/phase11_dw_wdt_registration_scaffold.zig` and `drivers/watchdog/dw_wdt.zig`.
