...
This survey note tracks the Phase 11 gap around `drivers/watchdog/bcm2835_wdt.c` after re-reading `master` `994722771929e467dc5da31c0820cf26dfbb7c66`.
...
This lane still does not claim watchdog-core registration, PM base wiring, live remove-time poweroff-handler release behavior, or hardware validation coverage.

The next honest bounded step inside the same lane is to add a tiny hardware-validation matrix before any platform registration, PM base plumbing, or live poweroff-handler coordination.
