...
- `zigux/tests/fixtures/phase6_base64_vectors.zig` is the current static base64 corpus with 22 standard encode vectors, 24 variant encode vectors, 22 standard decode vectors, 16 variant decode vectors, and 28 invalid decode vectors, including a repeated-alternate-alphabet multi-quartet sample family for the URL-safe and IMAP branches plus padded malformed tail-bit rejects across the standard, URL-safe, and IMAP variants.
