...
- this survey packet now records the inspected `master` head `436e1b0f84c53777c5f24668ef847c5dda019ad3`, which keeps the directly coupled MMIO survey artifacts aligned with the bounded config-write helper state.
