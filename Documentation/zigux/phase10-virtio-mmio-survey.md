...
- this means the roadmap's "virtqueue wrappers first, MMIO wrappers later" rule now holds for a small but real MMIO foothold through the config-write rung, while the broader lifecycle and IRQ paths remain intentionally blocked.
