...
- this survey packet now records the inspected `master` head `81356ba2b96caf155f2c8788b3ede1fbb4c96d74`, which keeps the directly coupled MMIO survey artifacts aligned with the bounded config-write helper state.
