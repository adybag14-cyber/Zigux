...
- this survey packet now records the inspected `master` head `09229747ad125661be1d17d3d55d87ef11cd33e4`, which keeps the directly coupled MMIO survey artifacts aligned with the current bounded helper state after the latest live `master` review.
