...
- `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md` now rematerializes the dedicated apply-observation replay and standalone build shard beside the shared closure packet, while `zigux/tests/README.md` remains the next shared reminder surface to realign with that already-landed VM-friendly replay.
