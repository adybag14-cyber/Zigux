...
- this survey packet now records the inspected `master` head `fda9b64a5beee1dad9545d0bffd585d0adae8c4b`, which keeps the directly coupled MMIO survey artifacts aligned with the hardened config-write inventory checks on the bounded helper state.
