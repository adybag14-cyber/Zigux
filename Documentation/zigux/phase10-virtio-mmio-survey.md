...
The direct closure-inventory and harness-coverage guards now appear here explicitly because the manifest-backed MMIO packet depends on that published closure path to keep the landed interrupt-ack rung and the parked lifecycle-and-IRQ blocker fail-closed together.
