...
- this survey packet now records the inspected `master` head `9f8501ee18b903cf2e19646d952e55563a7e642a`, which keeps the directly coupled MMIO survey artifacts aligned with the current bounded helper state after the latest live `master` review.
