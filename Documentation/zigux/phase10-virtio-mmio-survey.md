...
- this survey packet now records the inspected `master` head `8bda4f7c3b6270f184ec382c9cc830a54de67723`, which keeps the directly coupled MMIO survey artifacts aligned with the bounded config-write helper state.
