...
- current direct lane readback still does not materialize `drivers/virtio/virtio_driver_id.zig` and `zigux/tests/phase10_virtio_driver_id.zig` through the direct readback available in this lane, but the current mixed direct-read plus public current-`master` fallback reread now reconfirms `Documentation/zigux/phase10-virtio-core-slice.md`, `drivers/virtio/virtio_verify.zig`, `zigux/tests/phase10_virtio_core_manifest.json`, `zigux/tests/phase10_virtio_core_survey.zig`, `zigux/tests/phase10_virtio_core_reset_queue.zig`, `zigux/tests/phase10_virtio_core_interrupt_compound_ack.zig`, and `zigux/tests/phase10_virtio_ring.zig`; keep those mixed-source returned companions explicit beside the returned bounded core replay `zigux/tests/phase10_virtio_core.zig`, while only `drivers/virtio/virtio_driver_id.zig` and `zigux/tests/phase10_virtio_driver_id.zig` stay framed as the remaining repo-reality gaps in this lane.
...
Treat `scripts/zigux/README.md` as the current dedicated Phase 10 scripts-root packet on current `master` and keep it aligned with the shared closure note, lane-sequencing note, review checklist, the validator-first guide, and tests-root reminder instead of leaving it in neighboring-surface wording.

Treat `Documentation/zigux/phase10-closure-evidence.md`, `Documentation/zigux/phase10-virtio-driver-lane-sequencing.md`, `Documentation/zigux/phase10-phase11-phase13-validator-first-review-guide.md`, `scripts/zigux/validate-phase10-closure.py`, `Documentation/zigux/phase10-virtio-core-survey.md`, `zigux/tests/phase10_virtio_core.zig`, `zigux/tests/phase10_closure_manifest.json`, `Documentation/zigux/phase10-virtio-ring-survey.md`, `Documentation/zigux/phase10-virtio-ring-slice.md`, `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md`, `drivers/virtio/virtio_ring.zig`, `drivers/virtio/virtio_ring_verify.zig`, `drivers/virtio/virtio_ring_publish_readiness.zig`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_notification_data_readiness.zig`, `zigux/tests/phase10_virtio_ring_prepare_kick_idempotent.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_broken_queue_queue_discipline.zig`, `zigux/tests/phase10_virtio_ring_delayed_callback_budget.zig`, `Documentation/zigux/phase10-virtio-input-slice.md`, `Documentation/zigux/phase10-virtio-input-module-slice.md`, `Documentation/zigux/phase10-virtio-input-survey.md`, `Documentation/zigux/phase10-virtio-mmio-survey.md`, `Documentation/zigux/phase10-virtio-mmio-config-write-disposition-companion.md`, `Documentation/zigux/phase10-virtio-mmio-slice.md`, `drivers/virtio/virtio_mmio.zig`, `drivers/virtio/virtio_mmio_verify.zig`, `zigux/tests/phase10_virtio_mmio_manifest.json`, `zigux/tests/phase10_virtio_mmio.zig`, `zigux/tests/phase10_virtio_mmio_survey.zig`, `scripts/zigux/check-phase10-mmio-packet.py`, and `zigux/tests/phase10_build.zig` as the current directly re-readable Phase 10 anchors in this reminder surface.
...
Keep `drivers/virtio/virtio_ring.zig`, `drivers/virtio/virtio_ring_verify.zig`, `drivers/virtio/virtio_ring_publish_readiness.zig`, `zigux/tests/phase10_virtio_ring_notification_data_readiness.zig`, `zigux/tests/phase10_virtio_ring_prepare_kick_idempotent.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_broken_queue_queue_discipline.zig`, `zigux/tests/phase10_virtio_ring_delayed_callback_budget.zig`, `zigux/tests/phase10_virtio_ring_manifest.json`, `Documentation/zigux/phase10-virtio-ring-survey.md`, and `zigux/tests/phase10_virtio_ring_survey.zig` explicit as the current direct-readback ring helper-and-survey packet when broader shared summaries refresh, with `Documentation/zigux/phase10-virtio-ring-slice.md` and `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md` still named separately as the packet-local companions and the public current-`master` `zigux/tests/phase10_virtio_ring.zig` replay kept explicit as the returned broader ring companion while exact direct-path readback in this runtime still misses it.
...
Current exact-path contents reads in this runtime still do not rematerialize the full packet-local slice set on their own, but the current mixed-source reread now reconfirms `Documentation/zigux/phase10-virtio-core-slice.md`, `drivers/virtio/virtio_verify.zig`, `zigux/tests/phase10_virtio_core_manifest.json`, `zigux/tests/phase10_virtio_core_survey.zig`, `zigux/tests/phase10_virtio_core_reset_queue.zig`, `zigux/tests/phase10_virtio_core_interrupt_compound_ack.zig`, and `zigux/tests/phase10_virtio_ring.zig` through public current-`master` fallback beside the direct packet anchors above. Keep those mixed-source returned core companions explicit here, and keep only `drivers/virtio/virtio_driver_id.zig` plus `zigux/tests/phase10_virtio_driver_id.zig` framed as the remaining core-side repo-reality gaps.

Tests-root reviewer prompt:
- Do the docs-root notes, scripts-root guards, tests-root packet, the workflow-backed bootstrap route through `scripts/zigux/check-phase10-bootstrap-route.py` and `.github/workflows/zigux-bootstrap.yml`, the shared freeze-boundary guard through `scripts/zigux/check-phase10-shared-freeze-boundary.py`, the shared closure note, the lane-sequencing note, the validator-first guide, the returned shared validator pair and closure manifest, the returned core survey note plus the returned bounded core replay `zigux/tests/phase10_virtio_core.zig`, the ring survey, slice, and freeze-boundary notes, the direct ring helper packet through `drivers/virtio/virtio_ring.zig`, `drivers/virtio/virtio_ring_verify.zig`, `drivers/virtio/virtio_ring_publish_readiness.zig`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_notification_data_readiness.zig`, `zigux/tests/phase10_virtio_ring_prepare_kick_idempotent.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_broken_queue_queue_discipline.zig`, `zigux/tests/phase10_virtio_ring_delayed_callback_budget.zig`, the returned dedicated ring survey gate `zigux/tests/phase10_virtio_ring_survey.zig`, the shared `zigux/tests/phase10_build.zig` gate, and the public current-`master` `zigux/tests/phase10_virtio_ring.zig` replay kept explicit as the returned broader ring companion while exact direct-path readback in this runtime still misses it, the input slice, input module slice, input survey, `zigux/tests/phase10_virtio_input_manifest.json`, direct input helpers, queue-callback-preflight, registration-preflight, teardown-observation, and status-drain replays, the helper-local MMIO survey plus `Documentation/zigux/phase10-virtio-mmio-config-write-disposition-companion.md`, `Documentation/zigux/phase10-virtio-mmio-slice.md`, `drivers/virtio/virtio_mmio.zig`, `drivers/virtio/virtio_mmio_verify.zig`, `zigux/tests/phase10_virtio_mmio_manifest.json`, `zigux/tests/phase10_virtio_mmio.zig`, `zigux/tests/phase10_virtio_mmio_survey.zig`, and `scripts/zigux/check-phase10-mmio-packet.py`, the input-lane wrapper split where `drivers/virtio/virtio.zig` owns shared device-status bookkeeping, `drivers/virtio/virtio_ring.zig` owns virtqueue wrapper shape and notification planning, and `drivers/virtio/virtio_mmio.zig` owns MMIO wrapper planning, the blocked risky-transport posture, the returned `zigux/Makefile` body plus `make -C zigux phase10-validate`, `make -C zigux phase10-test`, and `make -C zigux phase10` explicit as the shared build gate, the allowed `drivers/virtio/*.zig` plus justified `zigux/kernel/` or `zigux/helpers/` destination family, the shared closure-packet vocabulary around `zigux/tests/phase10_closure_manifest.json`, and the Phase 14 study-only ownership of `kernel/workqueue.c` and `kernel/trace/ring_buffer.c` stay aligned on the same bounded virtio story while keeping only `drivers/virtio/virtio_driver_id.zig` and `zigux/tests/phase10_virtio_driver_id.zig` framed as the remaining repo-reality gaps instead of direct current-head evidence?
...
Current `master` does materialize `scripts/zigux/validate-phase11.py` and `zigux/Makefile`, and its live body now exposes `make -C zigux phase11-validate` even though it still does not expose `make -C zigux phase11` or `make -C zigux phase11-contract`; current direct readback also rematerializes `Documentation/zigux/phase11-dw-wdt-platform-registration-plan.md`, `Documentation/zigux/phase11-dw-wdt-provenance-readback.md`, `Documentation/zigux/phase11-dw-wdt-lane-sequencing-gap.md`, `Documentation/zigux/phase11-dw-wdt-verify-alignment-gap.md`, `drivers/watchdog/dw_wdt.zig`, `drivers/watchdog/dw_wdt_verify.zig`, `zigux/tests/phase11_dw_wdt_manifest.json`, `zigux/tests/phase11_dw_wdt.zig`, `zigux/tests/phase11_dw_wdt_registration_scaffold.zig`, `scripts/zigux/check-phase11-dw-wdt-teardown-packet.py`, and `scripts/zigux/check-phase11-dw-wdt-verify-alignment.py`. Current direct readback still does not rematerialize `zigux/tests/phase11_build.zig`, `Documentation/zigux/phase11-shared-replay-contract.md`, `Documentation/zigux/phase11-closure-note.md`, `scripts/zigux/check-phase11-shared-replay-contract.py`, `scripts/zigux/check-phase11-shared-summary-surfaces.py`, `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`, `Documentation/zigux/phase11-dw-wdt-survey.md`, `Documentation/zigux/phase11-dw-wdt-slice.md`, `Documentation/zigux/phase11-dw-wdt-teardown-note.md`, `zigux/tests/phase11_dw_wdt_survey.zig`, the older DesignWare packet-checker handle `scripts/zigux/check-phase11-dw-wdt-packet.py`, `Documentation/zigux/phase11-dw-wdt-clock-acquisition-plan.md`, or the deeper HVC helper and replay family through `drivers/tty/hvc/hvc_console_verify.zig`, `drivers/tty/hvc/hvc_console_sysrq.zig`, `zigux/tests/phase11_hvc_console.zig`, `zigux/tests/phase11_hvc_cleanup.zig`, `zigux/tests/phase11_hvc_console_survey.zig`, `zigux/tests/phase11_hvc_console_manifest.json`, `Documentation/zigux/phase11-hvc-console-slice.md`, `Documentation/zigux/phase11-hvc-console-teardown-note.md`, and `scripts/zigux/check-phase11-hvc-survey-packet.py`, so keep those route, checker, and replay surfaces framed as repo-reality gaps or archival vocabulary rather than current tests-root evidence.

Keep the returned shared validator `scripts/zigux/validate-phase11.py`, the returned `zigux/Makefile` surface, and the `make -C zigux phase11-validate` route explicit as the shared validation-and-build gate instead of leaving them visible only as a current-head caveat beside the still-missing aggregate replay routes.

Tests-root reviewer prompt:
- Does the shared Phase 11 reminder keep the shared owner-map note, the matrix-gap survey, the contributor-sync companion, the returned bcm2835, gpio, HVC, and header-boundary validation packet, the currently direct DesignWare continuity packet through the platform-registration, provenance, lane-gap, verify-alignment, helper, replay, manifest, registration-scaffold, and checker surfaces, the narrower HVC current-head continuity packet, the returned HVC proof-backed adjunct inventory plus the standalone `zigux/tests/phase11_hvc_targetless_unregister_gap.zig` witness and `zigux/tests/phase11_hvc_targetless_unregister_gap_build.zig` build shard, the returned shared validator `scripts/zigux/validate-phase11.py`, the returned `zigux/Makefile` surface plus `make -C zigux phase11-validate` as the shared validation-and-build gate, and the still-missing shared Phase 11 build, replay-contract, direct DesignWare clock-acquisition-plan, validation-matrix, survey, slice, teardown-note, dedicated survey replay, older DesignWare packet-checker handle, deeper HVC replay surfaces, plus the still-missing `make -C zigux phase11` and `make -C zigux phase11-contract` routes aligned without promoting platform-backed execution or a broader replay roster into current tests-root proof?
