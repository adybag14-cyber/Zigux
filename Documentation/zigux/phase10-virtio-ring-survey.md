...
- `Documentation/zigux/phase10-virtio-ring-slice.md` now carries that vocabulary in one packet-local note while keeping the focused replays, the publish-readiness replay, and the dedicated survey replay explicit current-head evidence without promoting the missing broader replay.
