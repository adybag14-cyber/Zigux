...
- `Documentation/zigux/phase10-virtio-ring-slice.md` now carries that vocabulary in one packet-local note while keeping the focused replays, the registration replay, the publish-readiness replay, the dedicated survey replay, and the broader replay explicit as reviewable ring evidence without promoting that broader replay into transport-backed claims.
