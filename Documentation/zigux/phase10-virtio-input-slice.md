...
- dedicated Phase 10 tests and build wiring for the helper, including the wrapper-facing `drivers/virtio/virtio_input_verify.zig` replay and the focused status-drain replay
