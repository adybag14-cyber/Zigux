...
Leave this helper parked unless fresh repo inspection shows a concrete checksum-local parity, perf-matrix, fixture-governance, or direct C parity drift. If this slice reopens soon, keep the next move inside `lib/checksum.zig`, `zigux/tests/phase6_checksum.zig`, `zigux/tests/phase6_checksum_perf.zig`, `zigux/tests/phase6_checksum_c_parity.zig`, `zigux/tests/fixtures/phase6_checksum_vectors.zig`, `zigux/tests/fixtures/phase6_checksum_c_harness.c`, or `scripts\zigux/check_phase6_checksum_c_parity.zig` rather than widening into hexdump re-materialization or broader shared-note churn.
