...
- `PHASE13_SURVEYED_COMMIT=10d0915b81c307b48c93c49f6e54ba43d8ad8704`
...
- reviewed against live `master` `10d0915b81c307b48c93c49f6e54ba43d8ad8704`
- `lib/devres.zig` already anchors a helper-first `DevresHelperLab` on `lib/devres.c`
- compared against the earlier surveyed head `b967ad6bc0f58c912232df1249217f0dbff9389f`, the current helper packet stays byte-for-byte unchanged; `lib/devres.zig` still hashes to `sha256 2bbad8cad014471312865a57a249412b29af4574d8a6918f8bb66f4948973eda`
- compared against that same earlier surveyed head, the dedicated `zigux/tests/phase13_devres.zig` replay also stays byte-for-byte unchanged and still hashes to `sha256 7dc45ab99f46d5424e3d757f720e58654aaea326b13db1af601be88c3cbff476`
