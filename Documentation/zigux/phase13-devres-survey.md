...
- `Documentation/zigux/phase13-devres-scatterlist-planner.md` records landed pure scatterlist lifetime and `sg_table` teardown planning surfaces instead of leaving that helper as adjacent evidence only.
