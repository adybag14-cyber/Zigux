...
The shared `phase12` smoke-and-test sextet remains unchanged; this lab is a separate compile-smoke packet that now proves six bounded properties:
...
- preexisting free transmit descriptors count toward the stopped-queue wake gate before parity is claimed
