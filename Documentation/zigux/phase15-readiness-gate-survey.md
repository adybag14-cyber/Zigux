...
- a fresh 2026-05-15 reread reopened one bounded shared-summary drift in `scripts/zigux/README.md`: the scripts-root Phase 15 flow still undercounts the live `phase15-validate` route by omitting `python3 scripts/zigux/check-phase15-docs-readme-alignment.py` and `python3 scripts/zigux/check-phase15-shared-summary-gap.py`, while `Documentation/zigux/README.md` and `Documentation/zigux/review-checklist.md` remain aligned with the current parked packet and `zigux/tests/README.md` remains scoped to the sequencing-marker plus replay-route packet
- start that bounded same-lane follow-through with `python3 scripts/zigux/check-phase15-scripts-readme-alignment.py` and `python3 scripts/zigux/check-phase15-shared-summary-gap.py`, keep the repair scoped to `scripts/zigux/README.md` plus `scripts/zigux/check-phase15-scripts-readme-alignment.py`, and leave packet-local readiness prose parked until that scripts-root reminder lands
- if the shared packet drifts again after that scripts-root repair, re-check `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase15-architecture-council-review-process.md`, `Documentation/zigux/phase15-parity-scorecard-survey.md`, `Documentation/zigux/phase15-handoff-next-steps-survey.md`, `Documentation/zigux/phase15-readiness-gate-survey.md`, `Documentation/zigux/phase15-governance-lane-sequencing.md`, `scripts/zigux/README.md`, `scripts/zigux/validate-phase15.py`, `scripts/zigux/check-phase15-docs-readme-alignment.py`, `scripts/zigux/check-phase15-scripts-readme-alignment.py`, `scripts/zigux/check-phase15-review-process-handoff.py`, `zigux/tests/phase15_readiness_gate_manifest.json`, `zigux/tests/phase15_readiness_gate.zig`, `zigux/tests/README.md`, and `zigux/Makefile` together, starting with whether the dedicated readiness packet still keeps the parked `make -C zigux phase15-validate`, `make -C zigux phase15-test`, and `make -C zigux phase15` routes aligned with the current no-approval-yet maintenance-mode blocker posture before widening into any new governance slice
