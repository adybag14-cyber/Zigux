...
That docs-root, scripts-root, and checker-local determinism follow-through is closed on `master`, but the tests-root determinism cleanup still remains the next honest same-lane repair called out above.
