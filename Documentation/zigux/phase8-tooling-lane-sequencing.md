...
- exact 2026-05-11 default-branch readback still succeeds for `Documentation/zigux/phase8-tooling-lane-sequencing.md`, `Documentation/zigux/phase8-userspace-kernel-bridge-boundary-survey.md`, `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `scripts/zigux/README.md`, `zigux/tests/README.md`, and `scripts/zigux/validate-phase8.py`
...
- current shared-surface drift: `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `scripts/zigux/README.md`, `zigux/tests/README.md`, and `zigux/Makefile` still name removed Phase 8 slice-note files, shard tests, or libbpf-segment members even though the current default-branch content surface does not expose those packet anchors
...
- the default-branch content surface does not currently expose `Documentation/zigux/phase8-exec-cmd-slice.md` or `Documentation/zigux/phase8-help-slice.md`
- the default-branch content surface does not currently expose `tools/lib/subcmd/exec-cmd.zig` or `tools/lib/subcmd/help.zig`
- the default-branch content surface does not currently expose the older `zigux/tests/phase8_exec_cmd*.zig` or `zigux/tests/phase8_help*.zig` companions
...
Current repo reality:
- the default-branch content surface does not currently expose `tools/lib/symbol/`
- the default-branch content surface does not currently expose the older `zigux/tests/phase8_kallsyms*.zig` companions
...
Current repo reality:
- the default-branch content surface does not currently expose `tools/lib/bpf/zigux_segments/`
- the default-branch content surface does not currently expose the older `zigux/tests/phase8_*` libbpf shard packet
...
- current `master` still carries only the shared reminder packet, this owner-map note, and the dedicated command-gap survey as directly readable Phase 8 evidence on the default-branch content surface
...
- when this lane reopens, start with `scripts/zigux/README.md`, then reread `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, and `zigux/Makefile` against that same default-branch content evidence before widening any wording repair
