...
- current 2026-05-12 exact readback shows `scripts/zigux/README.md` still mis-cases `zigux/tests/phase8_exec_cmd_only_build.zig` and `zigux/tests/phase8_cpu_mask_only_build.zig` as uppercase variants even though the sequencing note, docs-root summary, tests-root packet, validator, and live tree readback all keep the correct filenames explicit
...
## Next bounded step
The next honest shared-surface reopen cue now starts with `scripts/zigux/README.md`: current exact readback shows the Phase 8 scripts-root summary still mis-cases `zigux/tests/phase8_exec_cmd_only_build.zig` and `zigux/tests/phase8_cpu_mask_only_build.zig` even though the sequencing note, docs-root summary, tests-root packet, validator, and live tree readback all keep the correct filenames explicit.
