...
- A stay-in-C closeout must keep the retained `freeze_in_c` decision, the current blocker, the required approver set, retained discussion state, reopen triggers, and the evidence archive path explicit.
