...
The next honest bounded step in this same helper family is the smallest `dcache_dir_open()` / `dcache_readdir()` cursor-precondition planner that stays reviewable without claiming live cursor dentries, sibling traversal, or lock ordering.
