...
On current `master`, the older docs-root follow-through is already closed: `Documentation/zigux/README.md` now keeps `scripts/zigux/check-phase13-notifier-packet.py`, `include/zigux/abi.h`, `zigux/helpers/list_view.zig`, and `zigux/helpers/hlist_view.zig` explicit in both the broad Phase 13 contributor-workflow inventory and the later adjacent release-surface clause. The next smallest same-lane follow-through is to reread `Documentation/zigux/README.md`, `Documentation/zigux/phase10-phase11-phase13-contributor-surface-sync.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/phase13-contributor-workflow-guide.md`, `scripts/zigux/README.md`, and `zigux/tests/README.md` together for the next one-surface Phase 13 wording drift without reopening helper-local ownership or notifier packet scope.
