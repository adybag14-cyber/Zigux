...
Treat `scripts/zigux/check-phase13-shared-summary-surfaces.py` plus `make -C zigux phase13-validate` as the stable shared-summary guard and shared replay handle.
