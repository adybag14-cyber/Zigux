...
- mirrors the bounded `is_running`, `start`, `ping`, `set_timeout`, `stop`, `get_timeleft`, and restart behavior through register-image transitions only
