...
- adds a tiny platform-registration and PM-base handoff summary for parent attachment, PM base availability, drvdata handoff readiness, and register-device intent only
- adds a tiny poweroff-path summary for shared system-poweroff callback ownership, halt-partition request intent, and the short restart arming sequence without claiming a live poweroff hook installation
