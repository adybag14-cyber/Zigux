...
4. keep the focused lower- and upper-bound C ABI replay aligned with the current helper packet
- `zigux/tests/phase6_bsearch_lower_bound_c_abi.zig`

5. keep the focused direct C ABI equality-budget replay aligned with the current helper packet
- `zigux/tests/phase6_bsearch_c_abi_budget.zig`

6. keep the shared Phase 6 surface checker aligned with this slice
