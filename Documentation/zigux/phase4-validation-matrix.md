...
- perf threshold status: correctness-only gate today; no hard timing threshold is approved until the lane grows past the current range, rounded-prefix, starter-population summary, exact nth-lookup, and copy-behavior checkpoints
