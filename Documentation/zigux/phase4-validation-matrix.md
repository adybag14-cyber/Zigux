...
- canonical Phase 4 entrypoint: `zigux/tests/atomic64_diff.zig`, which keeps the roadmap-facing wrapper path published while delegating to this single replay body
