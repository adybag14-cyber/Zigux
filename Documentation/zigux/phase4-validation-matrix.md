...
- the external artifact-diff contract replay that keeps the published `ARTIFACT_DIFF=...`, `MODE=...`, `EXPECTED_EXISTS=...`, `ACTUAL_EXISTS=...`, malformed-JSON markers, SHA-256 digest fields, and exit-code surface reviewable outside the helper's built-in self-test
