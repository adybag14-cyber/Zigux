...
- current rollback evidence gap: none inside the shipped bitmap gate; the remaining roadmap-tracked Phase 4 gaps now sit outside this bitmap lane in the still-unlanded sample ports and perf thresholds recorded below
