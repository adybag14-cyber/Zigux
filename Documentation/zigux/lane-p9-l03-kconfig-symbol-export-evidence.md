...
Observed runtime output from a local compile of the fetched `confdata_bridge.zig` slice with Zig `0.17.0-dev.877+a3ae499dc`:
...
- compiled the fetched `scripts/zigux/kconfig/confdata_bridge.zig` source with the attached Zig toolchain `0.17.0-dev.877+a3ae499dc`
