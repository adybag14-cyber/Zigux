...
* bytestream packet work currently belongs in `Documentation/zigux/phase5-kfifo-sample-survey.md`, `samples/zigux/bytestream_fifo.zig`, and the directly readable companion manifest `zigux/tests/phase5_bytestream_fifo_manifest.json`; do not restate the older bytestream tests-root or shared-build packet as directly readable evidence until a fresh reread proves those remaining paths returned
