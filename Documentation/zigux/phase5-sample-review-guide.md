...
* within that shared set, `Documentation/zigux/phase5-sample-review-guide.md`, `Documentation/zigux/phase5-kretprobe-sample-survey.md`, `Documentation/zigux/review-checklist.md`, `samples/zigux/README.md`, and `zigux/tests/README.md` already reflect the survey-note-only kretprobe posture, while `Documentation/zigux/README.md`, `scripts/zigux/README.md`, `zigux/Makefile`, and `.github/workflows/zigux-bootstrap.yml` still need their own bounded follow-through before they should be reused as source text for kretprobe or shared-build claims
