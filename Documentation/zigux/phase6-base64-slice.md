...
## Next Step
Leave this slice parked unless helper behavior, focused fixture-backed replay coverage, the direct C parity companion, or the dedicated perf replay drifts on current `master`.
