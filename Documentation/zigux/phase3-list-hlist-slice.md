...
- this slice lands the shared dump, expected fixture, C harness, checker route, and shared tests-root hook without widening into broader Phase 3 reminder-surface work