...
- if a file under `samples/zigux/runtime_*` shares a family name with a Phase 5 sample lane or helper anchor such as bitmap, do the docs still say clearly that it is a Phase 9 runtime pilot rather than a Phase 5 approved reference idiom?
