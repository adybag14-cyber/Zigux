...
- if the change touches the shared Phase 13 release-discipline packet, do `Documentation/zigux/phase13-release-notes-survey.md`, `Documentation/zigux/phase13-roadmap-traceability.md`, `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, and `zigux/tests/phase13_build.zig` still agree that the tranche is active rather than closed and that `lib/devres.c` remains the only roadmap anchor without a manifest-backed survey packet?
