...
- the directly readable focused replay packet, manifest companion, survey gate, and tests-root guide now keep the broader bytestream review packet explicit while the shared build companion stays on the public-tree-backed side
