...
- if a shared README, guide, checklist, or dedicated guide-surface checker later stops naming the restored direct bytestream packet or underdescribes the sample-root preview, window-contract, helper-boundary replays, or the named queue-window companion step, repair only that one file
