...
- `PHASE3_POLICY_SLICE_DOC_BLOB_SHA=51dd9f90c5a1d9943a86ba72f252adc2e241f4e0`
- `PHASE3_LOW_LEVEL_WRAPPER_SURVEY_DOC_BLOB_SHA=e349c489c69717bd392d22f890aa28a0b9c4fc93`
...
- the layout helper now keeps the canonical starter layouts, the notifier block, notifier priority-increase, malformed list-link layouts, the chrdev budget-window delivery-window layouts, and the interop plus facility, status, and notifier-result values explicit again, while the helper-local policy starter packet, direct starter packet test route, focused policy dump route, and directly coupled low-level-wrapper packet own the live replay and survey evidence
