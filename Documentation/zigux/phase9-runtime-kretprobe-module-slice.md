...
- direct shared selftest-hook evidence rejection in the shared request surface plus prepared selftest-hook drift rejection, prepared shared-plan drift rejection, and prepared shared allocator and init-flow drift rejection that keep the loader packet truthful about the currently shipped review surface
