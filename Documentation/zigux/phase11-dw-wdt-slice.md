...
- adds a tiny platform-resource preflight that keeps the timer-clock choice, optional APB clock presence, reset-control availability, and optional pretimeout-IRQ wiring reviewable before any live devm calls
