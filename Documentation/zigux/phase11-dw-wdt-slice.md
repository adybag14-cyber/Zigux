...
- adds a tiny teardown-facing lifecycle summary so reset-control-backed reset-pulse intent versus continued watchdog heartbeats without reset stays reviewable before any live platform remove or PM teardown work
