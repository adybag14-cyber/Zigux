...
The next honest bounded step inside the same Phase 11 lane is to add a small registration-facing handoff around watchdog info selection, parent linkage, and register-device intent before any platform-backed behavior lands.
