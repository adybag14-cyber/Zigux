...
- ring lane `P10-L07` currently owns the fail-closed ring reminder packet in `zigux/tests/phase10_virtio_ring_manifest.json` and `Documentation/zigux/phase10-virtio-ring-survey.md`; current `master` readback returns `404` for `drivers/virtio/virtio_ring.zig`, `zigux/tests/phase10_virtio_ring.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring_verify.zig`, `scripts/zigux/check-phase10-ring-packet.py`, and `Documentation/zigux/phase10-virtio-ring-slice.md`, so the next same-lane follow-through is either one bounded restore step or one directly coupled reminder-packet truthfulness repair rather than more wrapper-growth claims
...
- input lane `P10-L13` currently owns the fail-closed input reminder packet in `zigux/tests/phase10_virtio_input_manifest.json` plus the still-directly-readable teardown-observation replay `zigux/tests/phase10_virtio_input_teardown_observation.zig`; current `master` readback returns `404` for `Documentation/zigux/phase10-virtio-input-survey.md`, `Documentation/zigux/phase10-virtio-input-slice.md`, `Documentation/zigux/phase10-virtio-input-module-slice.md`, `drivers/virtio/virtio_input.zig`, `drivers/virtio/virtio_input_verify.zig`, `scripts/zigux/check-phase10-input-packet.py`, `zigux/tests/phase10_virtio_input.zig`, `zigux/tests/phase10_virtio_input_probe_preflight.zig`, `zigux/tests/phase10_virtio_input_queue_callback_preflight.zig`, `zigux/tests/phase10_virtio_input_registration_preflight.zig`, `zigux/tests/phase10_virtio_input_status_drain.zig`, and `zigux/tests/phase10_virtio_input_survey.zig`, so the next same-lane follow-through is either one bounded restore step or one directly coupled reminder-packet truthfulness repair rather than more wrapper-growth claims
...
- ring packet review currently owns the fail-closed ring reminder surfaces in `zigux/tests/phase10_virtio_ring_manifest.json` and `Documentation/zigux/phase10-virtio-ring-survey.md`; shared reminders such as `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `Documentation/zigux/review-checklist.md`, and `zigux/tests/README.md` should inherit that fail-closed posture instead of relisting the missing direct ring helper packet as live current-master evidence; do not inventory `drivers/virtio/virtio_ring.zig`, `zigux/tests/phase10_virtio_ring.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring_verify.zig`, `scripts/zigux/check-phase10-ring-packet.py`, or `Documentation/zigux/phase10-virtio-ring-slice.md` as current-master evidence again until those paths are restored and reread successfully
- input packet review currently owns the fail-closed input reminder surfaces in `zigux/tests/phase10_virtio_input_manifest.json` plus the still-directly-readable teardown-observation replay `zigux/tests/phase10_virtio_input_teardown_observation.zig`; shared reminders should inherit that narrower repo-reality posture instead of relisting `Documentation/zigux/phase10-virtio-input-survey.md`, `Documentation/zigux/phase10-virtio-input-slice.md`, `Documentation/zigux/phase10-virtio-input-module-slice.md`, `drivers/virtio/virtio_input.zig`, `drivers/virtio/virtio_input_verify.zig`, `scripts/zigux/check-phase10-input-packet.py`, `zigux/tests/phase10_virtio_input.zig`, `zigux/tests/phase10_virtio_input_probe_preflight.zig`, `zigux/tests/phase10_virtio_input_queue_callback_preflight.zig`, `zigux/tests/phase10_virtio_input_registration_preflight.zig`, `zigux/tests/phase10_virtio_input_status_drain.zig`, or `zigux/tests/phase10_virtio_input_survey.zig` as live current-master evidence again until those paths are restored and reread successfully
...
7. When a broad reminder surface changes, prefer the directly shipped closure-manifest and checker-backed review packet over speculative packet-local inventory growth, and keep the ring lane on `Documentation/zigux/phase10-virtio-ring-survey.md` plus `zigux/tests/phase10_virtio_ring_manifest.json` until the direct ring helper, verifier, checker, survey gate, and drained-reset reuse replay materialize again.
