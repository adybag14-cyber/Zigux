...
- ring packet review currently owns the fail-closed ring reminder surfaces in `zigux/tests/phase10_virtio_ring_manifest.json` and `Documentation/zigux/phase10-virtio-ring-survey.md`; do not inventory `drivers/virtio/virtio_ring.zig`, `zigux/tests/phase10_virtio_ring.zig`, `zigux/tests/phase10_virtio_ring_reset_reuse.zig`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring_verify.zig`, `scripts/zigux/check-phase10-ring-packet.py`, or `Documentation/zigux/phase10-virtio-ring-slice.md` as current-master evidence again until those paths are restored and reread successfully
