...
- current `master` may move independently after this checkpoint; the live truthfulness source for the lane is the current driver, tests, validation matrix, and shared replay contract rather than this archived commit pin alone
