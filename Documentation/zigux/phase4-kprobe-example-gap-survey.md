...
## Purpose
This parked Phase 4 gap packet keeps the still-absent `samples/zigux/kprobe_example.zig` boundary reviewable without pretending that a shipped Zig starter already exists on current `master`.
