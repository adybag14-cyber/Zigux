...
The DesignWare watchdog lane owns the `dw_wdt` platform-facing starter, its dedicated packet checker, its registration-scaffold replay, and its teardown ownership note:
