...
* shared sequencing lane `P11-Y06` owns the shared packet truthfulness surfaces only: `Documentation/zigux/phase11-shared-replay-contract.md`, `Documentation/zigux/phase11-closure-note.md`, `Documentation/zigux/phase11-driver-lane-sequencing.md`, `scripts/zigux/check-phase11-shared-replay-contract.py`, and `scripts/zigux/check-phase11-shared-summary-surfaces.py`, plus the shared `zigux/Makefile` reminder surface, the direct `make -C zigux phase11-contract` route, and the shared Phase 11 workflow markers in `.github/workflows/zigux-bootstrap.yml`
...
* a dedicated shared validator or replay stack beyond the landed reminder checkers, Makefile and workflow route markers, and the bounded replay files already materialized on `master`
