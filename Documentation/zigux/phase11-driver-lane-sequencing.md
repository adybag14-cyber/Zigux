...
4. Keep the HVC survey, cleanup current-head checker, and starter-depth packet vocabulary authoritative for the HVC archival lane; shared sequencing work may cite that packet when comparing lane boundaries, but it must not claim ownership of the HVC-local note, checker, proof, direct replay surfaces, or the still-missing dedicated HVC survey-checker path.
