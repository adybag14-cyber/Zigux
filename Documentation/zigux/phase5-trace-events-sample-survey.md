...
- this approved payload-and-callback idiom is now pinned to `PHASE5_SURVEYED_COMMIT=a15760c3e46103fd41ae0da852b61f612e9116c6` so the sample-backed survey note, latest verification snapshot, sample-root catalog boundary, manifest-backed survey, and shared `phase5_build.zig` replay all point at the same inspected `master` head
