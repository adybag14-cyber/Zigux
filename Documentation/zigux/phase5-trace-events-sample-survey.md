...
- this approved payload-and-callback idiom is now pinned to `PHASE5_SURVEYED_COMMIT=c0b506e3254e63fe007a72d420bb275846a89093` so the sample-backed survey note, latest verification snapshot, sample-root catalog boundary, manifest-backed survey, and shared `phase5_build.zig` replay all point at the same inspected `master` head
