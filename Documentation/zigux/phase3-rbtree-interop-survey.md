...
- `Documentation/zigux/phase3-rbtree-slice.md`, `zigux/tests/phase3_rbtree_survey.zig`, and `zigux/tests/phase3_rbtree_manifest.json` keep the landed packet machine-checked
