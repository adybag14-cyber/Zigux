...
- `python3 scripts/zigux/check-phase3-rbtree-shared-lift-contract.py` now keeps the dedicated root-view layout, constants, shared replay, shared manifest catalog, and shared-lift note aligned before the shared ABI packet grows
