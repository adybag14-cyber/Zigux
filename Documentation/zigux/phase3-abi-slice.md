...
- the remaining same-lane rule is to keep the shared ABI slice, the manifest-backed inventory, the dedicated bindings-governance note, the lane-owner map, the header-family reminders, the validator-support note, the direct replay, and the focused layout proof honest together, and to avoid reverting to older wording that says the broad validator still trails the tree or that the starter boundary lacks direct exact-shape replay.
