...
- reserved bits, panic mode, allocator mode, and unsafe scope now fail through one explicit decode path before boundary code decides caller ownership, allocator-owned init and reset behavior, return behavior, or unsafe permissions
