...
- `zigux/tests/phase10_virtio_input_registration_blocker_build.zig` keeps the parked risky-transport registration fence explicit by replaying the dedicated blocker summary beside the survey packet instead of letting the landed blocker helper read like docs-only prose
