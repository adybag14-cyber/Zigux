...
2. leave the shared docs-root, scripts-root, tests-root, checklist, closure-manifest, `zigux/Makefile`, `make -C zigux phase10-validate`, `make -C zigux phase10-test`, `make -C zigux phase10`, and workflow packet parked unless a fresh repo-first reread finds a new same-lane truthfulness drift across `Documentation/zigux/README.md`, `scripts/zigux/README.md`, `zigux/tests/README.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase10-phase11-phase13-tests-root-review-companion.md`, `zigux/tests/phase10_closure_manifest.json`, or the direct ring, input, or MMIO helper-facing surfaces
