...
- `zigux/tests/phase11_hvc_targetless_unregister_gap.zig` and
  ...
  without widening the shared build-inventory packet.
...
- keep the targetless-unregister witness explicit as a standalone direct-readback
  replay that documents the current notifier-edge drift without promoting it to
  the shared proof inventory or a dedicated survey route claim
