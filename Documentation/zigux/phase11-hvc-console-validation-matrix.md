...
The bounded starter now covers slot validation, CRLF framing, flush-progress intent, teardown, the final-close wait boundary, the tiny remove-path handoff summary, and the tiny tty-registration handoff summary. The live repo still needed one reviewable note that explains:
