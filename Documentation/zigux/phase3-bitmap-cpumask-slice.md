...
This slice is intentionally helper-local. It does not yet claim exported ABI structs, scheduler-affinity semantics, or wider kernel cpumask traversal behavior.
