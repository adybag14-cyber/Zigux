...
- `PHASE4_MAKEFILE_BLOB_SHA=715d2d4ee588c8c0a6ed24e68e8c824b9a706941`
- `PHASE4_WORKFLOW_BLOB_SHA=52c177d488288f72cf9cd4e7ee8e5d46a9f6be49`
...
- `PHASE4_DOC_README_BLOB_SHA=5af78d558666941d167680e317b60b306668230a`
- `PHASE4_SCRIPT_README_BLOB_SHA=ee1bcd7b6713c8ec20305144994540defcbc7bfc`
- `PHASE4_TESTS_README_BLOB_SHA=5fb5515a3b8839b70881d0b247d5e1ef85e98717`
...
- `Documentation/zigux/phase4-validation-matrix.md` still names the current rollback owners, threshold posture, workflow step names, local replay commands, and reversible-delivery evidence for the two shipped rollback gates plus the two manifest-backed survey gates, and it now also records that the exact single-run-line counts for `make -C zigux phase4-validate` and `make -C zigux phase4-test` still live in this note until the shared validator hardens that workflow boundary directly.
