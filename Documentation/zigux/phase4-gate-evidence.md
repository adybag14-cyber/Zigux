...
- `PHASE4_EXACT_READBACK_HEAD=00e0207b1e2dce34c6cb949e0800483f45cf3291`
...
- the last recorded inspected head for this note is now `00e0207b1e2dce34c6cb949e0800483f45cf3291`, which is the artifact-diff evidence-tightening commit that made the Phase 4 gate-evidence checker fail closed on explicit contract-checker status bullets instead of leaving those published results implicit in prose alone; the shared survey provenance still carried by `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `zigux/tests/phase4_kprobe_example_survey.zig`, `zigux/tests/phase4_test_fsmount_survey.zig`, and `zigux/tests/phase4_perf_baseline_survey.zig`, and their sibling manifests remains `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`.
...
The shared survey provenance inside the four Phase 4 survey packets still reflects `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`, so this note now distinguishes the artifact-diff evidence-tightening inspected head from the older shared survey snapshot instead of implying they are the same commit.
