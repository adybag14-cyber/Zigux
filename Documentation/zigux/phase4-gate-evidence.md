...
- `PHASE4_VALIDATOR_BLOB_SHA=3e86558f2a54e56c92d49bb466cb19006c41b412`
...
- The shared validator now fails closed if the gate-evidence note, the manifest-backed runtime atomic64 survey packet, or the shared survey build marker disappear from the shipped packet, while the scripts-root and tests-root README summaries still stop short of naming the runtime atomic64 survey gate as a distinct build surface.
