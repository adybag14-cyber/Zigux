...
- `PHASE4_INSPECTED_MASTER_HEAD=954abd13f436c4a1fb6b23a638e0ce692c8cdc46`
- `PHASE4_VALIDATION_MATRIX_BLOB_SHA=ba053c6b14e8672a631975e704b32b3ddaea3425`
- `PHASE4_VALIDATOR_BLOB_SHA=cbd3865ed8cd44081c46cbcf172eabb61cac52ce`
...
- `PHASE4_REQUIRED_MARKER_COUNT=238`
...
- the inspected branch tip for this pass was `954abd13f436c4a1fb6b23a638e0ce692c8cdc46`, and the exact blob pins above match the live gate-definition files read from that `master` head.
...
- direct validator replay on that same source snapshot returned `PHASE4_VALIDATOR_SELF_TEST=pass`, `PHASE4_VALIDATION=pass`, `PHASE4_REQUIRED_FILE_COUNT=22`, and `PHASE4_REQUIRED_MARKER_COUNT=238`.
...
The current Phase 4 rollback-ownership survey packet is internally aligned at the inspected `master` head `954abd13f436c4a1fb6b23a638e0ce692c8cdc46`, and the direct validator replay on that same snapshot passed both the self-test and the live gate-definition check.
...
- benchmark commands and acceptable limits for the shipped `atomic64_diff.zig` and `bitmap_diff.zig` gates are still intentionally unapproved
