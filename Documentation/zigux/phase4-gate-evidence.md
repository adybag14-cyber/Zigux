...
- `PHASE4_MAKEFILE_BLOB_SHA=13b69951c7569be901afbe8d978bb8d9174d53bb`
- `PHASE4_WORKFLOW_BLOB_SHA=d62051cdab8252c19f25f474fa773ed4cac30cc8`
- `PHASE4_DOC_README_BLOB_SHA=4a07e5e97705f8b36dd14a89ed44a7977367ce1c`
- `PHASE4_SCRIPT_README_BLOB_SHA=7f2ad90ce5ad5da352bf326d6ae3f90057a9ffcd`
- `PHASE4_TESTS_README_BLOB_SHA=b1a4a25079091c4e4d220737e2565474fffbdcac`
- `PHASE4_ATOMIC64_DIFF_BLOB_SHA=afefd6f4106387ce0c209179365773e2d95e1012`
...
- `PHASE4_RUNTIME_ATOMIC64_MANIFEST_BLOB_SHA=746146bc5c40164aa8be7974e6ea1ecce8f6e06f`
- `PHASE4_RUNTIME_ATOMIC64_SURVEY_BLOB_SHA=b3e9197f058a48781decea32f7a3cdd0be9c1b39`
...
- `Documentation/zigux/review-checklist.md` still stays inside the broader shared `validate-phase4.py` packet, but this dedicated exact-readback note does not blob-pin that checklist yet, so the current target set remains intentionally narrower than the full reviewer-facing Phase 4 surface.
