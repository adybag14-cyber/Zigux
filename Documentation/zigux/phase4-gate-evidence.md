...
- `PHASE4_MAKEFILE_BLOB_SHA=1ee259f884a6c27a7424a71cfea95e9132304e92`
- `PHASE4_WORKFLOW_BLOB_SHA=eb8b18a815f415cf1e08ee65322a0871587559ca`
- `PHASE4_DOC_README_BLOB_SHA=1670e6aa976fa263e7249c63d0b16270d0c4ba57`
- `PHASE4_SCRIPT_README_BLOB_SHA=c19f8c487177248f40db93fb0475b8b637cc51ee`
- `PHASE4_TESTS_README_BLOB_SHA=7c529e6c62991e1316e827691cf7e232d84dba03`
...
- `PHASE4_RUNTIME_ATOMIC64_REVIEW_CHECKLIST_BLOB_SHA=0c4fd46e47573d1313fa674269405e31e58ab1ee`
...
- `scripts/zigux/check-phase4-workflow-route-counts.py` also remains the dedicated route-count guard for the shared workflow, `zigux/Makefile`, and `zigux/tests/phase4_build.zig` replay surface, so validator-first routing drift fails closed before the Zig rollback gates run.
...
- The current exact-readback note now matches the live validator, workflow, Makefile, dedicated `Documentation/zigux/artifact-diff.md` note, the dedicated `scripts/zigux/check-phase4-workflow-route-counts.py` routing guard, docs-root reminder, tests-root reminder, and adjacent runtime atomic64 manifest-backed survey pair on `master`, so the broader checker-backed packet is aligned again on current `master`.
