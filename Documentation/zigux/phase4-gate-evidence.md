...
- `PHASE4_MAKEFILE_BLOB_SHA=6be3158e44bc82f077eb6966572771cbccf7b538`
- `PHASE4_WORKFLOW_BLOB_SHA=a00338909fbfc1e13f646830b118a85a7daadf08`
- `PHASE4_DOC_README_BLOB_SHA=595d2cc5bd1fc6fd1c1cc3b2055e9bf6ae2e05da`
- `PHASE4_SCRIPT_README_BLOB_SHA=5bab2177b6394f32f640f567fa84bd918bc20274`
- `PHASE4_TESTS_README_BLOB_SHA=a8d73b7139d19815b3c816094b371b2bd351220d`
...
- `PHASE4_BITMAP_DIFF_BLOB_SHA=fa9f1dc5eb667a49080bde62183f446c7371ba98`
- `PHASE4_BITMAP_LIVE_HELPER_REPLAY_BLOB_SHA=24418ad890696a59b95276fe8dec7eaeecf25172`
- `PHASE4_RUNTIME_ATOMIC64_MANIFEST_BLOB_SHA=76d56c542ea0bfc5512199cd7979521de4cdcccf`
- `PHASE4_RUNTIME_ATOMIC64_SURVEY_BLOB_SHA=a99c69704efb1cb2a50670a7486cd625f4714574`
- `PHASE4_RUNTIME_ATOMIC64_REVIEW_CHECKLIST_BLOB_SHA=b9297064f411b9289b5cb26a18f5fcf36a9fcd30`
...
- The current exact-readback set is current again for the shared rollback-ownership and lab-matrix packet, and the manifest-backed runtime atomic64 survey pair keeps its embedded gate-evidence and review-checklist blob pins aligned with the current shared packet instead of lagging behind it.
...
- The current exact-readback note is aligned again to the live validator, workflow, Makefile, the dedicated `Documentation/zigux/artifact-diff.md` note, and the scripts-root Phase 4 packet on `master`; `zigux/tests/README.md` now explicitly carries the shipped local-only perf-baseline pair `zigux/tests/phase4_perf_baseline_manifest.json` plus `zigux/tests/phase4_perf_baseline_survey.zig`, the adjacent parked kprobe gap survey, and the parked `test_fsmount` gap packet, while the broader docs-root and tests-root summaries should keep the dedicated artifact-diff determinism checker wording explicit when those same-lane notes move again.
