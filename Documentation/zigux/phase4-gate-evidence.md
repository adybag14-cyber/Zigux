...
- `PHASE4_EXACT_READBACK_HEAD=6dc0c7f95aa4cf9e28ededfb40ae07de19dabf8b`
...
- `PHASE4_VALIDATOR_BLOB_SHA=a64cefca12465c3e5a7484318b788beb92087f24`
- `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=76cb202ffc6523da5fb71603f3235abba87c1efb`
...
- `PHASE4_DOC_README_BLOB_SHA=7b04023fb0c1b0b614ef0334969022c7716ad8e5`
- `PHASE4_SCRIPT_README_BLOB_SHA=400fdc6f8831ca9fe6b65213077b4527376d5710`
- `PHASE4_TESTS_README_BLOB_SHA=c33e3da96e52df5fce296a3f76ecf581991d8834`
- `PHASE4_VALIDATOR_SELF_TEST=pass`
- `PHASE4_VALIDATION=pass`
- `PHASE4_REQUIRED_FILE_COUNT=27`
- `PHASE4_REQUIRED_MARKER_COUNT=59`
...
- the last recorded inspected head for this note remains `6dc0c7f95aa4cf9e28ededfb40ae07de19dabf8b`, while the shared survey provenance still carried by `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `zigux/tests/phase4_kprobe_example_survey.zig`, `zigux/tests/phase4_test_fsmount_survey.zig`, and `zigux/tests/phase4_perf_baseline_survey.zig`, and their sibling manifests remains `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`; this bounded maintenance refresh re-pins the live validator, workflow-route checker, Makefile, docs-root, and scripts-root blobs from current connector readback while leaving the last recorded inspected head explicit until a later Phase 4 pass records a fresh branch-tip snapshot end to end.
...
- the current published validator contract for this packet now records `PHASE4_VALIDATOR_SELF_TEST=pass`, `PHASE4_VALIDATION=pass`, `PHASE4_REQUIRED_FILE_COUNT=27`, and `PHASE4_REQUIRED_MARKER_COUNT=59`, the dedicated gate-evidence checker records `PHASE4_GATE_EVIDENCE_SELF_TEST=pass`, `PHASE4_GATE_EVIDENCE_CHECK=pass`, and `PHASE4_GATE_EVIDENCE_TARGET_COUNT=17`, and the dedicated workflow-route checker records `PHASE4_WORKFLOW_ROUTE_COUNTS_SELF_TEST=pass`, `PHASE4_WORKFLOW_ROUTE_COUNTS=pass`, `PHASE4_WORKFLOW_ROUTE_COUNTS_REQUIRED_FILE_COUNT=5`, and `PHASE4_WORKFLOW_ROUTE_COUNTS_REQUIRED_CHECK_COUNT=34` for this exact blob-ledger packet. The shared validator now also fails closed if the exact-readback note drops the dedicated `PHASE4_VALIDATION_MATRIX_BLOB_SHA`, `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA`, `PHASE4_TEST_FSMOUNT_MANIFEST_BLOB_SHA`, `PHASE4_PERF_BASELINE_MANIFEST_BLOB_SHA`, or `PHASE4_RUNTIME_ATOMIC64_MANIFEST_BLOB_SHA` markers, while the separately recorded `PHASE4_WORKFLOW_ROUTE_CHECKER_BLOB_SHA` above remains exact-readback-only evidence for the dedicated workflow-route checker file itself rather than one of the 17 gate-evidence-checker-enforced blob targets.
