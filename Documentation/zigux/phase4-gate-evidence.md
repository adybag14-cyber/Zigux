...
- `PHASE4_EXACT_READBACK_HEAD=2774600467a4570d3f3f886c76f6cdb902becdec`
...
- the last recorded inspected head for this note is now `2774600467a4570d3f3f886c76f6cdb902becdec`, which is the latest visible `master` commit immediately after the runtime atomic64 survey hardening landed. The rerun refreshed the live `zigux/tests/phase4_runtime_atomic64_diff_survey.zig` blob pin to `PHASE4_RUNTIME_ATOMIC64_SURVEY_BLOB_SHA=477dd7f2811a56181c774250ae56bee5edf7ea4f` after the latest Phase 4 runtime atomic64 survey workflow-route-checker pin sync while confirming that the shared Phase 4 validator still lives at `PHASE4_VALIDATOR_BLOB_SHA=00f9d3b13c4e92ffda62acf281bae39bb937f81e`, the dedicated gate-evidence checker still lives at `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=0c81409ef0f55d61cf0fac997ce06ad2a8708b84`, the dedicated workflow-route checker still lives at `PHASE4_WORKFLOW_ROUTE_CHECKER_BLOB_SHA=60d250d7de47f92fc795c8905d182bbeb9c357fa`, and the docs-root, scripts-root, tests-root, perf-baseline-manifest, perf-baseline-survey, and runtime-atomic64-manifest blob pins remained aligned; the shared survey provenance still carried by `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `zigux/tests/phase4_kprobe_example_survey.zig`, `zigux/tests/phase4_test_fsmount_survey.zig`, and `zigux/tests/phase4_perf_baseline_survey.zig`, and their sibling manifests remains `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`.
