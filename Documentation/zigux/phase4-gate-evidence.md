...
- `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=bdd8ea01f3a303f5837a3ef53d5885d236114da1`
- `PHASE4_BUILD_BLOB_SHA=57f4c3809387cac39e3153b9bbad17ca92ce3684`
- `PHASE4_MAKEFILE_BLOB_SHA=59f1be5e55212b6b908477406f6a3eaa8131aa45`
...
- `PHASE4_DOC_README_BLOB_SHA=3910ec4eeffe47b12ba158dd8ca813ee90523cb4`
- `PHASE4_SCRIPT_README_BLOB_SHA=6572a0ff8056ef6bd3b309fa294dd93d83ebb9e0`
...
- the dedicated `scripts/zigux/check-phase4-gate-evidence.py` self-test now also mutates its own blob pin plus the shared `zigux/tests/phase4_build.zig`, `zigux/Makefile`, `scripts/zigux/README.md`, `zigux/tests/phase4_perf_baseline_manifest.json`, and `zigux/tests/phase4_runtime_atomic64_diff_survey.zig` blob pins, so implementation, index-surface, manifest, and survey ledger targets all fail closed in the same synthetic replay instead of relying only on live-note inspection.
