...
- `PHASE4_EXACT_READBACK_HEAD=f970401f12f48e4d93d0ac7427c318130f92bdb5`
...
- `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=7c1f7b99f1d24583268d3d096345517ed5cb0af6`
...
- the last recorded inspected head for this note is now `f970401f12f48e4d93d0ac7427c318130f92bdb5`, which landed the dedicated gate-evidence checker tightening for the scripts-root bitmap replay sentence while keeping the broader shared Phase 4 packet unchanged; the current connector rerun refreshed the checker pin above, confirmed that the shared Phase 4 validator still sits at `PHASE4_VALIDATOR_BLOB_SHA=3d9d1bd148c457c01ad2ec5d5db6c32e70e9e7d8`, confirmed that the dedicated gate-evidence checker now lives at `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=7c1f7b99f1d24583268d3d096345517ed5cb0af6`, and confirmed that the checker still fails closed on explicit contract-checker status bullets while now also exact-counting the dedicated scripts-root bitmap replay sentence inside this evidence note; the shared survey provenance still carried by `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `zigux/tests/phase4_kprobe_example_survey.zig`, `zigux/tests/phase4_test_fsmount_survey.zig`, and `zigux/tests/phase4_perf_baseline_survey.zig`, and their sibling manifests remains `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`.
