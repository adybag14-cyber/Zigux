...
- `PHASE4_DOC_README_BLOB_SHA=87fa3a79c9ae570102c5db5ac8b401b93f5835a4`
- `PHASE4_SCRIPT_README_BLOB_SHA=afeebac234d61e00b65fac74273207248d52e13c`
- `PHASE4_TESTS_README_BLOB_SHA=1f35899662ac2ad4113a154bf6887c1db7e0a32e`
...
- `PHASE4_RUNTIME_ATOMIC64_MANIFEST_BLOB_SHA=5f8fb3be446b64812dfa273647255d3fa745a7af`
- `PHASE4_RUNTIME_ATOMIC64_SURVEY_BLOB_SHA=9a7a36a29b978509e7c8b37b686d64164d60dff0`
...
- `scripts/zigux/check-phase4-gate-evidence.py --self-test` still publishes a fourteen-entry case catalog, and the shared `scripts/zigux/validate-phase4.py` route still expects that same printed catalog before the Phase 4 Zig replays continue. The live self-test body also directly mutates the helper-backed bitmap replay command, the dedicated helper-backed ownership line, and the helper-backed threshold-posture wording, so those three note anchors already fail closed even though they are not yet named separately in the printed catalog.
