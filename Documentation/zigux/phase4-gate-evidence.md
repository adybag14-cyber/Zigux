...
- `PHASE4_VALIDATION_MATRIX_BLOB_SHA=62e92e1dc2d2647ca7174b13f935f21be216d163`
...
- `PHASE4_ARTIFACT_DIFF_CONTRACT_CHECKER_BLOB_SHA=2caa42e9b7260f8c3777a1d671f77c948dab8d40`
...
- `Documentation/zigux/phase4-validation-matrix.md` now keeps the still-missing `samples/zigux/kprobe_example.zig`, `samples/zigux/test_fsmount.zig`, and perf-threshold follow-up rows explicit with their current C anchors, current replay commands, survey owners, rollback owners, and next bounded evidence steps instead of collapsing those roadmap gaps into three loose bullets.
