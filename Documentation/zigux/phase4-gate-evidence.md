...
- `PHASE4_VALIDATION_MATRIX_BLOB_SHA=1dfc5cacdc9418b791a7b186ac753c73dcba999d`
...
- `PHASE4_MAKEFILE_BLOB_SHA=2b601947651444a1d4425bf2cd11b9804949f8ca`
- `PHASE4_WORKFLOW_BLOB_SHA=bd05101e021c29497d2a4d0770acd4d1ba55bdb9`
- `PHASE4_DOC_README_BLOB_SHA=c70ed59dc8061e29282ca255d8902eb49e4f4130`
- `PHASE4_SCRIPT_README_BLOB_SHA=e92c841088ba54b017dbb7251a94d5a974d51dd6`
- `PHASE4_TESTS_README_BLOB_SHA=0753a6777cec92fa5985263a7f64f93820694575`
...
- `PHASE4_RUNTIME_ATOMIC64_REVIEW_CHECKLIST_BLOB_SHA=8af4a5a1a5c3051d1c65a5a5c9a6e417c065837e`
...
- the shared Phase 4 reminder surfaces now keep that split explicit too, so the next same-lane follow-through is the policy decision recorded in `Documentation/zigux/phase4-validation-matrix.md` and `Documentation/zigux/review-checklist.md`: the `Validation and Perf Team` should decide, in coordination with the `ABI and Runtime Team` and `Shared Subsystems Pod`, whether those approved limits stay local-only or intentionally promote a broader shared-CI perf-coverage claim.
