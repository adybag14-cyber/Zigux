...
- The shared build packet on current `master` now wires four replay surfaces, not three: `phase4-runtime-atomic64-diff-tests`, `phase4-runtime-atomic64-diff-survey-tests`, `phase4-bitmap-diff-tests`, and `phase4-bitmap-live-helper-replay-tests`.
...
- The runtime atomic64 handoff remains explicit in the live Phase 4 packet through `zigux/tests/atomic64_diff.zig`, `zigux/tests/phase4_runtime_atomic64_diff_manifest.json`, `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `Documentation/zigux/phase4-validation-matrix.md`, and the three root README surfaces.
