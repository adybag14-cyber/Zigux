...
- `PHASE4_EXACT_READBACK_HEAD=ed3394a63a83b4de0b540d7e54030c265a8cc1f9`
...
- the last recorded inspected head for this note is now `ed3394a63a83b4de0b540d7e54030c265a8cc1f9`, which landed the shared validator tightening for the scripts-root bitmap replay route and shared-build marker exact-count contract while keeping the rest of the shared Phase 4 packet unchanged; the current connector rerun refreshed the docs-root, scripts-root, tests-root, and perf-baseline survey blob pins above, confirmed that the shared Phase 4 validator now sits at `PHASE4_VALIDATOR_BLOB_SHA=3d9d1bd148c457c01ad2ec5d5db6c32e70e9e7d8`, confirmed that the dedicated gate-evidence checker still lives at `PHASE4_GATE_EVIDENCE_CHECKER_BLOB_SHA=49a8d5a4041f06775ab3901cbd2909f5a6dead8d`, and confirmed that the checker still fails closed on explicit contract-checker status bullets while also proving validator-blob drift inside its own synthetic coverage path; the shared survey provenance still carried by `zigux/tests/phase4_runtime_atomic64_diff_survey.zig`, `zigux/tests/phase4_kprobe_example_survey.zig`, `zigux/tests/phase4_test_fsmount_survey.zig`, and `zigux/tests/phase4_perf_baseline_survey.zig`, and their sibling manifests remains `3ba64cd4e41a4de1c8fd8dbaecb23702ad9701a3`.
