...
4. The public fallback split stays explicit.
   ...
   - The sequencing note, this checklist, and the shared checker should continue to describe the smoke-first reminder consistently across the shared fallback overview note, the shared libbpf anti-overlap companion, and the two commit-pinned fallback notes.
