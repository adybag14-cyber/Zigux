...
1. Shared release surfaces still agree.
   - `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase12-release-sequencing.md`, `Documentation/zigux/phase12-release-closure-checklist.md`, `Documentation/zigux/phase12-nvme-pci-slice.md`, `Documentation/zigux/phase12-nvme-pci-survey.md`, `Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md`, `Documentation/zigux/phase12-virtio-net-survey.md`, `Documentation/zigux/phase12-virtio-scsi-slice.md`, `Documentation/zigux/phase12-virtio-scsi-survey.md`, `Documentation/zigux/phase12-virtio-scsi-raw-github-fallback-catalog.md`, `Documentation/zigux/phase12-libbpf-segment-survey.md`, `scripts/zigux/README.md`, `scripts/zigux/check-build-only-phase12-surface.py`, `.github/workflows/zigux-bootstrap.yml`, `zigux/tests/README.md`, `zigux/tests/phase12_build.zig`, and `zigux/Makefile` must still describe the same shipped Phase 12 replay packet.
...
- the smallest same-lane follow-through is now a separate tests-root closure-companion reminder in `zigux/tests/README.md` so the PMO companion becomes visible from the tests-root packet without disturbing the already checker-counted shared Phase 12 summary line.
- after that separate tests-root reminder lands, extend `scripts/zigux/check-build-only-phase12-surface.py` so the closure companion is fail-closed against scripts-root drift too.
...
- Any future PMO follow-through should therefore start with that separate tests-root closure-companion reminder, then rerun `scripts/zigux/check-build-only-phase12-surface.py` and reread `zigux/tests/README.md` before widening into checker work, new wording, or closure claims.
