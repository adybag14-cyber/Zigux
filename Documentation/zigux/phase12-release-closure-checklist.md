...
## Closure checklist
  1. Shared release surfaces still agree.
     * `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase12-release-sequencing.md`, `Documentation/zigux/phase12-release-closure-checklist.md`, `Documentation/zigux/phase12-release-readiness-survey.md`, `Documentation/zigux/freeze-map.md`, `Documentation/zigux/phase12-complex-driver-lane-sequencing.md`, `Documentation/zigux/phase12-libbpf-heavy-consumer-lane-sequencing.md`, `Documentation/zigux/phase12-raw-github-coverage-survey.md`, `Documentation/zigux/phase12-release-coordination-matrix.md`, `Documentation/zigux/phase12-nvme-pci-slice.md`, `Documentation/zigux/phase12-nvme-pci-survey.md`, `Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md`, `Documentation/zigux/phase12-virtio-net-survey.md`, `Documentation/zigux/phase12-virtio-scsi-slice.md`, `Documentation/zigux/phase12-virtio-scsi-survey.md`, `Documentation/zigux/phase12-libbpf-segment-survey.md`, `Documentation/zigux/phase12-libbpf-verify-shard-note.md`, `scripts/zigux/README.md`, `scripts/zigux/check-build-only-phase12-surface.py`, `.github/workflows/zigux-bootstrap.yml`, `zigux/tests/README.md`, `zigux/tests/phase12_build.zig`, and `zigux/Makefile` must still describe the same shipped Phase 12 replay packet.
...
## Active release blocker
  ...
  * The live PMO job is now narrowed to a more exact scripts-root truthfulness sync: current `master` still returns 404s for `zigux/tests/phase12_nvme_pci.zig`, `zigux/tests/phase12_virtio_net.zig`, `zigux/tests/phase12_libbpf_segments.zig`, and `tools/lib/bpf/zigux_segments/verify.zig`, while the surviving survey-only `virtio_net` packet still reads back through `Documentation/zigux/phase12-virtio-net-survey.md`, `zigux/tests/phase12_virtio_net_manifest.json`, and `zigux/tests/phase12_virtio_net_survey.zig`, and the shared libbpf survey still retains `Documentation/zigux/phase12-libbpf-segment-survey.md` plus `zigux/tests/fixtures/phase12_libbpf_snapshot.json` as the surviving snapshot-backed anchor even while the direct `phase12_libbpf_*` replay files remain absent. Same-lane PMO follow-through should therefore repair `scripts/zigux/README.md` so it keeps those surviving survey-only and snapshot-backed boundaries explicit without presenting the absent direct replay files as shipped release-packet surfaces before reopening broader docs-root, fallback, or driver-local wording.
  * Live GitHub contents readback on 2026-05-12 confirms that scripts-root blocker is still open: current `master` still returns 404s for `zigux/tests/phase12_nvme_pci.zig`, `zigux/tests/phase12_virtio_net.zig`, `zigux/tests/phase12_libbpf_segments.zig`, and `tools/lib/bpf/zigux_segments/verify.zig`, while `Documentation/zigux/phase12-virtio-net-survey.md`, `zigux/tests/phase12_virtio_net_manifest.json`, `zigux/tests/phase12_virtio_net_survey.zig`, `Documentation/zigux/phase12-libbpf-segment-survey.md`, and `zigux/tests/fixtures/phase12_libbpf_snapshot.json` still read back successfully. `scripts/zigux/README.md` still needs to distinguish those surviving survey-only and snapshot-backed anchors from the absent direct replay files instead of presenting the whole family as shipped current-`master` release evidence.
