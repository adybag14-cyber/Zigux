...
- `PHASE9_SURVEYED_COMMIT=b76c26b5f2a2681ba7653459da4a074a19dca906`
...
- the current survey packet is pinned to `master` commit `b76c26b5f2a2681ba7653459da4a074a19dca906`.
...
- `initFromBitList()` rejects trailing or doubled separators, rejects out-of-bounds bit lists, and blocks repeat parse initialization with `InvalidLifecycleTransition` once the first parse succeeds
