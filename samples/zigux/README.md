...
- keep the landed replay contract explicit: exact queue-order replay, transfer counts, wrapped replay-preview prefix, helper-side preview truncation, non-destructive snapshot, and fixed embedded 32-byte ring-buffer backing
