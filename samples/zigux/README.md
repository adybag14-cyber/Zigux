...
Keep `samples/zigux/runtime_trace_events_exit_rollback_guard.zig` explicit as the failed-exit rollback companion for both the selftest-ready and initialized direct-activity lifecycle proofs in the same packet.
