...
pub const ModuleDescriptor = struct {
    ...
    provides_io_queue_map_summary: bool,
    provides_recovery_restore_planner: bool,
...
pub const RecoverySummary = struct {
    ...
    requires_queue_layout_replan: bool,
    cleared_probe_snapshot: bool,
    cleared_host_limit_summary: bool,
    cleared_queue_depth_summary: bool,
    cleared_io_queue_map_summary: bool,
...
pub const VirtioScsiQueueLab = struct {
    ...
    pub fn descriptor() ModuleDescriptor {
        return .{
            ...
            .provides_io_queue_map_summary = true,
            .provides_recovery_restore_planner = true,
    ...
    pub fn freezeForTransportReset(self: *Self) !RecoverySummary {
        ...
        return .{
            ...
            .requires_queue_layout_replan = false,
            .cleared_probe_snapshot = false,
            .cleared_host_limit_summary = false,
            .cleared_queue_depth_summary = false,
            .cleared_io_queue_map_summary = false,
    ...
    pub fn restoreAfterTransportReset(self: *Self) !RecoverySummary {
        ...
        return .{
            ...
            .requires_queue_layout_replan = true,
            .cleared_probe_snapshot = true,
            .cleared_host_limit_summary = true,
            .cleared_queue_depth_summary = true,
            .cleared_io_queue_map_summary = true,
            .remembered_request_queues = layout.request_queues,
            .remembered_poll_queues = layout.poll_queues,
            .remembered_event_buffer_count = layout.event_buffer_count,
            .recovery_generation = self.recovery_generation,
