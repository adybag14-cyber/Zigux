...
pub fn summarizeTransmitRecycle(request: TransmitRecycleRequest) !TransmitRecycleSummary {
    ...
    const remaining_in_flight_descriptors = request.in_flight_descriptors - request.completed_descriptors;
    ...
    const wakes_transmit_queue = request.queue_stopped and frees_completed_buffers and reaches_wake_threshold;
