...
pub fn build(b: *std.Build) void {
    ...
    const module = b.createModule(.{
        .root_source_file = b.path("lane01_phase10_virtio_lab_drivers_contract.zig"),
        .target = target,
        .optimize = optimize,
    });

    const unit_tests = b.addTest(.{
        .name = "lane01-phase10-virtio-lab-drivers-contract",
        .root_module = module,
    });
    ...
    const contract_step = b.step(
        "lane01-phase10-virtio-lab-drivers-contract",
