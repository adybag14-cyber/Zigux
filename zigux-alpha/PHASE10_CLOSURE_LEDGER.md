...
- `PHASE10_LEDGER_EXACT_CHECK_1=zig run check_phase10_bootstrap_route.zig`
- `PHASE10_LEDGER_EXACT_CHECK_2=zig run check_phase10_core_packet.zig`
- `PHASE10_LEDGER_EXACT_CHECK_3=zig run check_phase10_shared_freeze_boundary.zig`
- `PHASE10_LEDGER_EXACT_CHECK_4=zig run check_phase10_ring_packet.zig`
- `PHASE10_LEDGER_EXACT_CHECK_5=zig run check_phase10_input_packet.zig`
- `PHASE10_LEDGER_EXACT_CHECK_6=zig run check_phase10_mmio_packet.zig`
- `PHASE10_LEDGER_EXACT_CHECK_7=zig run check_phase10_harness_coverage.zig`
- `PHASE10_LEDGER_EXACT_CHECK_8=zig run check_phase10_tests_readme_core_surfaces.zig`
- `PHASE10_LEDGER_EXACT_CHECK_9=zig run check_phase10_closure_manifest_counts.zig`
- `PHASE10_LEDGER_EXACT_CHECK_10=zig run validate_phase10.zig`
- `PHASE10_LEDGER_EXACT_CHECK_11=zig run validate_phase10_closure.zig`
