...
fn emptyDeliveryWindowView() abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView, .{});
}

fn emptySummary() abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetSummary {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetSummary, .{
...
pub fn asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetView) abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView {
...
pub fn isValid(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetView) bool {
    if (view.window_policy_budget_window_delivery_window_budget_reserved != 0) return false;
    return chrdev_notify_ack_window_policy_budget_window_delivery_window_plan.isValid(asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView(view));
}

pub fn summarize(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetView) abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetSummary {
    if (!isValid(view)) return emptySummary();

    const delivery_window_summary = chrdev_notify_ack_window_policy_budget_window_delivery_window_plan.summarize(asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowView(view));
    var summary = emptySummary();
    @memcpy(
        std.mem.asBytes(&summary)[0..@sizeOf(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowSummary)],
        std.mem.asBytes(&delivery_window_summary),
    );

    summary.window_policy_budget_window_delivery_window_budget_flags = 0;
    summary.window_policy_budget_window_delivery_window_budget_before = view.window_policy_budget_window_delivery_window_budget;
    summary.window_policy_budget_window_delivery_window_budget_after = view.window_policy_budget_window_delivery_window_budget;
    summary.deferred_window_policy_budget_window_delivery_window_budget_before = view.deferred_window_policy_budget_window_delivery_window_budget;
    summary.deferred_window_policy_budget_window_delivery_window_budget_after = view.deferred_window_policy_budget_window_delivery_window_budget;
    summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_NONE;
    summary.window_policy_budget_window_delivery_window_budget_acked_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_deferred_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_suppressed_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_coalesced_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_dropped_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_skipped_count = 0;

    switch (delivery_window_summary.window_policy_budget_window_delivery_window_status) {
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_NONE => {},
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_SUPPRESSED => {
            summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_SUPPRESSED;
            summary.window_policy_budget_window_delivery_window_budget_suppressed_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_SKIPPED => {
            summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_SKIPPED;
            summary.window_policy_budget_window_delivery_window_budget_skipped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_DROPPED => {
            summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_DROPPED;
            summary.window_policy_budget_window_delivery_window_budget_dropped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_DEFERRED => {
            summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_BUDGET_APPLIED;
            if (summary.deferred_window_policy_budget_window_delivery_window_budget_after > 0) {
                summary.deferred_window_policy_budget_window_delivery_window_budget_after -= 1;
                summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_DEFERRED_WINDOW_DELIVERY_WINDOW_BUDGET_USED;
                summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_DEFERRED;
                summary.window_policy_budget_window_delivery_window_budget_deferred_count = 1;
            } else {
                summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_DEFERRED_WINDOW_DELIVERY_WINDOW_BUDGET_EXHAUSTED;
                summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_DROPPED;
                summary.window_policy_budget_window_delivery_window_budget_dropped_count = 1;
            }
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_ACKED,
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_COALESCED,
        => {
            summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_BUDGET_APPLIED;
            if (summary.window_policy_budget_window_delivery_window_budget_after > 0) {
                summary.window_policy_budget_window_delivery_window_budget_after -= 1;
                summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_WINDOW_DELIVERY_WINDOW_BUDGET_USED;
                if (delivery_window_summary.window_policy_budget_window_delivery_window_status == abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_STATUS_ACKED) {
                    summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_ACKED;
                    summary.window_policy_budget_window_delivery_window_budget_acked_count = 1;
                } else {
                    summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_COALESCED;
                    summary.window_policy_budget_window_delivery_window_budget_coalesced_count = 1;
                }
            } else {
                summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_WINDOW_DELIVERY_WINDOW_BUDGET_EXHAUSTED;
                if (summary.deferred_window_policy_budget_window_delivery_window_budget_after > 0) {
                    summary.deferred_window_policy_budget_window_delivery_window_budget_after -= 1;
                    summary.window_policy_budget_window_delivery_window_budget_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_FLAG_DEFERRED_WINDOW_DELIVERY_WINDOW_BUDGET_USED;
                    summary.window_policy_budget_window_delivery_window_budget_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_STATUS_DEFERRED;
