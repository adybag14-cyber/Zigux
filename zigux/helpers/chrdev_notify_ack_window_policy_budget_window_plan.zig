...
fn emptyBudgetView() abi.ChrdevNotifyAckWindowPolicyBudgetView {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetView, .{});
}

fn emptySummary() abi.ChrdevNotifyAckWindowPolicyBudgetWindowSummary {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetWindowSummary, .{
...
) abi.ChrdevNotifyAckWindowPolicyBudgetWindowView {
    return .{
...
pub fn asChrdevNotifyAckWindowPolicyBudgetView(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowView) abi.ChrdevNotifyAckWindowPolicyBudgetView {
...
pub fn isValid(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowView) bool {
    if (view.window_policy_budget_window_reserved != 0) return false;
    return chrdev_notify_ack_window_policy_budget_plan.isValid(asChrdevNotifyAckWindowPolicyBudgetView(view));
}

pub fn summarize(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowView) abi.ChrdevNotifyAckWindowPolicyBudgetWindowSummary {
    if (!isValid(view)) return emptySummary();

    const budget_summary = chrdev_notify_ack_window_policy_budget_plan.summarize(asChrdevNotifyAckWindowPolicyBudgetView(view));
    var summary = emptySummary();
    @memcpy(
        std.mem.asBytes(&summary)[0..@sizeOf(abi.ChrdevNotifyAckWindowPolicyBudgetSummary)],
        std.mem.asBytes(&budget_summary),
    );

    summary.window_policy_budget_window_flags = 0;
    summary.window_policy_budget_window_before = view.window_policy_budget_window;
    summary.window_policy_budget_window_after = view.window_policy_budget_window;
    summary.window_policy_budget_window_floor = view.window_policy_budget_window_floor;
    summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_NONE;
    summary.window_policy_budget_window_acked_count = 0;
    summary.window_policy_budget_window_deferred_count = 0;
    summary.window_policy_budget_window_suppressed_count = 0;
    summary.window_policy_budget_window_coalesced_count = 0;
    summary.window_policy_budget_window_dropped_count = 0;
    summary.window_policy_budget_window_skipped_count = 0;

    switch (budget_summary.window_policy_budget_status) {
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_NONE => {},
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_SUPPRESSED => {
            summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_SUPPRESSED;
            summary.window_policy_budget_window_suppressed_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_SKIPPED => {
            summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_SKIPPED;
            summary.window_policy_budget_window_skipped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_DROPPED => {
            summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_DROPPED;
            summary.window_policy_budget_window_dropped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_ACKED,
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_DEFERRED,
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_COALESCED,
        => {
            summary.window_policy_budget_window_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_FLAG_WINDOW_APPLIED;
            if (summary.window_policy_budget_window_before == 0) {
                summary.window_policy_budget_window_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_FLAG_WINDOW_EXHAUSTED;
                summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_DROPPED;
                summary.window_policy_budget_window_dropped_count = 1;
            } else if (summary.window_policy_budget_window_before <= view.window_policy_budget_window_floor) {
                summary.window_policy_budget_window_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_FLAG_FLOOR_HELD | abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_FLAG_FLOOR_BLOCKED;
                summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_DEFERRED;
                summary.window_policy_budget_window_deferred_count = 1;
            } else {
                summary.window_policy_budget_window_after = summary.window_policy_budget_window_before - 1;
                summary.window_policy_budget_window_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_FLAG_WINDOW_USED;
                switch (budget_summary.window_policy_budget_status) {
                    abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_ACKED => {
                        summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_ACKED;
                        summary.window_policy_budget_window_acked_count = 1;
                    },
                    abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_STATUS_COALESCED => {
                        summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_COALESCED;
                        summary.window_policy_budget_window_coalesced_count = 1;
                    },
                    else => {
                        summary.window_policy_budget_window_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_STATUS_DEFERRED;
                        summary.window_policy_budget_window_deferred_count = 1;
