...
fn emptyWindowView() abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView, .{});
}

fn emptySummary() abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliverySummary {
    return std.mem.zeroInit(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliverySummary, .{
...
) abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliveryView {
    return .{
...
pub fn asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliveryView) abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView {
...
pub fn isValid(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliveryView) bool {
    if (view.window_policy_budget_window_delivery_window_budget_window_delivery_reserved != 0) return false;
    return chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_window_plan.isValid(asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView(view));
}

pub fn summarize(view: abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliveryView) abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowDeliverySummary {
    if (!isValid(view)) return emptySummary();

    const window_summary = chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_window_plan.summarize(asChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowView(view));
    var summary = emptySummary();
    @memcpy(
        std.mem.asBytes(&summary)[0..@sizeOf(abi.ChrdevNotifyAckWindowPolicyBudgetWindowDeliveryWindowBudgetWindowSummary)],
        std.mem.asBytes(&window_summary),
    );

    summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_before = view.window_policy_budget_window_delivery_window_budget_window_delivery_budget;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_after = view.window_policy_budget_window_delivery_window_budget_window_delivery_budget;
    summary.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_before = view.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_budget;
    summary.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_after = view.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_budget;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_NONE;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_acked_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_deferred_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_suppressed_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_coalesced_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_dropped_count = 0;
    summary.window_policy_budget_window_delivery_window_budget_window_delivery_skipped_count = 0;

    switch (window_summary.window_policy_budget_window_delivery_window_budget_window_status) {
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_NONE => {},
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_SUPPRESSED => {
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_SUPPRESSED;
        ...
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_SKIPPED => {
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_SKIPPED;
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_skipped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_DROPPED => {
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_DROPPED;
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_dropped_count = 1;
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_DEFERRED => {
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_BUDGET_APPLIED;
            if (summary.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_after > 0) {
                ...
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_DEFERRED_WINDOW_DELIVERY_BUDGET_USED;
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_DEFERRED;
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_deferred_count = 1;
            } else {
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_DEFERRED_WINDOW_DELIVERY_BUDGET_EXHAUSTED;
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_DROPPED;
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_dropped_count = 1;
            }
        },
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_ACKED,
        abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_COALESCED,
        => {
            summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_BUDGET_APPLIED;
            if (summary.window_policy_budget_window_delivery_window_budget_window_delivery_after > 0) {
                ...
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_WINDOW_DELIVERY_BUDGET_USED;
                if (window_summary.window_policy_budget_window_delivery_window_budget_window_status == abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_STATUS_ACKED) {
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_ACKED;
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_acked_count = 1;
                } else {
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_COALESCED;
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_coalesced_count = 1;
                }
            } else {
                summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_WINDOW_DELIVERY_BUDGET_EXHAUSTED;
                if (summary.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_after > 0) {
                    summary.deferred_window_policy_budget_window_delivery_window_budget_window_delivery_after -= 1;
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_flags |= abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_FLAG_DEFERRED_WINDOW_DELIVERY_BUDGET_USED;
                    summary.window_policy_budget_window_delivery_window_budget_window_delivery_status = abi.CHRDEV_NOTIFY_ACK_WINDOW_POLICY_BUDGET_WINDOW_DELIVERY_WINDOW_BUDGET_WINDOW_DELIVERY_STATUS_DEFERRED;
