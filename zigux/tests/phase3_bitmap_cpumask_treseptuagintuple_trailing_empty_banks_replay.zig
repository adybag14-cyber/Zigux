...
test "lane27 treseptuagintuple replay keeps bitmap discovery stable across 73 empty banks" {
...
test "lane27 treseptuagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 treseptuagintuple replay ignores tail-only noise in subset and overlap checks" {
