...
test "bitmap view crosses duoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across duoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore duoogintuple tail noise in relations" {
