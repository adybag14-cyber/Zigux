...
test "bitmap view crosses centumundecim empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumundecim empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumundecim tail noise in relations" {
