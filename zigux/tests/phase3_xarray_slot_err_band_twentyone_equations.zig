...
test "representative 21-raw err-band windows keep alias-err spacing exact" {
...
test "every interior twentyone window keeps consecutive codes and alternating constructor families" {
...
test "twentyone windows preserve centered equations around the middle err-code slot" {
    var even_residue: usize = 0;
    while (even_residue + (window_len - 1) <= err_band_span) : (even_residue += 2) {
