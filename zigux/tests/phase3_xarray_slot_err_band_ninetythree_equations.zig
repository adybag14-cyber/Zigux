...
test "representative 93-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 3, 955, 1997, 2999, 4001 };
...
test "every interior ninetythree window keeps consecutive codes and alternating constructor families" {
...
test "ninetythree windows preserve centered equations around the middle err-code slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
