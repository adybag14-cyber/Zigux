...
test "lane27 octoquinquagintuple replay keeps bitmap discovery stable across 58 empty banks" {
...
test "lane27 octoquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 octoquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
