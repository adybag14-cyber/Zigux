...
fn nonUnitCmp(_: ?*anyopaque, a: *const list_sort.ListHead, b: *const list_sort.ListHead) i32 {
...
test "phase1 list_sort preserves non-unit order when a later pass ties everything" {
    ...
    list_sort.listSort(null, &head, nonUnitCmp);
