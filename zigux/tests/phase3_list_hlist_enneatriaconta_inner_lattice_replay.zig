...
const route = [_]usize{ 38, 0, 19, 18, 37, 1, 20, 17, 36, 2, 21, 16, 35, 3, 22, 15, 34, 4, 23, 14, 33, 5, 24, 13, 32, 6, 25, 12, 31, 7, 26, 11, 30, 8, 27, 10, 29, 9, 28 };
const detached_index = 39;
...
test "enneatriaconta inner lattice keeps forward list and hlist visibility before repair" {
...
test "enneatriaconta inner lattice staged repair crosses the center hinge" {
    var entries: [entry_count]Entry = undefined;
    resetEntries(&entries);
    poisonDetached(&entries);
