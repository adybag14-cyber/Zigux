...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .name = "phase1-helper-ports-b-numeric-mask-replay-tests",
    ...
    const replay_step = b.step(
        ...
        "Run the Phase 1 helper ports B numeric-mask replay",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the Phase 1 helper ports B numeric-mask replay");
