...
pub fn build(b: *std.Build) void {
    ...
    const lane_step = b.step(
        "phase3-policy-idr-slot-test",
        "Run the Phase 3 policy and IDR-slot starter packets together",
    );
    lane_step.dependOn(&policy_tests.step);
    lane_step.dependOn(&idr_slot_tests.step);

    const test_step = b.step("test", "Run the Phase 3 policy/IDR-slot standalone shard");
