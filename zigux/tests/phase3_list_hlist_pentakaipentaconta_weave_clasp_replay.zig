...
const staged_break_index = 35;
const route = [_]usize{
    54, 0,  29, 28, 53, 1,  30, 27, 52, 2,  31, 26, 51, 3,
    32, 25, 50, 4,  33, 24, 49, 5,  34, 23, 48, 6,  35, 22,
    47, 7,  36, 21, 46, 8,  37, 20, 45, 9,  38, 19, 44, 10,
    39, 18, 43, 11, 40, 17, 42, 12, 41, 16, 13, 15, 14,
};
...
test "pentakaipentaconta weave-clasp list route exposes staged backlink repair" {
...
test "pentakaipentaconta weave-clasp hlist route exposes staged pprev repair" {
