...
pub fn build(b: *std.Build) void {
    ...
    const phase3_xarray_slot_export_test = b.step(
        "phase3-xarray-slot-export-test",
        "Run the Phase 3 xarray-slot starter packet and export/UAPI layout replay together",
    );
    phase3_xarray_slot_export_test.dependOn(&phase3_xarray_slot_starter_packet.step);
    phase3_xarray_slot_export_test.dependOn(&phase3_export_uapi_layout.step);
}
