...
test "bitmap view crosses novemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across novemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore novemoogintuple tail noise in relations" {
