...
test "triple trailing empty banks keep early windows aligned and late banks empty" {
...
test "triple trailing empty banks keep subset and overlap checks bounded under masked late noise" {
    const capacity = (4 * bitmap_view.word_bits) + 11;
