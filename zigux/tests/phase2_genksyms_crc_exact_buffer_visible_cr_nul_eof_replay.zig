...
test "lane19 exact-buffer EOF replay preserves leading carriage returns before an embedded NUL in the continuation" {
    var exact_then_visible_cr_then_nul = try std.ArrayList(u8).initCapacity(std.testing.allocator, c_line_payload_len + 5);
