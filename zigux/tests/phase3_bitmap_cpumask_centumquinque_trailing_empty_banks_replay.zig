...
test "bitmap view crosses centumquinque empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumquinque empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumquinque tail noise in relations" {
