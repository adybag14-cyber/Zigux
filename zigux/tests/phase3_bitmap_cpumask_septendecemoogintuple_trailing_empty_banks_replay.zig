...
test "bitmap view crosses septendecemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across septendecemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore septendecemoogintuple tail noise in relations" {
