...
test "phase14 ring-buffer attached toolchain guidance stays packet-local and environment-only without a checkout tree" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, note, "`agent_files/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc (1).tar.xz`") != null);
    try std.testing.expect(std.mem.indexOf(u8, note, "mkdir -p /workspace/.toolchains/p14-l08 && tar -xf \"/workspace/agent_files/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc (1).tar.xz\" -C /workspace/.toolchains/p14-l08") != null);
    try std.testing.expect(std.mem.indexOf(u8, note, "`/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc`") != null);
    try std.testing.expect(std.mem.indexOf(u8, note, "`0.17.0-dev.877+a3ae499dc`") != null);
    try std.testing.expect(std.mem.indexOf(u8, note, "`/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig version`") != null);
    try std.testing.expect(std.mem.indexOf(u8, note, "`/workspace/.toolchains/p14-l08/zig-x86_64-linux-0.17.0-dev.877+a3ae499dc/zig env`") != null);
