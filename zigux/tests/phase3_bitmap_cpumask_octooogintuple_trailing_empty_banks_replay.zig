...
test "bitmap view crosses octooogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across octooogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore octooogintuple tail noise in relations" {
