...
test "lane27 septuagintuple replay keeps bitmap discovery stable across 70 empty banks" {
...
test "lane27 septuagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 septuagintuple replay ignores tail-only noise in subset and overlap checks" {
