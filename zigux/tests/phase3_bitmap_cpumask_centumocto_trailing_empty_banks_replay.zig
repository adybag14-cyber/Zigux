...
test "bitmap view crosses centumocto empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumocto empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumocto tail noise in relations" {
