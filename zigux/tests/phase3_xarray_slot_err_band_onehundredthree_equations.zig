...
test "representative 103-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 3, 947, 1989, 2991, 3991 };
...
test "every interior onehundredthree window keeps consecutive codes and alternating constructor families" {
...
test "onehundredthree windows preserve centered equations around the middle rejected-payload slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
