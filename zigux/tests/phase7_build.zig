...
pub fn build(b: *std.Build) void {
    ...
    const string_helpers_survey_step = b.step(
        ...
        "Run the dedicated Phase 7 string_helpers survey gate",
    );
    ...
    run_cmdline_survey_tests.setCwd(repo_root);

    const cmdline_survey_step = b.step(
        "phase7-cmdline-survey",
        "Run the dedicated Phase 7 cmdline survey gate",
    );
    ...
    run_argv_split_survey_tests.setCwd(repo_root);
    ...
    run_rbtree_survey_tests.setCwd(repo_root);

    const rbtree_survey_step = b.step(
        "phase7-rbtree-survey",
        "Run the dedicated Phase 7 rbtree survey gate",
    );
    ...
    const string_helpers_sample_boundary_step = b.step(
        ...
        "Run the dedicated Phase 7 string_helpers sample-boundary gate",
    );
    ...
    string_helpers_sample_survey_root_module.addImport("string_helpers_sample", string_helpers_sample_module);
    ...
    const string_helpers_sample_survey_step = b.step(
        "phase7-string-helpers-sample-survey",
        "Run the dedicated Phase 7 string_helpers sample survey gate",
    );
    string_helpers_sample_survey_step.dependOn(&run_string_helpers_sample_survey_tests.step);
