...
test "lane27 duoseptuagintuple replay keeps bitmap discovery stable across 72 empty banks" {
...
test "lane27 duoseptuagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 duoseptuagintuple replay ignores tail-only noise in subset and overlap checks" {
