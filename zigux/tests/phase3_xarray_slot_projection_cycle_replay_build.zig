...
pub fn build(b: *std.Build) void {
    ...
    const test_mod = b.createModule(.{
        .root_source_file = b.path("phase3_xarray_slot_projection_cycle_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const named_step = b.step(
        "phase3-xarray-slot-projection-cycle-replay",
        "Run Phase 3 xarray slot projection cycle replay tests",
    );
