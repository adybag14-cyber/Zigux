...
test "lane27 sexagintuple replay keeps bitmap discovery stable across 60 empty banks" {
...
test "lane27 sexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 sexagintuple replay ignores tail-only noise in subset and overlap checks" {
