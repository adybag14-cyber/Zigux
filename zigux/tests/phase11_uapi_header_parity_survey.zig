...
test "phase11 shared header parity manifest records the bounded layout checkpoints" {
    ...
    try std.testing.expectEqualStrings("a0bfa2fc2d924b16bcb342294bd4456dac3632f5", manifest.surveyed_commit);
...
test "phase11 shared header parity survey keeps the header boundary explicit" {
    ...
    try std.testing.expectEqual(@as(usize, 10), inventory.module_imports.len);
    try std.testing.expectEqual(@as(usize, 11), inventory.test_root_modules.len);
    ...
    try std.testing.expectEqualStrings("phase11-dw-wdt-survey-tests", inventory.build_test_names[6]);
    try std.testing.expectEqualStrings("phase11-uapi-header-parity-survey-tests", inventory.build_test_names[7]);
    try std.testing.expectEqualStrings("phase11-hvc-console-tests", inventory.build_test_names[8]);
    try std.testing.expectEqualStrings("phase11-hvc-console-poll-retry-split-tests", inventory.build_test_names[9]);
    try std.testing.expectEqualStrings("phase11-hvc-console-survey-tests", inventory.build_test_names[10]);
    try std.testing.expectEqualStrings("run_phase11_dw_wdt_survey_tests", inventory.shared_test_depend_steps[6]);
    try std.testing.expectEqualStrings("run_phase11_uapi_header_parity_survey_tests", inventory.shared_test_depend_steps[7]);
    try std.testing.expectEqualStrings("run_phase11_hvc_console_tests", inventory.shared_test_depend_steps[8]);
    try std.testing.expectEqualStrings("run_phase11_hvc_console_poll_retry_split_tests", inventory.shared_test_depend_steps[9]);
    try std.testing.expectEqualStrings("phase11_uapi_header_parity_survey_module", inventory.module_root_source_files[12].module);
    try std.testing.expectEqualStrings("phase11_uapi_header_parity_survey.zig", inventory.module_root_source_files[12].path);
    try std.testing.expectEqualStrings("hvc_console_module", inventory.module_root_source_files[13].module);
    try std.testing.expectEqualStrings("../../drivers/tty/hvc/hvc_console.zig", inventory.module_root_source_files[13].path);
    try std.testing.expectEqualStrings("phase11_hvc_console_poll_retry_split_module", inventory.module_root_source_files[15].module);
    try std.testing.expectEqualStrings("phase11_hvc_console_poll_retry_split.zig", inventory.module_root_source_files[15].path);
    try std.testing.expectEqualStrings("phase11_uapi_header_parity_survey_module", inventory.module_imports[5].module);
    try std.testing.expectEqualStrings("layout_assert", inventory.module_imports[5].import_name);
    try std.testing.expectEqualStrings("layout_assert_module", inventory.module_imports[5].imported_module);
    try std.testing.expectEqualStrings("phase11_uapi_header_parity_survey_module", inventory.module_imports[6].module);
    try std.testing.expectEqualStrings("hvc_console", inventory.module_imports[6].import_name);
    try std.testing.expectEqualStrings("hvc_console_module", inventory.module_imports[6].imported_module);
    try std.testing.expectEqualStrings("phase11_hvc_console_poll_retry_split_module", inventory.module_imports[8].module);
    try std.testing.expectEqualStrings("hvc_console", inventory.module_imports[8].import_name);
    try std.testing.expectEqualStrings("hvc_console_module", inventory.module_imports[8].imported_module);
    try std.testing.expectEqualStrings("phase11-uapi-header-parity-survey-tests", inventory.test_root_modules[7].@"test");
    try std.testing.expectEqualStrings("phase11_uapi_header_parity_survey_module", inventory.test_root_modules[7].root_module);
    try std.testing.expectEqualStrings("phase11-hvc-console-tests", inventory.test_root_modules[8].@"test");
    try std.testing.expectEqualStrings("phase11_hvc_console_module", inventory.test_root_modules[8].root_module);
    try std.testing.expectEqualStrings("phase11-hvc-console-poll-retry-split-tests", inventory.test_root_modules[9].@"test");
    try std.testing.expectEqualStrings("phase11_hvc_console_poll_retry_split_module", inventory.test_root_modules[9].root_module);
    try std.testing.expectEqualStrings("phase11-hvc-console-survey-tests", inventory.test_root_modules[10].@"test");
    try std.testing.expectEqualStrings("phase11_hvc_console_survey_module", inventory.test_root_modules[10].root_module);
