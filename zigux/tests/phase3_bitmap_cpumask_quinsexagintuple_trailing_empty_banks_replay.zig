...
test "lane27 quinsexagintuple replay keeps bitmap discovery stable across 65 empty banks" {
...
test "lane27 quinsexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 quinsexagintuple replay ignores tail-only noise in subset and overlap checks" {
