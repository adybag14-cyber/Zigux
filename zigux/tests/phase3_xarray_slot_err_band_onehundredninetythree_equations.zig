...
test "representative 193-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 0, 22, 952, 1990, 2970, 3902 };
...
test "every interior onehundredninetythree window keeps consecutive codes and alternating constructor families" {
...
test "onehundredninetythree windows preserve a centered raw seam and three-payload center" {
    var even_residue: usize = 0;
    while (even_residue + (window_len - 1) <= err_band_span) : (even_residue += 2) {
