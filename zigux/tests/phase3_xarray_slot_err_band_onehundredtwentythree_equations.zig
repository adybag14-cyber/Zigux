...
test "representative 123-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 5, 935, 1977, 2971, 3971 };
...
test "every interior onehundredtwentythree window keeps consecutive codes and alternating constructor families" {
...
test "onehundredtwentythree windows preserve centered equations around the middle payload and err slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
