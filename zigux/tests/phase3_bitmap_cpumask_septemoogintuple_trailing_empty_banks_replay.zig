...
test "bitmap view crosses septemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across septemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore septemoogintuple tail noise in relations" {
