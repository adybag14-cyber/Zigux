...
test "lane27 quinquinquagintuple replay keeps bitmap discovery stable across 55 empty banks" {
...
test "lane27 quinquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 quinquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
