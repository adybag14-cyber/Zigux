...
test "bitmap view crosses centumseptem empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumseptem empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumseptem tail noise in relations" {
