...
test "phase14 shared smoke manifest records the current evidence bundle" {
    ...
    try std.testing.expectEqualStrings("a1c6f22f0efad22fb31f9a7608b8b52b70cbbaf9", manifest.surveyed_commit);
    ...
    try std.testing.expectEqualStrings("6689715b1930c419e49a44b1c2dd317548a08c1d", manifest.anchor_packets[1].surveyed_commit);
