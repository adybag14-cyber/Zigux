...
pub fn build(b: *std.Build) void {
    ...
    const phase3_policy_export_test = b.step(
        "phase3-policy-export-test",
        "Run the Phase 3 policy starter packet and export/UAPI layout replay together",
    );
    phase3_policy_export_test.dependOn(&phase3_policy_starter_packet.step);
    phase3_policy_export_test.dependOn(&phase3_export_uapi_layout.step);
}
