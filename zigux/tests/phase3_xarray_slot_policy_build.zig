...
pub fn build(b: *std.Build) void {
    ...
    const phase3_xarray_slot_policy_test = b.step(
        "phase3-xarray-slot-policy-test",
        "Run the Phase 3 xarray-slot and policy starter packets through one focused Lane 04 harness",
    );
    phase3_xarray_slot_policy_test.dependOn(&phase3_xarray_slot_starter_packet.step);
    phase3_xarray_slot_policy_test.dependOn(&phase3_policy_starter_packet.step);
}
