...
fn expectEmptySeparateLongArgumentsAsData(
...
test "phase2 genksyms wrapper preserves repeated version counts before empty separate long arguments" {
    try expectEmptySeparateLongArgumentsAsData(&.{ "--version", "--ver", "--version" }, 3);
    try expectEmptySeparateLongArgumentsAsData(
