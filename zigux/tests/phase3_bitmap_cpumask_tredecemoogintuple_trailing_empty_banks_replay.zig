...
test "bitmap view crosses tredecemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across tredecemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore tredecemoogintuple tail noise in relations" {
