...
test "representative 57-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 3, 991, 2033, 3037, 4037 };
...
test "every interior fiftyseven window keeps consecutive codes and alternating constructor families" {
...
test "fiftyseven windows preserve centered equations around the middle err-code slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
