...
pub fn build(b: *std.Build) void {
    ...
    const phase3_dev_t_starter_packet = addPhase3DevTStarterPacket(
        b,
        target,
        optimize,
    );
    ...
    const phase3_dev_t_export_test = b.step(
        "phase3-dev-t-export-test",
        "Run the Phase 3 dev_t starter packet and export/UAPI layout replay together",
    );
    phase3_dev_t_export_test.dependOn(&phase3_dev_t_starter_packet.step);
    phase3_dev_t_export_test.dependOn(&phase3_export_uapi_layout.step);
}
