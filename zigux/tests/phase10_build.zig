...
pub fn build(b: *std.Build) void {
    ...
    const test_step = b.step("test", "Run Phase 10 virtio core, virtio core survey, virtio ring, virtio input, virtio_input survey, virtio_ring survey, and virtio_mmio survey tests");
