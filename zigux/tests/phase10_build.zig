...
pub fn build(b: *std.Build) void {
    ...
    const phase10_virtio_core_verify_module = b.createModule(.{
    ...
    phase10_virtio_mmio_verify_module.addImport("virtio_mmio", virtio_mmio_module);
    ...
    const run_phase10_virtio_core_interrupt_compound_ack_tests =
        b.addRunArtifact(phase10_virtio_core_interrupt_compound_ack_tests);
    ...
    const phase10_virtio_core_verify_tests = b.addTest(.{
        ...
        .root_module = phase10_virtio_core_verify_module,
    });
    ...
    const phase10_virtio_mmio_verify_tests = b.addTest(.{
        ...
        .root_module = phase10_virtio_mmio_verify_module,
    });
    ...
    const test_step = b.step(
        "test",
        "Run Phase 10 virtio core, virtio ring, virtio input, virtio mmio, verifier, and survey tests",
    );
