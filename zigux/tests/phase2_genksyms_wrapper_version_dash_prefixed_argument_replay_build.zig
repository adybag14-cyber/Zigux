...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .name = "phase2-genksyms-wrapper-version-dash-prefixed-argument-replay",
    ...
    const replay_step = b.step(
        ...
        "Run the Lane 23 genksyms wrapper version dash-prefixed argument replay",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the Lane 23 genksyms wrapper version dash-prefixed argument replay");
