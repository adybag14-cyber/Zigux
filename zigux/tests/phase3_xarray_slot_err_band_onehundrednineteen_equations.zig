...
test "representative 119-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 0, 4, 934, 1976, 2978, 3976 };
...
test "every interior onehundrednineteen window keeps consecutive codes and alternating constructor families" {
...
test "onehundrednineteen windows preserve centered equations around the middle err-code slot" {
    var even_residue: usize = 0;
    while (even_residue + (window_len - 1) <= err_band_span) : (even_residue += 2) {
