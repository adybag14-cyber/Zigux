...
test "lane27 unquinquagintuple replay keeps bitmap discovery stable across 51 empty banks" {
...
test "lane27 unquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 unquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
