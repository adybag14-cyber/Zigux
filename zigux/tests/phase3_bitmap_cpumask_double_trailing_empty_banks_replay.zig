...
test "double trailing empty banks keep early windows aligned and late banks empty" {
...
test "double trailing empty banks keep subset and overlap checks bounded under masked late noise" {
    const capacity = (3 * bitmap_view.word_bits) + 9;
