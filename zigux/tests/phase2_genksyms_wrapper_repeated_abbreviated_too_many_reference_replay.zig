...
test "phase2 genksyms wrapper abbreviated version fixture stays aligned before reference-limit failures" {
...
test "phase2 genksyms wrapper preserves repeated abbreviated version counts before too many reference files" {
    try expectTooManyReferenceFailure(&.{ "--ver", "--ver" }, 2);
    try expectTooManyReferenceFailure(&.{ "--ver", "-V", "--ver" }, 3);
}
