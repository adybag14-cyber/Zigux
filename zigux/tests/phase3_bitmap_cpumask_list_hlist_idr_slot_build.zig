...
pub fn build(b: *std.Build) void {
    ...
    const combined_step = b.step(
        "phase3-bitmap-cpumask-list-hlist-idr-slot-test",
        "Run the shared Phase 3 bitmap/cpumask, list/hlist, and IDR-slot starter packets from zigux/tests",
    );
    ...
    const test_step = b.step(
        "test",
        "Run the Lane 04 Phase 3 bitmap/cpumask, list/hlist, and IDR-slot harness shard",
    );
