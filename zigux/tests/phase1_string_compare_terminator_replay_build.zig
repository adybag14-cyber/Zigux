...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .name = "phase1-string-compare-terminator-replay-tests",
    ...
    const replay_step = b.step(
        ...
        "Run the focused Phase 1 string compare terminator replay.",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the focused Phase 1 string compare terminator replay.");
