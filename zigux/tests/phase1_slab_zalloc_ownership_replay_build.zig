...
pub fn build(b: *std.Build) void {
    ...
    const run = addPhase1SlabZallocOwnershipReplay(b, target, optimize);

    const replay_step = b.step("phase1-slab-zalloc-ownership-replay", "Run the Phase 1 slab/zalloc ownership hardening replay");
