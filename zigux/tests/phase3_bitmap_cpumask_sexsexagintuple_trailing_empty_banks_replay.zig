...
test "lane27 sexsexagintuple replay keeps bitmap discovery stable across 66 empty banks" {
...
test "lane27 sexsexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 sexsexagintuple replay ignores tail-only noise in subset and overlap checks" {
