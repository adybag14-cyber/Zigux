...
test "phase 15 parity scorecard manifest records all freeze-map anchors and decision-record templates" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_repo_handoff, "phase15_architecture_council_review_process_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_repo_handoff, "phase15_architecture_council_review_process.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_repo_handoff, "phase15_readiness_gate_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_repo_handoff, "phase15_readiness_gate.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_repo_handoff, "phase15_build.zig") != null);
