...
pub fn build(b: *std.Build) void {
    ...
    const combined_step = b.step(
        "phase3-list-hlist-policy-idr-slot-test",
        "Run the shared Phase 3 list/hlist, policy, and IDR-slot starter packets from zigux/tests",
    );
    ...
    const test_step = b.step(
        "test",
        "Run the Lane 04 Phase 3 list/hlist, policy, and IDR-slot harness shard",
    );
