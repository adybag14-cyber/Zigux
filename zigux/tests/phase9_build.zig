...
pub fn build(b: *std.Build) void {
    ...
    const run_runtime_kretprobe_diff_tests = b.addRunArtifact(
        runtime_kretprobe_diff_tests,
    );
    ...
    const phase9_runtime_kretprobe_module = b.step(
        ...
        "Run the Phase 9 runtime kretprobe module-boundary lifecycle tests.",
    );
    ...
    const phase9_runtime_kretprobe_survey = b.step(
        ...
        "Run the Phase 9 runtime kretprobe survey gate tests.",
    );
    ...
    const phase9_runtime_kretprobe_loader = b.step(
        ...
        "Run the Phase 9 runtime kretprobe loader handoff tests.",
    );
    ...
    const phase9_runtime_kretprobe = b.step(
        ...
        "Run the Phase 9 runtime kretprobe sample, diff, module, loader, and survey tests.",
    );
