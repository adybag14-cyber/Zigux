...
test "bitmap view crosses quattuoroogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across quattuoroogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore quattuoroogintuple tail noise in relations" {
