...
test "bitmap view crosses centumdecem empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumdecem empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumdecem tail noise in relations" {
