...
pub fn build(b: *std.Build) void {
    ...
    const notifier_abi_bindings = b.createModule(.{
    ...
    root_module.addImport("notifier_abi_bindings", notifier_abi_bindings);
    ...
    const test_step = b.step(
        ...
        "Run the focused Phase 3 notifier chain view helper tests",
    );
