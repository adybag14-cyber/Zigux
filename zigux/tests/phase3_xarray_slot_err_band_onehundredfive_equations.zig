...
test "representative 105-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 5, 945, 1987, 2989, 3989 };
...
test "every interior onehundredfive window keeps consecutive codes and alternating constructor families" {
...
test "onehundredfive windows preserve centered equations around the middle err-code slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
