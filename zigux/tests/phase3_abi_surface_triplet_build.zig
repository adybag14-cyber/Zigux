...
pub fn build(b: *std.Build) void {
    ...
    const triplet_step = b.step(
        "phase3-abi-surface-triplet-test",
        "Run the shared Phase 3 ABI core, export/UAPI layout, and low-level wrapper packets through a standalone triplet build shard",
    );
    triplet_step.dependOn(&phase3_abi_core_packet.step);
    triplet_step.dependOn(&phase3_export_uapi_layout.step);
    triplet_step.dependOn(&phase3_low_level_wrappers.step);
}
