...
test "bitmap view crosses quattuordecemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across quattuordecemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore quattuordecemoogintuple tail noise in relations" {
