...
test "lane27 tresquinquagintuple replay keeps bitmap discovery stable across 53 empty banks" {
...
test "lane27 tresquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 tresquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
