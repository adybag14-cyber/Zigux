...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_low_level_wrapper_range_overflow_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_step = b.step(
        "phase3-low-level-wrapper-range-overflow-replay",
        "Run the focused Phase 3 low-level wrapper range overflow replay",
    );
