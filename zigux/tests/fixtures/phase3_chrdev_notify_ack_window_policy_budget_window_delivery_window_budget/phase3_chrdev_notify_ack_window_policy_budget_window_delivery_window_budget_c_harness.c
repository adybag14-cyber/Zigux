...
static void print_summary(const struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summary *summary)
{
	printf("{\"window_policy_budget_window_delivery_window_status\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_flags\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_before\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_after\":%u,"
	       "\"deferred_window_policy_budget_window_delivery_window_budget_before\":%u,"
	       "\"deferred_window_policy_budget_window_delivery_window_budget_after\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_status\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_acked_count\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_deferred_count\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_suppressed_count\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_coalesced_count\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_dropped_count\":%u,"
	       "\"window_policy_budget_window_delivery_window_budget_skipped_count\":%u}",
...
int main(void)
{
	...
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view acked =
		zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view_from_bits(words, 240, 32, 8, 8, 2, ZIGUX_IDA_POLICY_LAST_FIT, 37, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_FOP_OPEN | ZIGUX_CHRDEV_FOP_RELEASE | ZIGUX_CHRDEV_FOP_WRITE, ZIGUX_CHRDEV_IO_OP_WRITE, 20, 8, 1024, 4, 1, 3, 2, 1, 5, 1, 4, 2, 0x1111, 1, ZIGUX_CHRDEV_NOTIFY_MASK_SUCCESS, 1, 0xAAAA, 0, 1, 0, ZIGUX_CHRDEV_NOTIFY_ACK_MASK_ISSUED, 2, 0xA1A1, 1, 0, 1, 0, 0, 0, 1, 0, 2, 0, 1, 0, 3, 0, 2, 1);
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view fallback_deferred =
		zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view_from_bits(words, 240, 32, 8, 8, 2, ZIGUX_IDA_POLICY_LAST_FIT, 37, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_FOP_OPEN | ZIGUX_CHRDEV_FOP_RELEASE | ZIGUX_CHRDEV_FOP_WRITE, ZIGUX_CHRDEV_IO_OP_WRITE, 20, 8, 1024, 4, 1, 3, 2, 1, 5, 1, 4, 2, 0x1111, 1, ZIGUX_CHRDEV_NOTIFY_MASK_SUCCESS, 1, 0xBBBB, 0, 1, 0, ZIGUX_CHRDEV_NOTIFY_ACK_MASK_ISSUED, 2, 0xB2B2, 1, 0, 1, 0, 0, 0, 1, 0, 2, 0, 1, 0, 3, 0, 0, 1);
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view policy_deferred =
		zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view_from_bits(words, 240, 32, 8, 8, 2, ZIGUX_IDA_POLICY_LAST_FIT, 37, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_FOP_OPEN | ZIGUX_CHRDEV_FOP_RELEASE | ZIGUX_CHRDEV_FOP_WRITE, ZIGUX_CHRDEV_IO_OP_WRITE, 20, 8, 1024, 4, 1, 3, 2, 1, 5, 1, 4, 2, 0x1111, 1, ZIGUX_CHRDEV_NOTIFY_MASK_SUCCESS, 1, 0xCCCC, 0, 1, 0, ZIGUX_CHRDEV_NOTIFY_ACK_MASK_ISSUED, 2, 0xC3C3, 1, 0, 1, 0, 0, ZIGUX_CHRDEV_NOTIFY_ACK_WINDOW_POLICY_FORCE_DEFERRED, 1, 1, 3, 0, 1, 1, 3, 0, 2, 1);
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view coalesced =
	...
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view suppressed =
	...
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view dropped =
		zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view_from_bits(words, 240, 32, 8, 8, 2, ZIGUX_IDA_POLICY_LAST_FIT, 37, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_MODE_READ | ZIGUX_CHRDEV_MODE_WRITE, ZIGUX_CHRDEV_FOP_OPEN | ZIGUX_CHRDEV_FOP_RELEASE | ZIGUX_CHRDEV_FOP_WRITE, ZIGUX_CHRDEV_IO_OP_WRITE, 20, 8, 1024, 4, 1, 3, 2, 1, 5, 1, 4, 2, 0xDDDD, 1, ZIGUX_CHRDEV_NOTIFY_MASK_SUCCESS, 1, 0xDDDD, 0, 1, 0, ZIGUX_CHRDEV_NOTIFY_ACK_MASK_ISSUED, 2, 0xD4D4, 1, 0, 1, 0, 0, 0, 1, 0, 2, 0, 0, 0, 0, 0, 0, 0);
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view skipped =
	...
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view empty = {0};
	struct zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summary summary;
	...
	printf("{\"constants\":{"
	       ...
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_flag_window_delivery_window_budget_used\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_flag_deferred_window_delivery_window_budget_used\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_flag_window_delivery_window_budget_exhausted\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_flag_deferred_window_delivery_window_budget_exhausted\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_none\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_acked\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_deferred\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_suppressed\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_coalesced\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_dropped\":%u,"
	       "\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_status_skipped\":%u}",
	...
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&acked);
	print_summary(&summary);
	printf("}");
	printf(",\"fallback_deferred\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&fallback_deferred);
	print_summary(&summary);
	printf("}");
	printf(",\"policy_deferred\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&policy_deferred);
	print_summary(&summary);
	printf("}");
	printf(",\"coalesced\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&coalesced);
	print_summary(&summary);
	printf("}");
	printf(",\"suppressed\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&suppressed);
	print_summary(&summary);
	printf("}");
	printf(",\"dropped\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&dropped);
	print_summary(&summary);
	printf("}");
	printf(",\"skipped\":{\"summary\":");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&skipped);
	print_summary(&summary);
	printf("}");
	printf(",\"empty\":{\"is_valid\":%s,\"summary\":",
	       zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_view_valid(&empty) ? "true" : "false");
	summary = zigux_chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_summarize(&empty);
	print_summary(&summary);
	printf("}}\n");
	return 0;
}
