...
int main(void)
{
    struct zigux_list_head empty_list_head = { 0, 0 };
    struct zigux_list_head list_head = { 0, 0 };
    struct zigux_list_head list_first = { 0, 0 };
    struct zigux_list_head list_second = { 0, 0 };
    struct zigux_hlist_head empty_hlist_head = { 0 };
    struct zigux_hlist_head hlist_head = { 0 };
    struct zigux_hlist_node hlist_first = { 0, 0 };
    struct zigux_hlist_node hlist_second = { 0, 0 };
