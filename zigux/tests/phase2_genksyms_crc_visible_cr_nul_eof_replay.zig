...
test "lane19 visible EOF replay preserves leading carriage returns before an embedded NUL" {
    var split_then_visible_cr_then_nul = try std.ArrayList(u8).initCapacity(std.testing.allocator, c_line_payload_len + 5);
