...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_list_hlist_empty_head_shadow_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const step = b.step(
        "phase3-list-hlist-empty-head-shadow-replay",
        "Run the Lane 28 empty-head shadow replay",
    );
