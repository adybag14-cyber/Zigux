...
test "bitmap view crosses centumsex empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumsex empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumsex tail noise in relations" {
