...
pub fn build(b: *std.Build) void {
    ...
    const phase3_abi_export_test = b.step(
        "phase3-abi-export-test",
        "Run the Phase 3 ABI core packet and export/UAPI layout replay together",
    );
    phase3_abi_export_test.dependOn(&phase3_abi_core_packet.step);
    phase3_abi_export_test.dependOn(&phase3_export_uapi_layout.step);
}
