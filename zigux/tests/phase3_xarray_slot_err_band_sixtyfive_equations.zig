...
test "representative 65-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 1, 3, 983, 2025, 3029, 4029 };
...
test "every interior sixtyfive window keeps consecutive codes and alternating constructor families" {
...
test "sixtyfive windows preserve centered equations around the middle err-code slot" {
    var odd_residue: usize = 1;
    while (odd_residue + (window_len - 1) <= err_band_span) : (odd_residue += 2) {
