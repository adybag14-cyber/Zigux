...
fn parityGroupCmp(_: ?*anyopaque, a: *const list_sort.ListHead, b: *const list_sort.ListHead) i32 {
...
test "phase1 list_sort preserves stable bucket order across parity groups" {
    ...
    list_sort.listSort(null, &head, parityGroupCmp);
