...
test "phase12 virtio_scsi survey manifest records the landed host-limit summary starter" {
    ...
    try std.testing.expectEqualStrings("658cf1efef9df701a00ee53d28a6ca3f49cbeb7d", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "658cf1efef9df701a00ee53d28a6ca3f49cbeb7d") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_MANIFEST_COUNT=4") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_SHARED_BUILD_TEST_COUNT=8") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_SHARED_BUILD_DEPEND_STEP_COUNT=8") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_EXPECTED_SUMMARY_LINE=Build Summary: 17/17 steps succeeded; 34/34 tests passed") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_STARTER_STATUS_COUNT=44") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_BLOCKED_DMA_STATUS_COUNT=3") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_BLOCKED_OBJECT_STATUS_COUNT=2") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `658cf1efef9df701a00ee53d28a6ca3f49cbeb7d`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/drivers/scsi/virtio_scsi.c") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/zigux/tests/phase12_virtio_scsi_manifest.json") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/scripts/zigux/validate-phase12.py") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "6e72ae7d73be1bd23c848ca79574a19bbfd34fc496fcc47f118632404ad415a4") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/zigux/Makefile") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/drivers/scsi/virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/zigux/tests/phase12_virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/zigux/tests/phase12_virtio_scsi_survey.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "78abfa4c5db436c5589e8147805df9989c13b680dd74b2975c19753e8c4fd478") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/zigux/tests/phase12_build.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/658cf1efef9df701a00ee53d28a6ca3f49cbeb7d/Documentation/zigux/phase12-virtio-scsi-slice.md") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_result: `PHASE12_VALIDATION=pass`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_manifest_count: `4`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_build_test_count: `8`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_depend_step_count: `8`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_expected_summary_line: `Build Summary: 17/17 steps succeeded; 34/34 tests passed`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_starter_status_count: `44`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_blocked_dma_status_count: `3`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_blocked_object_status_count: `2`") != null);
