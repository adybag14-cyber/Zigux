...
test "phase12 virtio_scsi survey manifest records the landed host-limit summary starter" {
    ...
    try std.testing.expectEqualStrings("5fbde08521966dd60c0e0591fea0cbc7c9a3cd62", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "5fbde08521966dd60c0e0591fea0cbc7c9a3cd62") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `5fbde08521966dd60c0e0591fea0cbc7c9a3cd62`") != null);
