...
test "phase12 virtio_scsi survey manifest records the landed queue-depth summary starter" {
    ...
    try std.testing.expectEqualStrings("3317e49e21d96ab2b555569c6224da84374c49d4", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "3317e49e21d96ab2b555569c6224da84374c49d4") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_VALIDATION=fail") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "phase12_libbpf_manifest.json:gap_count") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `3317e49e21d96ab2b555569c6224da84374c49d4`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/drivers/scsi/virtio_scsi.c") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/zigux/tests/phase12_virtio_scsi_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "3bb313de76ce119322fcffe7d88bf34763e2d7d9149b7355338b72587d6af409") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/scripts/zigux/validate-phase12.py") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "ba9c249b998a3eb9c260b80d4157a1e74892c759b23ec5198fa3e9a9923ddc29") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/zigux/Makefile") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "9ed0e0c0e7f62626606226ddaf6af1d5236f17a6089b148016be691cf74772bd") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/drivers/scsi/virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/zigux/tests/phase12_virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/zigux/tests/phase12_virtio_scsi_survey.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "00257bb4a205b861f74c185b0e51cbf9b980c1b65aab7c86bb3560357f7efea4") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/zigux/tests/phase12_build.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/Documentation/zigux/phase12-virtio-scsi-slice.md") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/3317e49e21d96ab2b555569c6224da84374c49d4/Documentation/zigux/phase12-virtio-scsi-survey.md") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "519b4542200f19bfa29f5f35148ab217f7a262e202251c81e9bd2657f850d5bd") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "shared_validator_missing_marker: `phase12_libbpf_manifest.json:gap_count`") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "current_master_replay_head: `3317e49e21d96ab2b555569c6224da84374c49d4`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "current_shared_validator_missing_marker: `phase12_libbpf_manifest.json:gap_count`") != null);
