...
test "phase12 virtio_scsi survey manifest records the landed host-limit summary starter" {
    ...
    try std.testing.expectEqualStrings("6cdf1b24fad34b4ef67f0902da0aa8621383c7ee", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "6cdf1b24fad34b4ef67f0902da0aa8621383c7ee") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `6cdf1b24fad34b4ef67f0902da0aa8621383c7ee`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/6cdf1b24fad34b4ef67f0902da0aa8621383c7ee/drivers/scsi/virtio_scsi.c") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/6cdf1b24fad34b4ef67f0902da0aa8621383c7ee/zigux/tests/phase12_virtio_scsi_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "9911fda5d529ac60d1c82438fca04c4e3d8517fbb26a27c031f2ab29e6c91257") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/6cdf1b24fad34b4ef67f0902da0aa8621383c7ee/scripts/zigux/validate-phase12.py") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "dddfe63558b86bf68ddffffeeef8c34ba5a8d8562ad8557598b4a936490174c9") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/6cdf1b24fad34b4ef67f0902da0aa8621383c7ee/zigux/Makefile") != null);
