...
test "phase12 virtio_scsi survey manifest records the landed queue-depth summary starter" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "shared `python3 scripts/zigux/validate-phase12.py` replay was red on unrelated Phase 12 packet drift") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "Treat that archived validator note as historical fallback evidence") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "not as the live validator state on newer Phase 12 heads") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "zig test zigux/tests/phase12_virtio_scsi_survey.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "passed `1/1` tests") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `7d653d8c5e57207763c07c1b1d020b514738c7f3`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/drivers/scsi/virtio_scsi.c") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/zigux/tests/phase12_virtio_scsi_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "b78911a5f739259b758ece4f7f43f09ea5cc7c75588b5a58a2d8fe45e691b8ad") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/scripts/zigux/validate-phase12.py") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "13bc19ceeb14f6807e01352f30f6fbed3e64ac34541aa4437ea28bc82e5674f8") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/zigux/Makefile") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "2a4fa2e382cb683d486fae1b503a8778d28b4d3862cb18b3c5cfcfb7618d941d") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/drivers/scsi/virtio_scsi.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "33e370bbec7c6bfaa6e51dffcea3950b011e64ecbd29175ee2743c7050bb1910") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/zigux/tests/phase12_virtio_scsi.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "c2b854ef12e6388a790f6876b57b92241031cbb69c3ec7354512eab963ecb5ea") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/zigux/tests/phase12_virtio_scsi_survey.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "e12401f490139958444c4a5be3dd35905ea6c381c81f8f5d5d231898a32408db") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/zigux/tests/phase12_build.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/Documentation/zigux/phase12-virtio-scsi-slice.md") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/7d653d8c5e57207763c07c1b1d020b514738c7f3/Documentation/zigux/phase12-virtio-scsi-survey.md") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "current_master_replay_head: `9dab85059c6f56865ef2f981d2303049775c5001`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "docs_root_readme:Phase 12 notes") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "phase12_build_fixture:expected_test_count_mismatch") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "phase12_nvme_pci_manifest.json:survey_note:surveyed_commit") != null);
