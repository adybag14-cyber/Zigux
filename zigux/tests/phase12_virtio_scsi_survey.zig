...
test "phase12 virtio_scsi survey manifest records the landed queue-depth summary starter" {
    ...
    try std.testing.expectEqualStrings("a8daee106057a542aa03f2983662bec7c06584bb", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "a8daee106057a542aa03f2983662bec7c06584bb") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "PHASE12_VALIDATION=fail") != null);
    try std.testing.expect(std.mem.indexOf(u8, survey_note, "phase12_virtio_net_manifest.json:lane_key") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "verified_master_head: `a8daee106057a542aa03f2983662bec7c06584bb`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/drivers/scsi/virtio_scsi.c") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/zigux/tests/phase12_virtio_scsi_manifest.json") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "213188f223ac545d256c584a91f355246b06b530982084f5bac268d358ea4358") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/scripts/zigux/validate-phase12.py") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "755586ee8a39c29d0a575418233455176ebee5350f27eea20a14e56cb1aa48cd") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/zigux/Makefile") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/drivers/scsi/virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/zigux/tests/phase12_virtio_scsi.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/zigux/tests/phase12_virtio_scsi_survey.zig") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "36afefd118dfafb3e5971bdc882dace7c26964f760b3bc97d86c47a0a049655b") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/zigux/tests/phase12_build.zig") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/Documentation/zigux/phase12-virtio-scsi-slice.md") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "https://raw.githubusercontent.com/adybag14-cyber/Zigux/a8daee106057a542aa03f2983662bec7c06584bb/Documentation/zigux/phase12-virtio-scsi-survey.md") != null);
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "26803c0c43606afec316d8b6688b95a681c4b3123afd319e58702c3bc47c03de") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "current_master_replay_head: `a8daee106057a542aa03f2983662bec7c06584bb`") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, raw_fallback_catalog, "phase12_virtio_net_manifest.json:lane_key") != null);
