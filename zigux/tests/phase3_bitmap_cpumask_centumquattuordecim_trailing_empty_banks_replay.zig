...
test "bitmap view crosses centumquattuordecim empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumquattuordecim empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumquattuordecim tail noise in relations" {
