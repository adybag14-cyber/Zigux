...
pub fn build(b: *std.Build) void {
    ...
    const dev_t_tests = addPhase3DevTStarterPacket(b, target, optimize);

    const lane_step = b.step(
        "phase3-policy-dev-t-test",
        "Run the Phase 3 policy and dev_t starter packets together",
    );
    lane_step.dependOn(&policy_tests.step);
    lane_step.dependOn(&dev_t_tests.step);

    const test_step = b.step("test", "Run the Phase 3 policy/dev_t standalone shard");
