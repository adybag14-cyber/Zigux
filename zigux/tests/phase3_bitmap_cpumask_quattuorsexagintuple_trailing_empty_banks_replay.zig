...
test "lane27 quattuorsexagintuple replay keeps bitmap discovery stable across 64 empty banks" {
...
test "lane27 quattuorsexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 quattuorsexagintuple replay ignores tail-only noise in subset and overlap checks" {
