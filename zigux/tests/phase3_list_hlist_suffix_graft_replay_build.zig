...
pub fn build(b: *std.Build) void {
    ...
    const root = b.createModule(.{
        .root_source_file = b.path("phase3_list_hlist_suffix_graft_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const named = b.step("phase3-list-hlist-suffix-graft-replay", "Run Lane 28 suffix graft replay");
    named.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run Lane 28 suffix graft replay");
