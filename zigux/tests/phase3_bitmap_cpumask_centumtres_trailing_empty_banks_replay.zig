...
test "bitmap view crosses centumtres empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumtres empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumtres tail noise in relations" {
