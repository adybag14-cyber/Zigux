...
pub fn build(b: *std.Build) void {
    ...
    const test_mod = b.createModule(.{
        .root_source_file = b.path("phase3_bitmap_cpumask_split_cluster_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const step = b.step(
        "phase3-bitmap-cpumask-split-cluster-replay",
        "Run the Phase 3 bitmap/cpumask split-cluster replay.",
    );
