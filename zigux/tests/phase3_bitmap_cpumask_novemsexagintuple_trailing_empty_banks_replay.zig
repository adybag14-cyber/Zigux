...
test "lane27 novemsexagintuple replay keeps bitmap discovery stable across 69 empty banks" {
...
test "lane27 novemsexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 novemsexagintuple replay ignores tail-only noise in subset and overlap checks" {
