...
pub fn build(b: *std.Build) void {
    ...
    const allocator_init_flow_step = b.step(
        "phase9-runtime-loader-allocator-init-flow-tests",
        "Run the Phase 9 runtime loader allocator/init-flow tests.",
    );
    allocator_init_flow_step.dependOn(&run_runtime_loader_allocator_init_flow_tests.step);
