...
test "bitmap view crosses centumduodecim empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumduodecim empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumduodecim tail noise in relations" {
