...
test "bitmap view crosses octoseptuagintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across octoseptuagintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore octoseptuagintuple tail noise in relations" {
