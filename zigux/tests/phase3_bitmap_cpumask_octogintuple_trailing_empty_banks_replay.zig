...
test "bitmap view crosses octogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across octogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore octogintuple tail noise in relations" {
