...
pub fn build(b: *std.Build) void {
    ...
    const combined_step = b.step(
        "phase3-bitmap-cpumask-list-hlist-policy-test",
        "Run the shared Phase 3 bitmap/cpumask, list/hlist, and policy starter packets from zigux/tests",
    );
    ...
    const test_step = b.step(
        "test",
        "Run the Lane 04 Phase 3 bitmap/cpumask, list/hlist, and policy harness shard",
    );
