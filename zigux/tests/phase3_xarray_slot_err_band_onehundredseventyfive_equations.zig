...
test "representative 175-raw err-band windows keep alias-err spacing exact" {
...
test "every interior onehundredseventyfive window keeps consecutive codes and alternating constructor families" {
...
test "onehundredseventyfive windows preserve a centered raw seam and a split payload seam" {
    var even_residue: usize = 0;
    while (even_residue + (window_len - 1) <= err_band_span) : (even_residue += 2) {
