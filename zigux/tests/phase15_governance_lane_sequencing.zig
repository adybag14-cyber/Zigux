...
test "phase 15 governance-lane sequencing manifest records the current direct packet" {
    ...
    try expectSliceContains(manifest.maintenance_replay_commands, "python3 scripts/zigux/check-phase15-review-checklist-study-only-alignment.py");
...
test "phase 15 governance-lane sequencing note names the current packet and current gaps honestly" {
    ...
    try expectContains(sequencing_note, "focused review-checklist study-only alignment checker is landed");
    try expectContains(sequencing_note, "`scripts/zigux/check-phase15-review-checklist-study-only-alignment.py`");
    try expectContains(sequencing_note, "`zigux/tests/phase15_indefinite_c_lane_owner_alignment.zig`");
    try expectContains(sequencing_note, "python3 scripts/zigux/check-phase15-review-checklist-study-only-alignment.py");
