...
- keep the current Phase 8 tooling packet reviewable through `zigux/tests/phase8_exec_cmd_only_build.zig`, `zigux/tests/phase8_libbpf_segments_only_build.zig`, and `zigux/tests/phase8_build.zig`, `scripts/zigux/validate-phase8.py`, `Documentation/zigux/phase8-exec-cmd-slice.md`, `Documentation/zigux/review-checklist.md`, `Documentation/zigux/phase8-libbpf-cpu-mask-slice.md`, `Documentation/zigux/phase8-libbpf-segment-survey.md`, and `Documentation/zigux/phase8-userspace-kernel-bridge-boundary-survey.md`, including the landed `phase8_file_path_handle_bridge.zig` helper replay, the parked deferred execution helper-only `exec-cmd` review guards, the parked command-preparation boundary, and the still-deferred `perf-buffer-online-cpu-routing` boundary beside `tools/lib/bpf/zigux_segments/cpu_mask.zig`
