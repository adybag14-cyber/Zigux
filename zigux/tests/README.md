...
- keep the current Phase 9 runtime bundle reviewable through `zigux/tests/phase9_build.zig`, `zigux/tests/runtime_loader_gap_survey.zig`, `zigux/tests/runtime_loader_gap_manifest.json`, `zigux/tests/runtime_module_metadata_survey.zig`, `zigux/tests/runtime_module_metadata_manifest.json`, `scripts/zigux/validate-phase9.py`, `scripts/zigux/check-phase9-module-metadata-packet.py`, `make -C zigux phase9-validate`, and the focused `make -C zigux phase9-module-metadata-survey` plus `make -C zigux phase9-trace-events-survey` replays instead of widening into ad hoc runtime-slice checks
...
Phase 10 guidance
- keep the current Phase 10 lab bundle reviewable through `zigux/tests/phase10_build.zig`, `zigux/tests/phase10_virtio_input_multitouch_preflight.zig`, `zigux/tests/phase10_virtio_mmio_queue_isolation.zig`, the four lane survey manifests plus the shared `zigux/tests/phase10_closure_manifest.json`, instead of treating individual virtio starter files as independent closure signals
