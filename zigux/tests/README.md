...
- `zigux/tests/README.md`
  ...
  * current live Phase 1 workflow-gate packet: `.github/workflows/zigux-bootstrap.yml`, `python3 scripts/zigux/check-phase1-bench.py --self-test`, `python3 scripts/zigux/check-phase1-shared-reminder-packet.py --self-test`, and `python3 scripts/zigux/check-phase1-shared-reminder-packet.py`
