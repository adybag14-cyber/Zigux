...
- keep the current Phase 9 runtime bundle reviewable through `zigux/tests/phase9_build.zig`, `zigux/tests/runtime_loader_gap_survey.zig`, `zigux/tests/runtime_loader_gap_manifest.json`, `scripts/zigux/validate-phase9.py`, and `make -C zigux phase9-validate` instead of widening into ad hoc runtime-slice checks
