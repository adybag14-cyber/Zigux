...
test "phase2 genksyms wrapper preserves mixed repeated abbreviated version counts before abbreviated unexpected long option arguments" {
    try expectUnexpectedLongArgumentFailure(&.{ "--ver", "-V" }, "--he=extra", 2, "--help");
}
