...
pub fn build(b: *std.Build) void {
    ...
    const test_step = b.step(
        "phase3-list-hlist-header-family-test",
        "Run the standalone Phase 3 list/hlist starter packet plus header-family binding packet from zigux/tests",
    );
    test_step.dependOn(&list_hlist.step);
