...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .name = "phase1-helper-ports-a-range-print-replay-tests",
    ...
    const replay_step = b.step(
        ...
        "Run the focused Phase 1 helper ports A range-print replay",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the focused Phase 1 helper ports A range-print replay");
