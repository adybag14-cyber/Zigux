...
test "phase 4 atomic64 survey keeps wrapper handoff, owner map, and current local-only perf evidence explicit" {
    ...
    try std.testing.expectEqualStrings("23e5593d0ada210e445ff94df50dadd7f7b578d6", manifest.phase4_review_checklist_blob_sha);
...
// review checklist blob 23e5593d0ada210e445ff94df50dadd7f7b578d6
