...
test "phase 4 atomic64 survey keeps wrapper handoff, owner map, and current local-only perf evidence explicit" {
    ...
    try std.testing.expectEqualStrings("492cdecc11d5adbdc9086f7bbce72bfb0b8c4fbe", manifest.phase4_gate_evidence_blob_sha);
...
// phase4 gate evidence blob 492cdecc11d5adbdc9086f7bbce72bfb0b8c4fbe
