...
test "phase 4 atomic64 survey keeps wrapper handoff, owner map, and current local-only perf evidence explicit" {
    ...
    try std.testing.expectEqualStrings("0e3db00a96c329a90ebf224e7f17c23e932d46b3", manifest.phase4_review_checklist_blob_sha);
...
// review checklist blob 0e3db00a96c329a90ebf224e7f17c23e932d46b3
