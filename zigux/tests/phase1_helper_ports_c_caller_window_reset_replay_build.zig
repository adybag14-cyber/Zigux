...
pub fn build(b: *std.Build) void {
    ...
    const replay_step = b.step(
        "phase1-helper-ports-c-caller-window-reset-replay",
        "Run Lane 10 helper ports C caller-window reset replay",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run Lane 10 helper ports C caller-window reset replay");
