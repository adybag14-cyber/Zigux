...
pub fn build(b: *std.Build) void {
    ...
    const replay_tests = b.addTest(.{
        .name = "phase2-genksyms-wrapper-repeated-version-help-replay-tests",
        .root_module = root_module,
    });
    const run_replay_tests = b.addRunArtifact(replay_tests);

    const test_step = b.step("test", "Run focused Phase 2 genksyms wrapper repeated version-help replay tests.");
