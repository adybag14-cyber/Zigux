...
test "phase 15 architecture council review-process manifest records current trigger, packet, and handoff behavior" {
    ...
    try std.testing.expectEqualStrings("3156353bb605fae0337e56968fb00e9977c898f8", manifest.surveyed_commit);
    ...
    try std.testing.expect(std.mem.indexOf(u8, manifest.handoff_evidence.current_bounded_lane, "P15-L07") != null);
...
test "phase 15 architecture council review-process note stays aligned with checklist and handoff language" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, review_process, "current bounded lane: `P15-L07`") != null);
