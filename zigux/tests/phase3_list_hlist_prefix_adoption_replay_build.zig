...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_list_hlist_prefix_adoption_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const named_step = b.step("phase3-list-hlist-prefix-adoption-replay", "Run the Phase 3 list/hlist prefix adoption replay");
