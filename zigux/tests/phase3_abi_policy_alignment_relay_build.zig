...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_abi_policy_alignment_relay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_step = b.step(
        "phase3-abi-policy-alignment-relay-test",
        "Run the focused Phase 3 ABI policy-alignment relay packet",
    );
