...
test "lane27 quinseptuagintuple replay keeps bitmap discovery stable across 75 empty banks" {
...
test "lane27 quinseptuagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 quinseptuagintuple replay ignores tail-only noise in subset and overlap checks" {
