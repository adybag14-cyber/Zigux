...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_list_hlist_bridge_pair_middle_claim_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const step = b.step("phase3-list-hlist-bridge-pair-middle-claim-replay", "Run the Phase 3 list/hlist bridge-pair middle-claim replay");
