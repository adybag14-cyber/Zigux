...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("phase3_bitmap_cpumask_window_slide_replay.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const test_step = b.step("phase3-bitmap-cpumask-window-slide-replay", "Run the Phase 3 bitmap/cpumask window-slide replay");
