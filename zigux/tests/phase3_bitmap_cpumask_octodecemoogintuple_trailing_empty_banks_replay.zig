...
fn octodecemoogintupleWords() [word_count]Word {
...
test "octodecemoogintuple trailing empty banks keep bitmap and cpumask traversal aligned" {
    const words = octodecemoogintupleWords();
...
test "octodecemoogintuple trailing empty banks keep subset and overlap tail bounded" {
    const base_words = octodecemoogintupleWords();
