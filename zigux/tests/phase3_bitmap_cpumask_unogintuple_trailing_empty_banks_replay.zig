...
test "bitmap view crosses unogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across unogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore unogintuple tail noise in relations" {
