...
test "bitmap view crosses centumtredecim empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumtredecim empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumtredecim tail noise in relations" {
