...
test "bitmap view crosses centumquattuor empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumquattuor empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumquattuor tail noise in relations" {
