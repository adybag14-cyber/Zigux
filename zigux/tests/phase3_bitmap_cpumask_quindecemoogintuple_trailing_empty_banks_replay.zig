...
test "bitmap view crosses quindecemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across quindecemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore quindecemoogintuple tail noise in relations" {
