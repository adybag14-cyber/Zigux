...
test "lane27 unseptuagintuple replay keeps bitmap discovery stable across 71 empty banks" {
...
test "lane27 unseptuagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 unseptuagintuple replay ignores tail-only noise in subset and overlap checks" {
