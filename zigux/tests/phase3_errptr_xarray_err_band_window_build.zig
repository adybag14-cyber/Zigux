...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_errptr_xarray_err_band_window.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_step = b.step(
        "phase3-errptr-xarray-err-band-window",
        "Run the Phase 3 err_ptr/xarray err-band window replay",
    );
