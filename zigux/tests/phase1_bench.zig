...
fn rbtreeBench() struct { checksum: u64, duplicate_checksum: u64, cached_checksum: u64 } {
    ...
    return .{ .checksum = checksum, .duplicate_checksum = duplicate_checksum, .cached_checksum = cached_checksum };
}
