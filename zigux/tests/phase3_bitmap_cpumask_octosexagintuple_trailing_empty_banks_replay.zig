...
test "lane27 octosexagintuple replay keeps bitmap discovery stable across 68 empty banks" {
...
test "lane27 octosexagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 octosexagintuple replay ignores tail-only noise in subset and overlap checks" {
