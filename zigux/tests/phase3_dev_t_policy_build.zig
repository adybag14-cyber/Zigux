...
pub fn build(b: *std.Build) void {
    ...
    const phase3_dev_t_policy_test = b.step(
        "phase3-dev-t-policy-test",
        "Run the Phase 3 dev_t and policy starter packets together",
    );
    phase3_dev_t_policy_test.dependOn(&phase3_dev_t_starter_packet.step);
    phase3_dev_t_policy_test.dependOn(&phase3_policy_starter_packet.step);
}
