...
test "phase3 abi keeps shared interop-policy recognition aligned with dedicated policy helpers" {
    ...
    try std.testing.expectEqual(abi.unsafeScopeFromInteropPolicy(bug_heap), unsafe_policy.scopeFromInteropPolicy(bug_heap));
