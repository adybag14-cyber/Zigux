...
test "bitmap view crosses centumduo empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumduo empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumduo tail noise in relations" {
