...
pub fn build(b: *std.Build) void {
    ...
    const contract = b.addTest(.{
        .name = "phase1-bench-live-check-workflow-contract",
        .root_module = b.createModule(.{
            .root_source_file = b.path("phase1_bench_live_check_workflow_contract.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const contract_step = b.step(
        "phase1-bench-live-check-workflow-contract",
