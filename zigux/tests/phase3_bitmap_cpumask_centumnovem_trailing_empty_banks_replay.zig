...
test "bitmap view crosses centumnovem empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across centumnovem empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore centumnovem tail noise in relations" {
