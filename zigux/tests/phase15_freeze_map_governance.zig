...
test "phase 15 freeze-map governance doc records the current blocker posture honestly" {
    ...
    try expectContains(governance_note, "current-master-readback-2026-05-15");
    try expectContains(governance_note, "prior dated marker `current-master-readback-2026-05-14` no longer represented the latest survey date");
