...
test "phase 15 freeze-map governance manifest records the current route-gap posture" {
    ...
    try expectContains(manifest.maintenance_handoff.next_future_target, "scripts\zigux/validate_phase15.zig");
    ...
    try expectContains(rcu_survey.repo_reality, "scripts\zigux/validate_phase15.zig");
    try expectContains(rcu_survey.repo_reality, "zigux/tests/phase15_build.zig");
    try expectContains(rcu_survey.repo_reality, "scripts\zigux/check_phase15_tests_readme_alignment.zig");
    ...
    try expectContains(docs_checker_gap.why_now, "Direct contents readback resolves scripts\zigux/check_phase15_docs_readme_alignment.zig");
    ...
    try expectContains(readiness_checker_gap.why_now, "Direct contents readback resolves scripts\zigux/check_phase15_readiness_gate_packet.zig");
    ...
    try expectContains(checklist_guard_gap.why_now, "Direct contents readback resolves scripts\zigux/check_phase15_review_checklist_study_only_alignment.zig");
    ...
    try expectContains(tests_guard_gap.why_now, "Direct contents readback resolves scripts\zigux/check_phase15_tests_readme_alignment.zig");
    ...
    try expectContains(validator_gap.why_now, "Current direct reads now materialize scripts\zigux/validate_phase15.zig");
...
test "phase 15 freeze-map governance doc records the refreshed route classification honestly" {
    ...
    try expectContains(governance_note, "the focused docs-root alignment checker `scripts\zigux/check_phase15_docs_readme_alignment.zig`");
    ...
    try expectContains(governance_note, "direct contents readback resolves `scripts\zigux/check_phase15_docs_readme_alignment.zig`, so the focused docs-root alignment guard stays adjacent direct-readback evidence");
    try expectContains(governance_note, "the tests-root Phase 15 alignment checker `scripts\zigux/check_phase15_tests_readme_alignment.zig`");
    try expectContains(governance_note, "direct contents readback resolves `scripts\zigux/validate_phase15.zig`, so the validator-first companion stays adjacent direct-readback evidence");
