...
pub fn build(b: *std.Build) void {
    ...
    const test_step = b.step(
        "phase3-list-hlist-abi-test",
        "Run the shared Phase 3 list/hlist starter packet plus ABI core packet",
    );
    test_step.dependOn(&phase3_list_hlist_starter_packet.step);
