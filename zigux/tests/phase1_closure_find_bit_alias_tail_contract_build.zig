...
fn addContractTest(
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase1_closure_find_bit_alias_tail_contract.zig"),
        .target = target,
        .optimize = optimize,
    });
    const tests = b.addTest(.{
        .name = "phase1-closure-find-bit-alias-tail-contract",
...
pub fn build(b: *std.Build) void {
    ...
    const contract_step = b.step(
        "phase1-closure-find-bit-alias-tail-contract",
