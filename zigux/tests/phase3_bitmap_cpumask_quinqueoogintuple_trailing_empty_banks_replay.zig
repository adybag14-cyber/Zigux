...
test "bitmap view crosses quinqueoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across quinqueoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore quinqueoogintuple tail noise in relations" {
