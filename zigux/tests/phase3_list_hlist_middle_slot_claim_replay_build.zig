...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase3_list_hlist_middle_slot_claim_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const step = b.step(
        "phase3-list-hlist-middle-slot-claim-replay",
        "Run the Lane 28 middle-slot-claim replay",
    );
