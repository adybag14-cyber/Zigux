...
pub fn build(b: *std.Build) void {
    ...
    const unit_tests = b.addTest(.{
        .name = "phase3-abi-core-header-family",
        .root_module = root_module,
    });
    const run_unit_tests = b.addRunArtifact(unit_tests);

    const test_step = b.step(
        "phase3-abi-core-header-family-test",
        "Run the focused Phase 3 ABI core packet with explicit header-family binding wiring",
    );
