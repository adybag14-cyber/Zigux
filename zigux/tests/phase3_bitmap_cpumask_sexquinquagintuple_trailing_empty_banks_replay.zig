...
test "lane27 sexquinquagintuple replay keeps bitmap discovery stable across 56 empty banks" {
...
test "lane27 sexquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 sexquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
