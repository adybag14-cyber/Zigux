...
test "lane27 novemquinquagintuple replay keeps bitmap discovery stable across 59 empty banks" {
...
test "lane27 novemquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 novemquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
