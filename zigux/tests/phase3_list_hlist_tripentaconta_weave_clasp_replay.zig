...
const staged_break_index = 33;
const route = [_]usize{
    52, 0,  27, 26, 51, 1,  28, 25, 50, 2,  29, 24, 49, 3,
    30, 23, 48, 4,  31, 22, 47, 5,  32, 21, 46, 6,  33, 20,
    45, 7,  34, 19, 44, 8,  35, 18, 43, 9,  36, 17, 42, 10,
    37, 16, 41, 11, 38, 15, 40, 12, 39, 14, 13,
};
...
test "tripentaconta weave-clasp list route exposes staged backlink repair" {
...
test "tripentaconta weave-clasp hlist route exposes staged pprev repair" {
