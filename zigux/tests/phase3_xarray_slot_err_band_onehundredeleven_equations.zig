...
test "representative 111-raw err-band windows keep alias-err spacing exact" {
    const left_residues = [_]usize{ 0, 4, 938, 1980, 2982, 3982 };
...
test "every interior onehundredeleven window keeps consecutive codes and alternating constructor families" {
...
test "onehundredeleven windows preserve centered equations around the middle err-code slot" {
    var even_residue: usize = 0;
    while (even_residue + (window_len - 1) <= err_band_span) : (even_residue += 2) {
