...
test "bitmap view crosses undecemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across undecemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore undecemoogintuple tail noise in relations" {
