...
pub fn build(b: *std.Build) void {
    ...
    const replay_step = b.step("phase1-argv-split-whitespace-replay", "Run Phase 1 argv_split whitespace replay tests");
    replay_step.dependOn(&run_replay_tests.step);

    const test_step = b.step("test", "Run Phase 1 argv_split whitespace replay tests");
