...
test "list entry stagger keeps the live first interior node visible until adoption" {
    var head = list_view.ListHead{ .next = 0, .prev = 0 };
    var first = list_view.ListHead{ .next = 0, .prev = 0 };
    var live_mid_a = list_view.ListHead{ .next = 0, .prev = 0 };
    var live_mid_b = list_view.ListHead{ .next = 0, .prev = 0 };
    var alt_first = list_view.ListHead{ .next = 0, .prev = 0 };
    ...
    alt_first.next = @intFromPtr(&live_mid_a);
    alt_first.prev = @intFromPtr(&head);
...
test "list entry stagger reports the first stale interior backlink after adoption" {
    var head = list_view.ListHead{ .next = 0, .prev = 0 };
    var first = list_view.ListHead{ .next = 0, .prev = 0 };
    var live_mid_a = list_view.ListHead{ .next = 0, .prev = 0 };
    var live_mid_b = list_view.ListHead{ .next = 0, .prev = 0 };
    ...
    head.next = @intFromPtr(&alt_first);
    head.prev = @intFromPtr(&tail);
    first.next = @intFromPtr(&live_mid_a);
    first.prev = @intFromPtr(&head);
    live_mid_a.next = @intFromPtr(&live_mid_b);
    ...
    try testing.expectEqual(@as(usize, @intFromPtr(&alt_first)), breakage.expected_prev);
...
test "hlist entry stagger keeps the live first interior node visible until adoption" {
    var head = hlist_view.HListHead{ .first = 0 };
    var first = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var live_mid_a = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var live_mid_b = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var alt_first = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    ...
    alt_first.next = @intFromPtr(&live_mid_a);
    alt_first.pprev = @intFromPtr(&head.first);
...
test "hlist entry stagger reports the first stale interior prev link after adoption" {
    var head = hlist_view.HListHead{ .first = 0 };
    var first = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var live_mid_a = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var live_mid_b = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    ...
    head.first = @intFromPtr(&alt_first);
    first.next = @intFromPtr(&live_mid_a);
    first.pprev = @intFromPtr(&head.first);
    live_mid_a.next = @intFromPtr(&live_mid_b);
    live_mid_a.pprev = @intFromPtr(&first.next);
    ...
    try testing.expectEqual(@as(usize, 1), breakage.current_index);
    try testing.expectEqual(@as(usize, @intFromPtr(&alt_first.next)), breakage.expected_pprev);
