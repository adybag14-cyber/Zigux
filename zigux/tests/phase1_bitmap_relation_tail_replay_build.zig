...
pub fn build(b: *std.Build) void {
    ...
    const tests = b.addTest(.{
        .name = "phase1-bitmap-relation-tail-replay-test",
    ...
    const replay_step = b.step(
        ...
        "Run the focused Phase 1 bitmap relation tail replay",
    );
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the focused Phase 1 bitmap relation tail replay");
