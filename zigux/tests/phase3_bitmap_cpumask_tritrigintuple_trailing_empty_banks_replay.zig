...
test "tritrigintuple trailing empty banks keep early windows aligned and masked tail bits bounded" {
...
test "tritrigintuple trailing empty banks keep subset and overlap checks bounded under masked late noise" {
    const capacity = (35 * bitmap_view.word_bits) + 11;
