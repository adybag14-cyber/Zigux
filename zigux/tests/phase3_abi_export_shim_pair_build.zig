...
pub fn build(b: *std.Build) void {
    ...
    uapi_dev_t_module.addImport("dev_t_bindings", dev_t_binding_module);
    ...
    const abi_tests = b.addTest(.{
        .name = "phase3_abi_export_shim_pair_abi_tests",
        .root_module = abi_bindings_module,
    });
    const export_shim_tests = b.addTest(.{
        .name = "phase3_abi_export_shim_pair_export_shim_tests",
    ...
    const test_step = b.step(
        ...
        "Run the focused Phase 3 ABI binding plus export shim pair replay",
    );
