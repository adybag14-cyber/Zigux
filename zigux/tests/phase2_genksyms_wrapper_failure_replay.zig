...
test "phase2 genksyms wrapper replay canonicalizes abbreviated missing long failures after mixed versions" {
    const args = [_][]const u8{
        "--ver",
        "--version",
        "--ref",
...
test "phase2 genksyms wrapper replay canonicalizes abbreviated unexpected long failures after mixed versions" {
    const args = [_][]const u8{
        "--version",
        "--ver",
        "--hel=extra",
