...
test "phase3 empty list and hlist witnesses stay explicit" {
...
test "phase3 malformed singleton witnesses stay visible on both helper families" {
    var list_head = list_view.ListHead{ .next = 0, .prev = 0 };
...
test "phase3 second-node witness index stays aligned for list and hlist" {
    var list_head = list_view.ListHead{ .next = 0, .prev = 0 };
...
test "phase3 one-node list and hlist keep distinct tail terminators" {
    var list_head = list_view.ListHead{ .next = 0, .prev = 0 };
