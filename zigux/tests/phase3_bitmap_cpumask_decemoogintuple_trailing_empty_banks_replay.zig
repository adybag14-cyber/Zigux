...
test "bitmap view crosses decemoogintuple empty banks before masked tail" {
...
test "cpumask view mirrors bitmap traversal across decemoogintuple empty banks" {
    const words = fixtureWords();
...
test "bitmap and cpumask masks ignore decemoogintuple tail noise in relations" {
