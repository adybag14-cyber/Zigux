...
test "list view detects and clears suffix-attach tail repair" {
    ...
    try std.testing.expectEqual(@as(usize, @intFromPtr(&new_tail)), breakage.expected_prev);
...
test "hlist view detects and clears suffix-attach prev-link repair" {
