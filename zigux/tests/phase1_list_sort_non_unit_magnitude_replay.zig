...
fn nonUnitMagnitudeCmp(_: ?*anyopaque, a: *const list_sort.ListHead, b: *const list_sort.ListHead) i32 {
...
test "phase1 list_sort accepts non-unit comparator magnitudes" {
    ...
    list_sort.listSort(null, &head, nonUnitMagnitudeCmp);
