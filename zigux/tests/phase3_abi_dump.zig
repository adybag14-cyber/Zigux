...
pub fn main(init: std.process.Init) !void {
    ...
    try writer.print(
        "\"facility_kernel\":{d},\"facility_helpers\":{d},\"facility_drivers\":{d},\"status_flag_error\":{d},\"panic_abort\":{d},\"panic_bug\":{d},\"panic_warn\":{d},\"allocator_caller_provided\":{d},\"allocator_kernel_heap\":{d},\"allocator_arena\":{d},\"unsafe_scope_none\":{d},\"unsafe_scope_volatile_mmio\":{d},\"unsafe_scope_raw_pointer_bridge\":{d},\"chrdev_notify_ack_window_policy_budget_window_delivery_window_flag_delivery_applied\":{d},\"chrdev_notify_ack_window_policy_budget_window_delivery_window_status_skipped\":{d},\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_flag_budgex_applied\":{d},\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_window_flag_window_applied\":{d},\"chrdev_notify_ack_window_policy_budget_window_delivery_window_budget_window_status_skipped\":{d},\"notifier_done\":{d},\"notifier_ok\":{d},\"notifier_stop\":{d}",
        .{
            abi.FACILITY_KERNEL,
