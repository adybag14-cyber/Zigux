...
test "phase13 devres manifest records the current iomap/mmio safety surface and explicit blockers" {
    ...
    try std.testing.expectEqualStrings("10d0915b81c307b48c93c49f6e54ba43d8ad8704", manifest.surveyed_commit);
    try std.testing.expectEqual(@as(usize, 3), manifest.roadmap_destinations.len);
    try std.testing.expect(manifest.survey_summary.devres_c_lines >= 390);
    try std.testing.expectEqualStrings("b967ad6bc0f58c912232df1249217f0dbff9389f", manifest.survey_summary.previous_surveyed_commit);
    ...
    try expectContains(survey_note, "- `PHASE13_SURVEYED_COMMIT=10d0915b81c307b48c93c49f6e54ba43d8ad8704`");
    ...
    try expectContains(survey_note, "the current helper packet stays byte-for-byte unchanged");
