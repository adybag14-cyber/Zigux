...
test "phase3 list/hlist head alias lag replay keeps the live first node visible while the detached list alias stays off path" {
...
test "phase3 list/hlist head alias lag replay keeps the live first node visible while the detached hlist alias stays off path" {
