...
test "lane27 septenquinquagintuple replay keeps bitmap discovery stable across 57 empty banks" {
...
test "lane27 septenquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 septenquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
