...
test "phase 4 bitmap survey keeps the roadmap rollback gate and helper replay measurable" {
    ...
    try std.testing.expectEqualStrings("4a4c07b2a07585e0d14ddee70bbb82806baeb1f1", manifest.helper_replay_blob_sha);
    try std.testing.expectEqualStrings("62262fc0726f7a313c648490620dbee7f2899646", manifest.gate_evidence_blob_sha);
