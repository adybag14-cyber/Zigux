...
test "phase 4 bitmap survey keeps the roadmap rollback gate and helper replay measurable" {
    ...
    try std.testing.expectEqualStrings("3832b62978802753bf89d720a36d3f23a2b264b6", manifest.gate_evidence_blob_sha);
...
test "phase 4 bitmap survey keeps bitmap gate-evidence coverage explicit" {
    ...
    try expectContains(gate_evidence_source, "4641743358357118437");
    try expectContains(gate_evidence_source, "15640590978236698512");
