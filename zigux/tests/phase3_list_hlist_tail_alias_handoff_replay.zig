...
test "phase3 list/hlist tail alias handoff replay keeps the live list tail visible while the detached alias stays off path" {
...
test "phase3 list/hlist tail alias handoff replay reports the adopted list alias before head prev follows" {
    var head = list_view.ListHead{ .next = 0, .prev = 0 };
    var first = list_view.ListHead{ .next = 0, .prev = 0 };
    var middle = list_view.ListHead{ .next = 0, .prev = 0 };
    var tail = list_view.ListHead{ .next = 0, .prev = 0 };
...
test "phase3 list/hlist tail alias handoff replay keeps the live hlist tail visible while the detached alias stays off path" {
...
test "phase3 list/hlist tail alias handoff replay reports the adopted hlist alias before the tail backlink follows" {
    var head = hlist_view.HListHead{ .first = 0 };
    var first = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var middle = hlist_view.HListNode{ .next = 0, .pprev = 0 };
    var tail = hlist_view.HListNode{ .next = 0, .pprev = 0 };
