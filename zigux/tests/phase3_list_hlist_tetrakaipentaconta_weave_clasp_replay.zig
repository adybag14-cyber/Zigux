...
const staged_break_index = 34;
const route = [_]usize{
    53, 0,  28, 27, 52, 1,  29, 26, 51, 2,  30, 25, 50, 3,
    31, 24, 49, 4,  32, 23, 48, 5,  33, 22, 47, 6,  34, 21,
    46, 7,  35, 20, 45, 8,  36, 19, 44, 9,  37, 18, 43, 10,
    38, 17, 42, 11, 39, 16, 41, 12, 40, 15, 14, 13,
};
...
test "tetrakaipentaconta weave-clasp list route exposes staged backlink repair" {
...
test "tetrakaipentaconta weave-clasp hlist route exposes staged pprev repair" {
