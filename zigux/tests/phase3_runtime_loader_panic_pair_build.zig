...
pub fn build(b: *std.Build) void {
    ...
    panic_policy_tests.root_module.addImport("abi_bindings", abi_bindings);
    ...
    const pair_test_step = b.step(
        "phase3-runtime-loader-panic-pair-test",
        "Run the focused Phase 3 runtime-loader/panic-policy pair replay",
    );
    pair_test_step.dependOn(&run_panic_policy_tests.step);
