...
test "lane27 duoquinquagintuple replay keeps bitmap discovery stable across 52 empty banks" {
...
test "lane27 duoquinquagintuple replay keeps cpumask traversal aligned with bitmap traversal" {
    const words = replayWords();
...
test "lane27 duoquinquagintuple replay ignores tail-only noise in subset and overlap checks" {
