...
test "resolvePollExecutionResultFromWaitResult rejects inconsistent processing accounting summaries" {
    ...
    const impossible_processed_records_without_completion = PollExecutionSummary{
        .poll = .{
            .wait_class = .bounded,
            .outcome = .ready,
            .observed_ready_events = 2,
    ...
    try std.testing.expectError(
        PollError.InconsistentProcessingAccountingSummary,
        resolvePollExecutionResultFromWaitResult(2, impossible_processed_records_without_completion),
    );
    ...
    const impossible_ready_without_processing = PollExecutionSummary{
        .poll = .{
            .wait_class = .bounded,
            .outcome = .ready,
            .observed_ready_events = 2,
    ...
    try std.testing.expectError(
        PollError.InconsistentProcessingAccountingSummary,
        resolvePollExecutionResultFromWaitResult(2, impossible_ready_without_processing),
    );
