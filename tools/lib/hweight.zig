...
test "hweight helpers stay stable under width-preserving rotations" {
    const value8: u32 = 0b1010_0101;
    const rotated8 = ((value8 << 3) | (value8 >> 5)) & 0xff;
    ...
    const rotated16 = ((value16 << 5) | (value16 >> 11)) & 0xffff;
    ...
    const rotated32 = std.math.rotl(u32, value32, 9);
    ...
    const rotated64 = std.math.rotl(u64, value64, 17);
    ...
    const rotated_long = std.math.rotl(usize, value_long, 7);
