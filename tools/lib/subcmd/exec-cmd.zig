...
test "planDeferredExecvCall keeps PATH planning and deferred execv argv aligned" {
    const config = Config{
        .exec_name = "perf",
        .prefix = "/usr/libexec/perf-core",
        .exec_path = "libexec/perf-core",
...
test "planDeferredExeclCallWithPwd keeps logical PWD path choice and deferred execl argv aligned" {
    const config = Config{
        .exec_name = "perf",
        .prefix = "/usr/libexec/perf-core",
        .exec_path = "libexec/perf-core",
