...
test "phase1 helper ports A offset mirror replay" {
    ...
    var old = std.mem.zeroes([2]Word);
    var new = std.mem.zeroes([2]Word);
    var mask = std.mem.zeroes([2]Word);
    var replaced = std.mem.zeroes([2]Word);
    var mirror = std.mem.zeroes([2]Word);
    var gap = std.mem.zeroes([2]Word);
