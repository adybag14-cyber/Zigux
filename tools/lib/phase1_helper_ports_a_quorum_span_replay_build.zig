...
pub fn build(b: *std.Build) void {
    ...
    const root_module = b.createModule(.{
        .root_source_file = b.path("phase1_helper_ports_a_quorum_span_replay.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const replay_step = b.step("phase1-helper-ports-a-quorum-span-replay", "Run the Lane 06 quorum-span replay");
    replay_step.dependOn(&run_tests.step);

    const test_step = b.step("test", "Run the Lane 06 quorum-span replay");
