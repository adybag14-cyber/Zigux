...
pub fn build(b: *std.Build) void {
    ...
    const test_module = b.createModule(.{
        .root_source_file = b.path("list_sort_phase1_detour_queue_test.zig"),
        .target = b.graph.host,
        .optimize = optimize,
        .imports = &.{
    ...
    const test_step = b.step("list-sort-phase1-detour-queue-test", "Run the Lane 12 list_sort detour queue proof");
