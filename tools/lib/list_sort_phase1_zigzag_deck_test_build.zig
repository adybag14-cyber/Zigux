...
pub fn build(b: *std.Build) void {
    ...
    const unit_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("list_sort_phase1_zigzag_deck_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const test_step = b.step("list-sort-phase1-zigzag-deck-test", "Run the list_sort zigzag deck proof");
