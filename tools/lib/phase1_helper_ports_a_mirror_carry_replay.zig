...
test "phase1 helper ports A mirror carry replay" {
    ...
    var old = [_]Word{0} ** nwords;
    var new = [_]Word{0} ** nwords;
    var mask = [_]Word{0} ** nwords;
    var replaced = [_]Word{0} ** nwords;
    var copied = [_]Word{~@as(Word, 0)} ** nwords;
    var carry = [_]Word{0} ** nwords;
    var mirrored = [_]Word{0} ** nwords;
    var dropped_carry = [_]Word{0} ** nwords;
