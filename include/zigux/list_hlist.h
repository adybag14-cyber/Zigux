...
#define ZIGUX_LIST_HEAD_ALIGN ((uint32_t)_Alignof(uintptr_t))
...
#define ZIGUX_HLIST_HEAD_ALIGN ((uint32_t)_Alignof(uintptr_t))
#define ZIGUX_HLIST_HEAD_FIRST_OFFSET 0u

#define ZIGUX_HLIST_NODE_SIZE ((uint32_t)(2u * sizeof(uintptr_t)))
#define ZIGUX_HLIST_NODE_ALIGN ((uint32_t)_Alignof(uintptr_t))
