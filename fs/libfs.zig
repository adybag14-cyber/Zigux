...
pub const CursorClosePlan = struct {
    anchor: []const u8,
    returns_zero: bool,
...
pub const LibFsHelperLab = struct {
    ...
    pub fn dcacheDirClosePlan(has_private_cursor: bool) CursorClosePlan {
        return .{
            .anchor = descriptor().anchor,
            .returns_zero = true,
            .releases_private_cursor = has_private_cursor,
            .had_private_data = has_private_cursor,
        };
    }
