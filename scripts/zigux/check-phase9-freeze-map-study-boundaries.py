...
PATH_REQUIREMENTS = {
    FREEZE_MAP_PATH: [
        ...
        "`zigux/Makefile` explicit only as a readable non-owner surface whose live body now exposes bounded `phase9-runtime-atomic64-test`, `phase9-runtime-bitmap-test`, `phase9-runtime-loader-shared-test`, `phase9-runtime-trace-events-test`, `phase9-runtime-kretprobe-test`, and `phase9-test` routes",
    ],
