...
CURRENT_FIXTURE = {
    ...
    "shared_test_depend_steps": [
        ...
        "run_phase12_nvme_pci_direct_tests",
        "run_virtio_net_survey_tests",
    ],
    "module_root_source_files": [
        {"module": "virtio_net_queue_resume_module", "path": "../../drivers/net/virtio_net_queue_resume.zig"},
        {"module": "virtio_net_queue_resume_root_module", "path": "phase12_virtio_net_queue_resume.zig"},
        {"module": "virtio_net_transmit_recycle_module", "path": "../../drivers/net/virtio_net_transmit_recycle.zig"},
        {"module": "virtio_net_transmit_recycle_root_module", "path": "phase12_virtio_net_transmit_recycle.zig"},
        {"module": "virtio_net_receive_refill_replay_module", "path": "../../drivers/net/virtio_net_receive_refill_replay.zig"},
        {"module": "virtio_net_receive_refill_replay_root_module", "path": "phase12_virtio_net_receive_refill_replay.zig"},
        {"module": "virtio_net_post_reset_replay_module", "path": "../../drivers/net/virtio_net_post_reset_replay.zig"},
        {"module": "virtio_net_post_reset_replay_root_module", "path": "phase12_virtio_net_post_reset_replay.zig"},
        {"module": "virtio_net_throughput_parity_module", "path": "../../drivers/net/virtio_net_throughput_parity.zig"},
        {"module": "virtio_net_throughput_parity_root_module", "path": "phase12_virtio_net_throughput_parity.zig"},
        {"module": "nvme_pci_module", "path": "../../drivers/nvme/host/pci.zig"},
        {"module": "nvme_pci_root_module", "path": "phase12_nvme_pci.zig"},
        {"module": "virtio_net_survey_root_module", "path": "phase12_virtio_net_survey.zig"},
    ],
    "module_imports": [
        {"module": "virtio_net_queue_resume_root_module", "import_name": "virtio_net_queue_resume", "imported_module": "virtio_net_queue_resume_module"},
        {"module": "virtio_net_transmit_recycle_root_module", "import_name": "virtio_net_transmit_recycle", "imported_module": "virtio_net_transmit_recycle_module"},
        {"module": "virtio_net_receive_refill_replay_root_module", "import_name": "virtio_net_receive_refill_replay", "imported_module": "virtio_net_receive_refill_replay_module"},
        {"module": "virtio_net_post_reset_replay_root_module", "import_name": "virtio_net_post_reset_replay", "imported_module": "virtio_net_post_reset_replay_module"},
        {"module": "virtio_net_throughput_parity_root_module", "import_name": "virtio_net_throughput_parity", "imported_module": "virtio_net_throughput_parity_module"},
        {"module": "nvme_pci_root_module", "import_name": "nvme_pci", "imported_module": "nvme_pci_module"},
    ],
    "test_root_modules": [
        {"test": "phase12-virtio-net-queue-resume-tests", "root_module": "virtio_net_queue_resume_root_module"},
        {"test": "phase12-virtio-net-transmit-recycle-tests", "root_module": "virtio_net_transmit_recycle_root_module"},
        {"test": "phase12-virtio-net-receive-refill-replay-tests", "root_module": "virtio_net_receive_refill_replay_root_module"},
        {"test": "phase12-virtio-net-post-reset-replay-tests", "root_module": "virtio_net_post_reset_replay_root_module"},
        {"test": "phase12-virtio-net-throughput-parity-tests", "root_module": "virtio_net_throughput_parity_root_module"},
        {"test": "phase12-nvme-pci-direct-tests", "root_module": "nvme_pci_root_module"},
        {"test": "phase12-virtio-net-survey-tests", "root_module": "virtio_net_survey_root_module"},
    ],
}
