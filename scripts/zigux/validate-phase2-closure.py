...
def validate_genksyms_crc_checker_gate(checker_script: Path) -> list[str]:
    ...
    required_markers = {
        ...
        'missing_expected_fixture_guard': 'genksyms-crc:self-test:missing_expected_fixture',
        'missing_input_fixture_guard': 'genksyms-crc:self-test:missing_input_fixture',
...
def validate_fixdep_checker_gate(checker_script: Path) -> list[str]:
    ...
    required_markers = {
        ...
        'self_test_case_count_marker': "print('FIXDEP_SELF_TEST_CASE_COUNT=14')",
        'missing_expected_fixture_guard': 'expected:missing_fixture:',
        'missing_stdout_mode_guard': 'stdout_mode:unknown_mode:',
        'orphaned_expected_guard': 'cases.json:orphaned_expected:',
        'duplicate_expected_guard': 'expected:duplicate_reference:',
        'dependency_file_error_guard': 'dependency_file:',
        'c_error_contract': 'fixdep: parse error; no targets found',
