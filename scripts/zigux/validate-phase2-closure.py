...
def run_self_test() -> int:
    ...
    cases = [
        ...
        (
            'make_duplicate_phase2_genksyms_bridge_alignment_self_test',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py --self-test'
            ),
            ['make_exact_run:scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py --self-test:count=2:expected=1'],
        ),
        (
            'make_duplicate_phase2_genksyms_bridge_alignment_gate',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py'
            ),
            ['make_exact_run:scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py:count=2:expected=1'],
        ),
        (
        ...
        (
            ...
            ['make_exact_run:scripts/zigux/check-phase2-toolchain-pin-scope.py --self-test:count=2:expected=1'],
        ),
        (
            'make_duplicate_toolchain_pin_scope_gate',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-phase2-toolchain-pin-scope.py'
            ),
            ['make_exact_run:scripts/zigux/check-phase2-toolchain-pin-scope.py:count=2:expected=1'],
        ),
        (
            'make_duplicate_kconfig_alignment_self_test',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-phase2-kconfig-selftest-alignment.py --self-test'
            ),
            ['make_exact_run:scripts/zigux/check-phase2-kconfig-selftest-alignment.py --self-test:count=2:expected=1'],
        ),
        (
            'make_duplicate_kconfig_alignment_gate',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-phase2-kconfig-selftest-alignment.py'
            ),
        ...
        (
            'make_duplicate_mk_elfconfig_gate',
            validate_exact_makefile_runs(
                make_ok
                + '\ncd $(ZIGUX_ROOT) && $(PYTHON) scripts/zigux/check-mk-elfconfig-diff.py'
            ),
            ['make_exact_run:scripts/zigux/check-mk-elfconfig-diff.py:count=2:expected=1'],
        ),
        (
        ...
        (
            'workflow_duplicate_phase2_genksyms_bridge_alignment_self_test',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py --self-test\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py --self-test:count=2:expected=1'],
        ),
        (
            'workflow_duplicate_phase2_genksyms_bridge_alignment_gate',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-phase2-genksyms-bridge-selftest-alignment.py:count=2:expected=1'],
        ),
        (
        ...
        (
            'workflow_duplicate_kconfig_alignment_self_test',
            validate_exact_workflow_runs(
                workflow_ok
                + 'run: python3 scripts/zigux/check-phase2-kconfig-selftest-alignment.py --self-test\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-phase2-kconfig-selftest-alignment.py --self-test:count=2:expected=1'],
        ),
        (
            'workflow_duplicate_kconfig_alignment_gate',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-phase2-kconfig-selftest-alignment.py\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-phase2-kconfig-selftest-alignment.py:count=2:expected=1'],
        ),
        (
            'workflow_duplicate_kconfig_bridge_self_test',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-kconfig-bridge.py --self-test\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-kconfig-bridge.py --self-test:count=2:expected=1'],
        ),
        (
            'workflow_duplicate_kconfig_bridge_gate',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-kconfig-bridge.py\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-kconfig-bridge.py:count=2:expected=1'],
        ),
        (
            'workflow_duplicate_mk_elfconfig_gate',
            validate_exact_workflow_runs(
                workflow_ok + 'run: python3 scripts/zigux/check-mk-elfconfig-diff.py\n'
            ),
            ['workflow_exact_run:python3 scripts/zigux/check-mk-elfconfig-diff.py:count=2:expected=1'],
        ),
        (
...
def validate_exact_makefile_runs(text: str) -> list[str]:
    ...
    for expected_line, expected_count in PHASE2_MAKEFILE_EXACT_LINES.items():
        ...
        if count != expected_count:
            issues.append(
                f'make_exact_line:{expected_line}:count={count}:expected={expected_count}'
            )
    return issues
