...
def build_self_test_root(root: Path) -> None:
    ...
    readme_lines = ["# scripts/zigux", "", "## Phase 2", "", "- current packet", *README_PRESENT_MARKERS, *README_WARNING_MARKERS]
    write_text(resolve_path(root, SCRIPTS_README), "\n".join(readme_lines) + "\n")
    bootstrap_lines = ["# Phase 2 Toolchain Bootstrap Notes", "", "## Current direct packet", "", *BOOTSTRAP_PRESENT_MARKERS, "", "## Current repo-reality gaps", "", *BOOTSTRAP_WARNING_MARKERS]
