...
def run_self_test() -> int:
    ...
    try:
        ...
        mutations = (
            ...
            (NOTE_PATH, "does not claim that live `hvc_cleanup()` execution is replayed on current"),
            ...
            (DRIVER_PATH, "final_close_only,"),
            (DRIVER_PATH, "hangup_only,"),
            (DRIVER_PATH, "final_close_and_hangup,"),
            ...
            (PROOF_PATH, "cleanup prerequisite hangup-only trigger reviewable"),
            (PROOF_PATH, "cleanup prerequisite combined trigger reviewable"),
            (PROOF_PATH, "rejects cleanup without final-close or hangup evidence"),
            (SELF_PATH, "PHASE11_HVC_CLEANUP_PREREQUISITE_PACKET=pass"),
            (SELF_PATH, "PHASE11_HVC_CLEANUP_PREREQUISITE_PACKET_SELF_TEST=pass"),
        )
