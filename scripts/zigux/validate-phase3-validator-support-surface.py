...
REQUIRED_SHARED_GAP_MARKERS = (
    "PHASE3_SHARED_REMINDER_GAP=current master now keeps the docs-root and tests-root Phase 3 summaries aligned with the landed notifier binding companion, bounded kernel-export-shim note, focused export/UAPI layout replay, and low-level-wrapper reminder packet, while scripts-root inventory follow-through remains a separate reminder surface",
...
SELF_TEST_CASES = (
    ...
    ("gap", "PHASE3_SHARED_REMINDER_GAP=current master now keeps the docs-root and tests-root Phase 3 summaries aligned with the landed notifier binding companion, bounded kernel-export-shim note, focused export/UAPI layout replay, and low-level-wrapper reminder packet, while scripts-root inventory follow-through remains a separate reminder surface", f"missing {SHARED_REMINDER_GAP_PATH.as_posix()} marker: PHASE3_SHARED_REMINDER_GAP=current master now keeps the docs-root and tests-root Phase 3 summaries aligned with the landed notifier binding companion, bounded kernel-export-shim note, focused export/UAPI layout replay, and low-level-wrapper reminder packet, while scripts-root inventory follow-through remains a separate reminder surface"),
