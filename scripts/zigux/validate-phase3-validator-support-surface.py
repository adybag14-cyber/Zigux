...
REQUIRED_NOTE_MARKERS = (
    ...
    "records the partially aligned docs-root, tests-root, and scripts-root summaries together with the remaining shared-summary drift while keeping any later scripts-root inventory follow-through separate",
