...
# Keep the manifest-backed starter companion trio explicit in the shared
# validator-support packet instead of trusting the broader note alone.
...
def run_self_test() -> int:
    ...
    if validate_boundary_note_text(boundary_sample):
        ...
        return 1
    checks = [
        ("## Current packet", "## Review boundary", "Documentation/zigux/phase3-kernel-export-shim-governance.md", "expected current-packet kernel-export governance drift was not reported"),
        ("## Current packet", "## Review boundary", "Documentation/zigux/phase3-abi-bindings-survey.md", "expected current-packet bindings-survey drift was not reported"),
        ...
        ("## Current packet", "## Review boundary", "Documentation/zigux/phase3-abi-header-family-survey.md", "expected current-packet header-family survey drift was not reported"),
        ("## Current packet", "## Review boundary", "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "expected current-packet paired next-step drift was not reported"),
        ...
        ("## Current packet", "## Review boundary", "zigux/tests/phase3_low_level_wrappers.zig", "expected current-packet low-level-wrapper replay drift was not reported"),
        ...
        ("## Current packet", "## Review boundary", "make -C zigux phase3-low-level-wrappers-test", "expected current-packet low-level-wrapper make route drift was not reported"),
        ("## Review boundary", "## Non-goals", "Documentation/zigux/phase3-validator-support-surface.md", "expected review-boundary self-note drift was not reported"),
        ("## Review boundary", "## Non-goals", "scripts/zigux/validate-phase3-validator-support-surface.py", "expected review-boundary self-validator drift was not reported"),
        ("## Review boundary", "## Non-goals", "scripts/zigux/validate-phase3-linux-zigux-header-governance.py", "expected review-boundary header-governance validator drift was not reported"),
        ...
        ("## Review boundary", "## Non-goals", "Documentation/zigux/phase3-bindings-governance.md", "expected review-boundary bindings-governance drift was not reported"),
        ("## Review boundary", "## Non-goals", "Documentation/zigux/phase3-kernel-export-shim-governance.md", "expected review-boundary kernel-export governance drift was not reported"),
        ("## Review boundary", "## Non-goals", "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "expected review-boundary paired next-step drift was not reported"),
        ("## Review boundary", "## Non-goals", "closed together when either note drifts", "expected review-boundary paired-drift wording was not reported"),
        ("## Shared reminder", None, "scripts/zigux/validate_phase3_selftest.py", "expected shared-reminder selftest driver drift was not reported"),
        ("## Shared reminder", None, "scripts/zigux/check-phase3-abi.py", "expected shared-reminder focused ABI gate drift was not reported"),
        ("## Shared reminder", None, "scripts/zigux/validate-phase3-validator-support-surface.py", "expected shared-reminder self-validator drift was not reported"),
        ...
        ("## Shared reminder", None, "Documentation/zigux/phase3-abi-bindings-survey.md", "expected shared-reminder bindings-survey drift was not reported"),
        ...
        ("## Shared reminder", None, "Documentation/zigux/phase3-abi-header-family-survey.md", "expected shared-reminder header-family survey drift was not reported"),
        ("## Shared reminder", None, "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "expected shared-reminder paired next-step drift was not reported"),
        ("## Shared reminder", None, "Documentation/zigux/review-checklist.md", "expected shared-reminder review-checklist drift was not reported"),
        ("## Shared reminder", None, "Documentation/zigux/phase3-policy-unsafe-boundary-survey.md", "expected shared-reminder policy survey drift was not reported"),
        ("## Shared reminder", None, "scripts/zigux/validate-phase3-policy-unsafe-survey.py", "expected shared-reminder policy validator drift was not reported"),
        ...
        ("## Shared reminder", None, "scripts/zigux/check-phase3-policy-unsafe-focused-replay.py", "expected shared-reminder focused policy replay drift was not reported"),
        ("## Shared reminder", None, "scripts/zigux/check-phase3-policy-unsafe-mmio-consumer.py", "expected shared-reminder mmio consumer drift was not reported"),
        ...
        ("## Shared reminder", None, "zigux/tests/phase3_low_level_wrappers_build.zig", "expected shared-reminder low-level-wrapper build anchor drift was not reported"),
        ("## Shared reminder", None, "include/zigux/dev_t.h", "expected shared-reminder dev_t header drift was not reported"),
        ("## Shared reminder", None, "zigux/uapi/version.zig", "expected shared-reminder version companion drift was not reported"),
        ("## Shared reminder", None, "zigux/uapi/dev_t.zig", "expected shared-reminder dev_t starter companion drift was not reported"),
        ("## Shared reminder", None, "zigux/bindings/abi.zig", "expected shared-reminder abi binding drift was not reported"),
        ...
        ("## Shared reminder", None, "make -C zigux phase3-selftest", "expected shared-reminder selftest make route drift was not reported"),
