    ...
    with tempfile.TemporaryDirectory(prefix="zigux_phase3_catalog_selftest_") as temp_dir:
        ...
        required_cases = (
            ...
            (
                CATALOG_PATH,
                'Path("scripts/zigux/generate-phase3-check-wrappers.py")',
                'missing scripts/zigux/phase3_catalog.py marker: Path("scripts/zigux/generate-phase3-check-wrappers.py")',
                "expected missing wrapper generator catalog marker was not reported",
            ),
            (
                CATALOG_PATH,
                '"python3 scripts/zigux/check-phase3-wrapper-templates.py --self-test"',
