...
def run_self_test() -> int:
    marker_cases = (
        ...
        (
            CATALOG_PATH,
            'Path("Documentation/zigux/phase3-policy-unsafe-boundary-survey.md")',
            "expected missing catalog policy-unsafe survey marker was not reported",
        ),
        (
            CATALOG_PATH,
            'Path("Documentation/zigux/phase3-validator-support-surface.md")',
        ...
        (
            CATALOG_PATH,
            'Path("scripts/zigux/check-phase3-policy-dump.py")',
            "expected missing catalog policy-dump checker marker was not reported",
        ),
        (
            CATALOG_PATH,
            'Path("zigux/tests/phase3_policy_dump.zig")',
            "expected missing catalog policy-dump replay marker was not reported",
        ),
        (
            CATALOG_PATH,
            'Path("zigux/tests/phase3_policy_dump_build.zig")',
            "expected missing catalog policy-dump build marker was not reported",
        ),
        (
            CATALOG_PATH,
            'Path("zigux/tests/fixtures/phase3_policy_dump_expected.txt")',
            "expected missing catalog policy-dump expected-output marker was not reported",
        ),
        (
            CATALOG_PATH,
            'Path("zigux/tests/phase3_export_shim_build.zig")',
        ...
        (
            CATALOG_PATH,
            '"python3 scripts/zigux/check-phase3-policy-dump.py --self-test"',
            "expected missing catalog policy-dump selftest route marker was not reported",
        ),
        (
            CATALOG_PATH,
            '"python3 scripts/zigux/check-phase3-policy-dump.py"',
        ...
        (
            CATALOG_PATH,
            '"python3 scripts/zigux/validate-phase3-policy-unsafe-survey.py --self-test"',
            "expected missing catalog policy-unsafe selftest route marker was not reported",
        ),
        (
            CATALOG_PATH,
            '"python3 scripts/zigux/validate-phase3-policy-unsafe-survey.py"',
            "expected missing catalog policy-unsafe route marker was not reported",
        ),
        (
            CATALOG_PATH,
            '"python3 scripts/zigux/validate_phase3_selftest.py"',
