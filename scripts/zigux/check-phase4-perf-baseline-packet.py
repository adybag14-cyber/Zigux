...
NOTE_MARKERS = (
    ...
    "The direct checker pair now publishes `PHASE4_REPO_REALITY_WARNING_SELF_TEST_CASES=22` and `PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=19` here",
)
...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="phase4-perf-baseline-packet-") as tmp_dir:
        ...
        variants = (
            ...
            (NOTE, "PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=19", "PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=8", "note_marker:The direct checker pair now publishes `PHASE4_REPO_REALITY_WARNING_SELF_TEST_CASES=22` and `PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=19` here"),
            (NOTE, "Current direct-readback dedicated local-only perf companion members:\n  * `zigux/tests/phase4_perf_baseline_manifest.json`\n  * `zigux/tests/phase4_perf_baseline_survey.zig`", "Current direct-readback dedicated local-only perf companion members:\n  * `zigux/tests/phase4_perf_baseline_manifest.json`\n  * `zigux/tests/phase4_perf_baseline_survey_drift.zig`", "note_marker:  * `zigux/tests/phase4_perf_baseline_survey.zig`"),
            ...
            (MANIFEST, '"shared_ci_perf_promotion_status": "pending"', '"shared_ci_perf_promotion_status": "approved"', "manifest_json:shared_ci_perf_promotion_status:"),
        )
