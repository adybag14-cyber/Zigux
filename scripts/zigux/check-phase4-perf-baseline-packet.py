...
NOTE_MARKERS = (
    ...
    "The direct checker pair now publishes `PHASE4_REPO_REALITY_WARNING_SELF_TEST_CASES=32` and `PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=19` here",
)
...
def expect_json_value(
    payload: object, path: tuple[str | int, ...], expected: object, missing: list[str]
) -> None:
    current = payload
    for step in path:
        try:
...
def validate_manifest_json(manifest_data: dict[str, object], missing: list[str]) -> None:
    expected_values = (
        ...
        (
            ("dedicated_linux_style_survey_wrapper",),
        ...
        (
            ("shared_lab_and_ci_matrix_anchor",),
        ...
        (
            ("gate_surfaces", 0, "threshold_posture"),
        ...
        (
            ("gate_surfaces", 1, "threshold_posture"),
    ...
    with tempfile.TemporaryDirectory(prefix="phase4-perf-baseline-packet-") as tmp_dir:
        ...
        variants = (
            ...
            (
                ...
                "note_marker:The direct checker pair now publishes `PHASE4_REPO_REALITY_WARNING_SELF_TEST_CASES=32` and `PHASE4_REVERSIBLE_DELIVERY_PIN_SELF_TEST_CASE_COUNT=19` here",
            ),
            (
                NOTE,
                "Current direct-readback dedicated local-only perf companion members:\n  * `zigux/tests/phase4_perf_baseline_manifest.json`\n  * `zigux/tests/phase4_perf_baseline_survey.zig`",
