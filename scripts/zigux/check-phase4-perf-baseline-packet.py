...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="phase4-perf-baseline-packet-") as tmp_dir:
        ...
        survey_variants = (
            ...
            ('try requireMarker("\\"local_only_posture_note\\": \\\"The dedicated perf-baseline survey keeps approved local benchmark commands and approved local-only acceptable limits explicit while shared CI perf promotion remains intentionally pending.\\\"");', 'try requireMarker("\\"local_only_posture_note\\": \\\"The dedicated perf-baseline survey now treats shared CI perf promotion as complete.\\\"");', 'survey_marker:try requireMarker("\\"local_only_posture_note\\": \\\"The dedicated perf-baseline survey keeps approved local benchmark commands and approved local-only acceptable limits explicit while shared CI perf promotion remains intentionally pending.\\\"");'),
            ...
            ('try requireMarker("\\"coordination_owners\\": [");', 'try requireMarker("\\"coordination_owner\\": [");', 'survey_marker:try requireMarker("\\"coordination_owners\\": [");'),
        )
