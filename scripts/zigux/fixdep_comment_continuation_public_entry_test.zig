...
test "fixdep replays the shipped comment-continuation fixture on the public entry path" {
    ...
    const expected_stdout_path = "../../zigux/tests/fixtures/fixdep/sample_comment_continuation_expected.txt";
