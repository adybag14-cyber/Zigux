...
REQUIRED_SNIPPETS = {
    ...
    "Documentation/zigux/phase6-checksum-slice.md": [
        ...
        "- a direct 30-case C-vs-Zig replay for compute, seeded partial, composition, pseudo-header, and incremental replacement behavior",
