...
const contracts = [_]FileContract{
    ...
    .{ .rel = "zigux/tests/phase3_list_hlist_dump.zig", .markers = &markers_5 },
    .{ .rel = "zigux/tests/phase3_list_hlist_dump_build.zig", .markers = &markers_6 },
    .{ .rel = "zigux/Makefile", .markers = &markers_7 },
    .{ .rel = "zigux/tests/fixtures/phase3_list_hlist/phase3_list_hlist_c_harness.c", .markers = &markers_8 },
    .{ .rel = "zigux/tests/fixtures/phase3_list_hlist/expected.json", .markers = &markers_9 },
    .{ .rel = "zigux/tests/fixtures/phase3_list_hlist_manifest.json", .markers = &markers_10 },
};
