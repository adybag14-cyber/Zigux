...
REQUIRED_MARKERS = {
    ...
    "Documentation/zigux/phase10-closure-evidence.md": [
        ...
        "directly re-readable shared checker-backed reminder anchors also now include `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, `.github/workflows/zigux-bootstrap.yml`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-input-packet.py`, `scripts/zigux/check-phase10-mmio-packet.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, and `scripts/zigux/check-phase10-closure-manifest-counts.py`",
        ...
        "scripts/zigux/check-phase10-tests-readme-core-surfaces.py",
        "`zigux/Makefile`",
        "The current ring lane therefore stays reviewable here through `Documentation/zigux/phase10-virtio-ring-survey.md`, `Documentation/zigux/phase10-virtio-ring-slice.md`, `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring.zig`, and `scripts/zigux/check-phase10-ring-packet.py`, while direct current-`master` contents reads now also rematerialize `zigux/tests/phase10_virtio_ring.zig` and `zigux/tests/phase10_virtio_ring_registration_replay.zig` beside the already-returned notification-data and survey replays, so keep that broader ring replay packet explicit here instead of treating it as fallback-only evidence.",
    ],
    "Documentation/zigux/phase10-virtio-driver-lane-sequencing.md": [
        "scripts/zigux/check-phase10-harness-coverage.py",
        "scripts/zigux/check-phase10-tests-readme-core-surfaces.py",
        "- shared reminder lane owns the shared packet truthfulness surfaces only: `Documentation/zigux/phase10-closure-evidence.md`, `Documentation/zigux/phase10-virtio-driver-lane-sequencing.md`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, `scripts/zigux/check-phase10-closure-manifest-counts.py`, and the shared Phase 10 wording in the docs root, review checklist, and tests root, with `scripts/zigux/README.md` aligned as the current dedicated Phase 10 scripts-root packet on current `master`",
        "drivers/virtio/virtio_input_queue_callback_preflight.zig",
        "zigux/tests/phase10_virtio_input_queue_callback_preflight.zig",
...
SELF_TEST_MUTATIONS = [
    ...
    (
        "Documentation/zigux/phase10-closure-evidence.md",
        "directly re-readable shared checker-backed reminder anchors also now include `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, `.github/workflows/zigux-bootstrap.yml`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-input-packet.py`, `scripts/zigux/check-phase10-mmio-packet.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, and `scripts/zigux/check-phase10-closure-manifest-counts.py`",
        "directly re-readable shared checker-backed reminder anchors also now include `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, `.github/workflows/zigux-bootstrap.yml`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-input-packet.py`, `scripts/zigux/check-phase10-mmio-packet.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, and `scripts/zigux/check-phase10-closure-manifest-counts-missing.py`",
        "Documentation/zigux/phase10-closure-evidence.md:directly re-readable shared checker-backed reminder anchors also now include `Documentation/zigux/README.md`, `Documentation/zigux/review-checklist.md`, `zigux/tests/README.md`, `.github/workflows/zigux-bootstrap.yml`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-input-packet.py`, `scripts/zigux/check-phase10-mmio-packet.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, and `scripts/zigux/check-phase10-closure-manifest-counts.py`",
    ),
    (
        "Documentation/zigux/phase10-closure-evidence.md",
    ...
    (
        "Documentation/zigux/phase10-closure-evidence.md",
        "The current ring lane therefore stays reviewable here through `Documentation/zigux/phase10-virtio-ring-survey.md`, `Documentation/zigux/phase10-virtio-ring-slice.md`, `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring.zig`, and `scripts/zigux/check-phase10-ring-packet.py`, while direct current-`master` contents reads now also rematerialize `zigux/tests/phase10_virtio_ring.zig` and `zigux/tests/phase10_virtio_ring_registration_replay.zig` beside the already-returned notification-data and survey replays, so keep that broader ring replay packet explicit here instead of treating it as fallback-only evidence.",
        "The current ring lane therefore stays reviewable here through `Documentation/zigux/phase10-virtio-ring-survey.md`, `Documentation/zigux/phase10-virtio-ring-slice.md`, `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring.zig`, and `scripts/zigux/check-phase10-ring-packet.py`, while direct current-`master` contents reads now also rematerialize `zigux/tests/phase10_virtio_ring.zig` and `zigux/tests/phase10_virtio_ring_registration_replay_missing.zig` beside the already-returned notification-data and survey replays, so keep that broader ring replay packet explicit here instead of treating it as fallback-only evidence.",
        "Documentation/zigux/phase10-closure-evidence.md:The current ring lane therefore stays reviewable here through `Documentation/zigux/phase10-virtio-ring-survey.md`, `Documentation/zigux/phase10-virtio-ring-slice.md`, `Documentation/zigux/phase10-virtio-ring-freeze-boundary-survey.md`, `zigux/tests/phase10_virtio_ring_manifest.json`, `zigux/tests/phase10_virtio_ring_survey.zig`, `drivers/virtio/virtio_ring.zig`, and `scripts/zigux/check-phase10-ring-packet.py`, while direct current-`master` contents reads now also rematerialize `zigux/tests/phase10_virtio_ring.zig` and `zigux/tests/phase10_virtio_ring_registration_replay.zig` beside the already-returned notification-data and survey replays, so keep that broader ring replay packet explicit here instead of treating it as fallback-only evidence.",
    ),
    (
        "Documentation/zigux/phase10-virtio-driver-lane-sequencing.md",
        "- shared reminder lane owns the shared packet truthfulness surfaces only: `Documentation/zigux/phase10-closure-evidence.md`, `Documentation/zigux/phase10-virtio-driver-lane-sequencing.md`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, `scripts/zigux/check-phase10-closure-manifest-counts.py`, and the shared Phase 10 wording in the docs root, review checklist, and tests root, with `scripts/zigux/README.md` aligned as the current dedicated Phase 10 scripts-root packet on current `master`",
        "- shared reminder lane owns the shared packet truthfulness surfaces only: `Documentation/zigux/phase10-closure-evidence.md`, `Documentation/zigux/phase10-virtio-driver-lane-sequencing.md`, `scripts/zigux/check-phase10-bootstrap-route.py`, `scripts/zigux/check-phase10-shared-freeze-boundary.py`, `scripts/zigux/check-phase10-harness-coverage.py`, `scripts/zigux/check-phase10-tests-readme-core-surfaces.py`, `scripts/zigux/check-phase10-closure-manifest-counts-missing.py`, and the shared Phase 10 wording in the docs root, review checklist, and tests root, with `scripts/zigux/README.md` aligned as the current dedicated Phase 10 scripts-root packet on current `master`",
