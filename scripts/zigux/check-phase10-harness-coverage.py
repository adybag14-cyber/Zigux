...
SELF_TEST_MUTATIONS = [
    ...
    (
        "Documentation/zigux/phase10-closure-evidence.md",
        "The returned input packet also keeps the dedicated helper shards explicit through `drivers/virtio/virtio_input_probe_preflight.zig`, `drivers/virtio/virtio_input_queue_callback_preflight.zig`, `drivers/virtio/virtio_input_registration_preflight.zig`, `drivers/virtio/virtio_input_status_drain.zig`, `drivers/virtio/virtio_input_teardown_preflight.zig`, and `drivers/virtio/virtio_input_teardown_observation.zig`, so the shared closure note names the same helper-local input packet that the current survey and tests-root reminder already expose instead of collapsing that evidence into replay-only wording.",
        "The returned input packet also keeps the dedicated helper shards explicit through `drivers/virtio/virtio_input_probe_preflight.zig`, `drivers/virtio/virtio_input_queue_callback_preflight.zig`, `drivers/virtio/virtio_input_registration_preflight.zig`, `drivers/virtio/virtio_input_status_drain.zig`, `drivers/virtio/virtio_input_teardown_preflight_missing.zig`, and `drivers/virtio/virtio_input_teardown_observation.zig`, so the shared closure note names the same helper-local input packet that the current survey and tests-root reminder already expose instead of collapsing that evidence into replay-only wording.",
        "Documentation/zigux/phase10-closure-evidence.md:The returned input packet also keeps the dedicated helper shards explicit through `drivers/virtio/virtio_input_probe_preflight.zig`, `drivers/virtio/virtio_input_queue_callback_preflight.zig`, `drivers/virtio/virtio_input_registration_preflight.zig`, `drivers/virtio/virtio_input_status_drain.zig`, `drivers/virtio/virtio_input_teardown_preflight.zig`, and `drivers/virtio/virtio_input_teardown_observation.zig`, so the shared closure note names the same helper-local input packet that the current survey and tests-root reminder already expose instead of collapsing that evidence into replay-only wording.",
    ),
    (
        "Documentation/zigux/phase10-closure-evidence.md",
