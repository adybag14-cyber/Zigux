...
REQUIRED_MARKERS = {
    ...
    "review_checklist": [
        ...
        "`zig build test --build-file zigux/tests/phase11_build.zig --summary all`",
        "`make -C zigux phase11-contract`",
        "surviving DesignWare continuity packet through `Documentation/zigux/phase11-dw-wdt-platform-registration-plan.md`, `drivers/watchdog/dw_wdt.zig`, `drivers/watchdog/dw_wdt_verify.zig`, and `zigux/tests/phase11_dw_wdt_registration_scaffold.zig`",
        "shared header-boundary survey through `Documentation/zigux/phase11-uapi-header-parity-survey.md` and `zigux/tests/phase11_uapi_header_parity_survey.zig`",
