...
test "genksyms bridge keeps repeated version side effects before invalid short option" {
...
test "genksyms bridge keeps repeated version side effects before ambiguous long option" {
    const args = [_][]const u8{
        "-V",
        "--version",
        "--d",
