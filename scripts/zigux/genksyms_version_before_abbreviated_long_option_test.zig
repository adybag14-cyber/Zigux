...
test "genksyms preserves abbreviated long version side effect before abbreviated long matches" {
...
test "genksyms preserves abbreviated long version side effect before abbreviated long arguments" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
