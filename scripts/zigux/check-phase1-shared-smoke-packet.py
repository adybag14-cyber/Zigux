...
WORKFLOW_PACKET_STEPS = (
    (
        "Self-test current Phase 1 shared smoke packet checker",
        "python3 scripts/zigux/check-phase1-shared-smoke-packet.py --self-test",
    ),
    (
        "Check current Phase 1 shared smoke packet",
        "python3 scripts/zigux/check-phase1-shared-smoke-packet.py",
    ),
    (
