...
REFRESHED_BOOTSTRAP_HELPERS_SNIPPET = (
    " - `check-phase2-kconfig-readme-alignment.py` - `check-phase2-tests-readme-alignment.py` - `validate-phase2.py` - `validate-phase2-closure.py` - `check-phase2-toolchain-pin-scope.py` - `validate-phase3.py`"
)
