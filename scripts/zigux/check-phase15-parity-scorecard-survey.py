...
def collect_failures(root: Path) -> list[str]:
    ...
    for label, value in EXPECTED_METRICS:
        ...
        explicit_keys = {
            "active_freeze_in_c_anchor_count": "active_freeze_in_c_anchor_count",
            "blocked_status_change_anchor_count": "blocked_status_change_anchor_count",
            "anchors_blocked_entirely_within_phase_15_governance_evidence": "phase15_governance_only_blocker_anchor_count",
            "phase_14_coupled_blocker_anchor_count": "phase14_coupled_blocker_anchor_count",
            "anchors_still_blocked_on_prior_phase_bridge_evidence": "anchors_still_blocked_on_prior_phase_bridge_evidence",
            "study_only_anchors_tracked_outside_the_scorecard": "study_only_anchors_tracked_outside_scorecard",
            "architecture_council_approvals_recorded_for_status_change": "architecture_council_status_change_approval_count",
        }
        manifest_key = explicit_keys[key]
    ...
    with tempfile.TemporaryDirectory(prefix="zigux_phase15_parity_scorecard_survey_") as tmp_dir:
        ...
        _write(
            ...
            _sample_survey().replace(
                "current-master-readback-2026-05-18", "current-master-readback-2026-05-17", 1
            ),
        )
