...
test "lane19 multi-megabyte exact-buffer split preserves visible CR-led bytes, truncates at NUL, and trims trailing carriage returns without inventing a tail record" {
    ...
    var input = try std.ArrayList(u8).initCapacity(
        ...
        skipped_record_count * skipped_record_len + c_line_payload_len + 7,
    );
