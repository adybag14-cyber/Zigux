...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "kernel replay, allocator/init-flow shard, direct contract replay, "
            "command/environment boundary guard shard, substrate-drift shard, "
            "shared aggregate step, and first-loadable parity-survey route explicit "
            "on current master."
        )
    )
