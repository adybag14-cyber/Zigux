...
const EXPECTED_REPLAY_ROUTES = [_][]const u8{
    ...
    "zig run check_phase3_abi_support_packet.zig --self-test",
    "zig run check_phase3_abi_support_packet.zig",
    ...
    "zig run check_phase3_catalog_selftest.zig --self-test",
    "zig run check_phase3_catalog_selftest.zig",
    "zig run validate_phase3.zig --self-test",
    "zig run validate_phase3.zig",
    "zig run validate_phase3_validator_support_surface.zig --self-test",
    "zig run validate_phase3_validator_support_surface.zig",
    "zig run validate_phase3_export_uapi_survey.zig --self-test",
    "zig run validate_phase3_export_uapi_survey.zig",
    "zig run validate_phase3_abi_header_family_survey.zig --self-test",
    "zig run validate_phase3_abi_header_family_survey.zig",
    "zig run validate_phase3_policy_unsafe_survey.zig --self-test",
    "zig run validate_phase3_policy_unsafe_survey.zig",
    "zig run validate_phase3_low_level_wrapper_survey.zig --self-test",
    "zig run validate_phase3_low_level_wrapper_survey.zig",
    "zig run check_phase3_low_level_wrappers.zig --self-test",
    "zig run check_phase3_low_level_wrappers.zig",
    ...
    "zig run check_phase3_xarray_slot.zig",
    "zig run check_phase3_export_uapi_c_header_smoke.zig --self-test",
    "zig run check_phase3_export_uapi_c_header_smoke.zig",
