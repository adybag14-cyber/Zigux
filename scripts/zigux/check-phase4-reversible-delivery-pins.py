...
EXPECTED_CURRENT_HEAD_SHA_LINES = (
    ...
    "  * `PHASE4_REVERSIBLE_DELIVERY_PIN_CHECKER_BLOB_SHA=f0c5da9f7920e23df0a40f2df3c1e8e63abc8f13`",
    "  * `PHASE4_REVERSIBLE_DELIVERY_REVIEW_CHECKLIST_BLOB_SHA=829972689722368cae2f2a5fd421fbb6da3be0d8`",
    "  * `PHASE4_REVERSIBLE_DELIVERY_TESTS_README_BLOB_SHA=ff293e2534d1345ac97fa6a2d3aa224349970b15`",
    ...
    "  * `PHASE4_REVERSIBLE_DELIVERY_LAST_KNOWN_MAKEFILE_BLOB_SHA=fc959aef4b752a51577cff383b0e7a61bd78df93`",
    "  * `PHASE4_REVERSIBLE_DELIVERY_LAST_KNOWN_WORKFLOW_BLOB_SHA=33a9e854082f27051f6bdd86f54dd5cf53fdf70f`",
...
def run_self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="phase4-reversible-delivery-pins-") as tmp:
        ...
        mutations = (
            ...
            (NOTE, EXPECTED_CURRENT_HEAD_SHA_LINES[2], "  * `PHASE4_REVERSIBLE_DELIVERY_REVIEW_CHECKLIST_BLOB_SHA=bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb`"),
            (NOTE, EXPECTED_CURRENT_HEAD_SHA_LINES[3], "  * `PHASE4_REVERSIBLE_DELIVERY_TESTS_README_BLOB_SHA=cccccccccccccccccccccccccccccccccccccccc`"),
            (NOTE, EXPECTED_CURRENT_HEAD_SHA_LINES[8], "  * `PHASE4_REVERSIBLE_DELIVERY_LAST_KNOWN_MAKEFILE_BLOB_SHA=dddddddddddddddddddddddddddddddddddddddd`"),
            (NOTE, EXPECTED_CURRENT_HEAD_SHA_LINES[9], "  * `PHASE4_REVERSIBLE_DELIVERY_LAST_KNOWN_WORKFLOW_BLOB_SHA=eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee`"),
            (NOTE, EXPECTED_CURRENT_HEAD_SHA_LINES[10], "  * `PHASE4_REVERSIBLE_DELIVERY_LAST_KNOWN_LOCAL_PERF_CHECKER_BLOB_SHA=ffffffffffffffffffffffffffffffffffffffff`"),
