...
BPF_TYPE_NAMES_SLICE_PATH = "Documentation/zigux/phase8-bpf-type-names-slice.md"
FILE_PATH_HANDLE_BRIDGE_SLICE_PATH = "Documentation/zigux/phase8-file-path-handle-bridge-slice.md"
PERF_BUFFER_POLL_SLICE_PATH = "Documentation/zigux/phase8-perf-buffer-poll-slice.md"
...
BPF_TYPE_NAMES_TEST_PATH = "zigux/tests/phase8_bpf_type_names.zig"
PERF_BUFFER_POLL_TEST_PATH = "zigux/tests/phase8_perf_buffer_poll.zig"
PERF_BUFFER_POLL_ONLY_BUILD_PATH = "zigux/tests/phase8_perf_buffer_poll_only_build.zig"
LIBBPF_SEGMENTS_TEST_PATH = "zigux/tests/phase8_libbpf_segments.zig"
LIBBPF_SEGMENTS_ONLY_BUILD_PATH = "zigux/tests/phase8_libbpf_segments_only_build.zig"
...
FIXTURE_OVERRIDES = {
    ...
    BPF_TYPE_NAMES_SLICE_PATH: "# fixture\n",
    FILE_PATH_HANDLE_BRIDGE_SLICE_PATH: "\n".join(REQUIRED_MARKERS[FILE_PATH_HANDLE_BRIDGE_SLICE_PATH]) + "\n",
    PERF_BUFFER_POLL_SLICE_PATH: "# fixture\n",
    ...
    BPF_TYPE_NAMES_TEST_PATH: "// fixture\n",
    PERF_BUFFER_POLL_TEST_PATH: "// fixture\n",
    PERF_BUFFER_POLL_ONLY_BUILD_PATH: "// fixture\n",
    LIBBPF_SEGMENTS_TEST_PATH: "// fixture\n",
    LIBBPF_SEGMENTS_ONLY_BUILD_PATH: "// fixture\n",
...
def run_self_test() -> None:
    missing_file_cases = [
        ...
        ("missing_bpf_type_names_slice_note", BPF_TYPE_NAMES_SLICE_PATH),
        ("missing_file_path_handle_bridge_slice_note", FILE_PATH_HANDLE_BRIDGE_SLICE_PATH),
        ("missing_perf_buffer_poll_slice_note", PERF_BUFFER_POLL_SLICE_PATH),
        ...
        ("missing_bpf_type_names_test", BPF_TYPE_NAMES_TEST_PATH),
        ("missing_perf_buffer_poll_test", PERF_BUFFER_POLL_TEST_PATH),
        ("missing_perf_buffer_poll_only_build", PERF_BUFFER_POLL_ONLY_BUILD_PATH),
        ("missing_libbpf_segments_test", LIBBPF_SEGMENTS_TEST_PATH),
        ("missing_libbpf_segments_only_build", LIBBPF_SEGMENTS_ONLY_BUILD_PATH),
    ...
    marker_cases = [
        ...
        (
            "docs_root_bpf_type_names_slice_marker",
            DOCS_ROOT_PATH,
            "`Documentation/zigux/phase8-bpf-type-names-slice.md`",
            "`Documentation/zigux/phase8-type-names-slice.md`",
            f"{DOCS_ROOT_PATH}: `Documentation/zigux/phase8-bpf-type-names-slice.md`",
        ),
        (
            "docs_root_perf_buffer_route_marker",
            DOCS_ROOT_PATH,
            "`make -C zigux phase8-perf-buffer-poll-test`",
            "`make -C zigux phase8-perf-buffer-review`",
            f"{DOCS_ROOT_PATH}: `make -C zigux phase8-perf-buffer-poll-test`",
        ),
        (
        ...
        (
            "review_checklist_bpf_type_names_slice_marker",
            REVIEW_CHECKLIST_PATH,
            "`Documentation/zigux/phase8-bpf-type-names-slice.md`",
            "`Documentation/zigux/phase8-type-names-slice.md`",
            f"{REVIEW_CHECKLIST_PATH}: `Documentation/zigux/phase8-bpf-type-names-slice.md`",
        ),
        (
            "review_checklist_libbpf_segments_build_marker",
            REVIEW_CHECKLIST_PATH,
            "`zigux/tests/phase8_libbpf_segments_only_build.zig`",
            "`zigux/tests/phase8_libbpf_segments_build_only.zig`",
            f"{REVIEW_CHECKLIST_PATH}: `zigux/tests/phase8_libbpf_segments_only_build.zig`",
        ),
        (
        ...
        (
            "scripts_readme_bpf_type_names_slice_marker",
            SCRIPTS_README_PATH,
            "`Documentation/zigux/phase8-bpf-type-names-slice.md`",
            "`Documentation/zigux/phase8-type-names-slice.md`",
            f"{SCRIPTS_README_PATH}: `Documentation/zigux/phase8-bpf-type-names-slice.md`",
        ),
        (
            "scripts_readme_libbpf_segments_build_marker",
            SCRIPTS_README_PATH,
            "`zigux/tests/phase8_libbpf_segments_only_build.zig`",
            "`zigux/tests/phase8_libbpf_segments_build_only.zig`",
            f"{SCRIPTS_README_PATH}: `zigux/tests/phase8_libbpf_segments_only_build.zig`",
        ),
        (
        ...
        (
            "tests_readme_bpf_type_names_marker",
            TESTS_README_PATH,
            "`zigux/tests/phase8_bpf_type_names.zig`",
            "`zigux/tests/phase8_type_names.zig`",
            f"{TESTS_README_PATH}: `zigux/tests/phase8_bpf_type_names.zig`",
        ),
        (
            "tests_readme_libbpf_segments_only_build_marker",
            TESTS_README_PATH,
            "`zigux/tests/phase8_libbpf_segments_only_build.zig`",
            "`zigux/tests/phase8_libbpf_segments_build_only.zig`",
            f"{TESTS_README_PATH}: `zigux/tests/phase8_libbpf_segments_only_build.zig`",
        ),
        (
