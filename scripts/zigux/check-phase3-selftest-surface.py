...
def run_self_test() -> int:
    cases = (
        ...
        (README_PATH, "Documentation/zigux/phase3-xarray-slot-slice.md", "docs README"),
        ...
        (README_PATH, "Documentation/zigux/phase3-bitmap-cpumask-slice.md", "docs README"),
        (README_PATH, "Documentation/zigux/phase3-abi-header-family-survey.md", "docs README"),
        (README_PATH, "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "docs README"),
        (README_PATH, "zigux/bindings/notifier_abi.zig", "docs README"),
        (README_PATH, "zigux/helpers/layout_assert.zig", "docs README"),
        (README_PATH, "zigux/helpers/xarray_slot_view.zig", "docs README"),
        (README_PATH, "zigux/helpers/bitmap_view.zig", "docs README"),
        (README_PATH, "zigux/helpers/cpumask_view.zig", "docs README"),
        (README_PATH, "zigux/unsafe/narrow.zig", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-xarray-slot-starter-packet.py", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-xarray-slot.py", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-policy-dump.py", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-catalog-selftest.py", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-abi.py", "docs README"),
        (README_PATH, "scripts/zigux/check-phase3-bitmap-cpumask.py", "docs README"),
        (README_PATH, "scripts/zigux/phase3_catalog.py", "docs README"),
        (README_PATH, "scripts/zigux/validate-phase3.py", "docs README"),
        ...
        (README_PATH, "scripts/zigux/validate-phase3-abi-header-family-survey.py", "docs README"),
        ...
        (README_PATH, "zigux/tests/phase3_bitmap_cpumask_starter_packet.zig", "docs README"),
        (README_PATH, "zigux/tests/phase3_bitmap_cpumask_starter_packet_build.zig", "docs README"),
        (README_PATH, "make -C zigux phase3-export-uapi-layout-test", "docs README"),
        (README_PATH, "zig build phase3-export-uapi-layout-test --build-file zigux/tests/phase3_export_uapi_layout_build.zig", "docs README"),
        (README_PATH, "zig build phase3-policy-dump --build-file zigux/tests/phase3_policy_dump_build.zig", "docs README"),
        (README_PATH, "zig build phase3-bitmap-cpumask-starter-packet --build-file zigux/tests/phase3_bitmap_cpumask_starter_packet_build.zig", "docs README"),
        ...
        (TESTS_README_PATH, "Documentation/zigux/phase3-export-uapi-boundary-survey.md", "tests README"),
        (TESTS_README_PATH, "Documentation/zigux/phase3-low-level-wrapper-boundary-survey.md", "tests README"),
        (TESTS_README_PATH, "zigux/tests/phase3_xarray_slot_starter_packet.zig", "tests README"),
        (TESTS_README_PATH, "scripts/zigux/validate-phase3-export-uapi-survey.py", "tests README"),
        (TESTS_README_PATH, "scripts/zigux/validate-phase3-low-level-wrapper-survey.py", "tests README"),
        (TESTS_README_PATH, "zigux/tests/phase3_low_level_wrappers.zig", "tests README"),
        (TESTS_README_PATH, "zigux/tests/phase3_low_level_wrappers_build.zig", "tests README"),
        (TESTS_README_PATH, "zig build phase3-low-level-wrappers --build-file zigux/tests/build.zig", "tests README"),
        (TESTS_README_PATH, "`zigux/tests/README.md` now keeps the returned bitmap/cpumask and list/hlist helper slices explicit beside the packet-local export/UAPI survey note, validator, focused export/UAPI layout replay, and direct C smoke companion family, so the tests-root reminder no longer carries a same-lane summary gap.", "tests README"),
        (TESTS_README_PATH, "keep the returned notifier-binding and focused export/UAPI layout replay pair explicit beside `zigux/bindings/notifier_abi.zig`, `zigux/kernel/export_shim.zig`, `zigux/tests/phase3_export_uapi_layout.zig`, and `zigux/tests/phase3_export_uapi_layout_build.zig` as shipped tests-root evidence", "tests README"),
        (REVIEW_CHECKLIST_PATH, "Documentation/zigux/phase3-export-uapi-boundary-survey.md", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "Documentation/zigux/phase3-low-level-wrapper-boundary-survey.md", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "Documentation/zigux/phase3-linux-zigux-header-governance.md", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "Documentation/zigux/phase3-abi-header-family-survey.md", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/check-phase3-selftest-surface.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/check-phase3-readme-tooling-inventory.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/validate-phase3-validator-support-surface.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/validate-phase3-export-uapi-survey.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/validate-phase3-abi-header-family-survey.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/validate-phase3-low-level-wrapper-survey.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/check-phase3-catalog-selftest.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "scripts/zigux/phase3_catalog.py", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "zigux/tests/fixtures/phase3_abi_manifest.json", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "zigux/tests/phase3_export_uapi_layout.zig", "review checklist"),
        (REVIEW_CHECKLIST_PATH, "keep any broader shared replay or broader header-family completion claims framed as repo-reality gaps", "review checklist"),
        (VALIDATOR_SUPPORT_PATH, "Documentation/zigux/phase3-xarray-slot-slice.md", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/helpers/xarray_slot_view.zig", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/phase3_xarray_slot_starter_packet.zig", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/phase3_xarray_slot_starter_packet_build.zig", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/check-phase3-xarray-slot-starter-packet.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/phase3_xarray_slot_dump.zig", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/phase3_xarray_slot_dump_build.zig", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/fixtures/phase3_xarray_slot/expected.json", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/check-phase3-xarray-slot.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "one focused helper-local `xarray_slot` classifier slice with both starter-packet and fixture-backed dump parity coverage", "validator-support note"),
        ...
        (VALIDATOR_SUPPORT_PATH, "Documentation/zigux/phase3-linux-zigux-header-governance.md", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/check-phase3-abi.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/phase3_catalog.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zigux/tests/fixtures/phase3_abi_manifest.json", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/validate-phase3-abi-header-family-survey.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Documentation/zigux/phase3-abi-header-family-survey.md", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Documentation/zigux/phase3-shared-reminder-gap.md", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "scripts/zigux/validate-phase3-validator-support-surface.py", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "zig build phase3-dev-t-starter-packet-test --build-file zigux/tests/phase3_dev_t_starter_packet_build.zig --summary all", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "It does not currently ship the broader shared Phase 3 replay packet itself, even though the shared `scripts/zigux/validate-phase3.py` validator entrypoint and `scripts/zigux/check-phase3-abi.py` shared ABI checker are directly readable on current `master`, current `master` also directly serves the bounded catalog helper at `scripts/zigux/phase3_catalog.py` together with the shared ABI manifest at `zigux/tests/fixtures/phase3_abi_manifest.json`, and the aligned docs-root, review-checklist, tests-root, and scripts-root reminder surfaces now keep that broader shared-summary drift closed.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Current `master` also directly serves the returned `Documentation/zigux/phase3-linux-zigux-header-governance.md` ownership note beside that adjacent export/UAPI layout replay pair, so the bounded Linux-facing relay is reviewable without turning this validator-support packet into the semantic owner of the separately landed header-family survey follow-through.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Current `master` also directly serves the focused `Documentation/zigux/phase3-abi-h-boundary-next-step.md` note as the packet-local `include/zigux/abi.h` companion beside the dedicated `Documentation/zigux/phase3-abi-header-family-survey.md` plus `scripts/zigux/validate-phase3-abi-header-family-survey.py` follow-through and `Documentation/zigux/phase3-linux-zigux-header-governance.md`, but those returned same-family surfaces should not be used here to imply that the broader shared Phase 3 replay packet has returned.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "Current `master` does still ship the separately readable shared validator entrypoint through `scripts/zigux/validate-phase3.py` together with the shared ABI checker through `scripts/zigux/check-phase3-abi.py`, and it also directly serves `scripts/zigux/phase3_catalog.py` together with `zigux/tests/fixtures/phase3_abi_manifest.json`, but those shared validation, catalog, and manifest surfaces should not be used here to imply that the broader validator-support or shared replay packet has returned beyond that bounded survey-plus-next-step companion packet already enumerated here.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "`zigux/tests/README.md` now keeps the returned bitmap/cpumask and list/hlist helper slices explicit beside the packet-local export/UAPI survey note, validator, focused export/UAPI layout replay, and direct C smoke companion family, so keep any broader shared-summary follow-through parked unless a fresh reread reopens same-packet drift on current `master`.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "`Documentation/zigux/phase3-shared-reminder-gap.md` now records the aligned docs-root, review-checklist, tests-root, and scripts-root summaries, keeps the returned header-family survey follow-through explicit as a same-family companion, and records that no same-lane shared-summary drift remains on current `master`.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "broader export/UAPI survey, catalog, or shared Phase 3 replay packet", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "make -C zigux phase3-low-level-wrappers-test", "validator-support note"),
        (SCRIPTS_README_PATH, "python3 scripts/zigux/check-phase3-abi-manifest-replay-routes.py --self-test", "scripts README"),
        (SCRIPTS_README_PATH, "scripts/zigux/check-phase3-abi-manifest-replay-routes.py", "scripts README"),
        (SCRIPTS_README_PATH, "python3 scripts/zigux/check-phase3-readme-tooling-inventory.py --self-test", "scripts README"),
        (SCRIPTS_README_PATH, "scripts/zigux/check-phase3-shared-tests-routes.py", "scripts README"),
        (SCRIPTS_README_PATH, "zigux/tests/phase3_xarray_slot_starter_packet.zig", "scripts README"),
        (SCRIPTS_README_PATH, "zig build phase3-xarray-slot-starter-packet --build-file zigux/tests/build.zig", "scripts README"),
        (SCRIPTS_README_PATH, "`scripts/zigux/validate-phase3-low-level-wrapper-survey.py`", "scripts README"),
        (SCRIPTS_README_PATH, "python3 scripts/zigux/validate-phase3-low-level-wrapper-survey.py --self-test", "scripts README"),
        ...
        (SCRIPTS_README_PATH, "scripts/zigux/validate-phase3-abi-header-family-survey.py", "scripts README"),
        (SCRIPTS_README_PATH, "Documentation/zigux/phase3-abi-header-family-survey.md", "scripts README"),
        (SCRIPTS_README_PATH, "Documentation/zigux/phase3-abi-h-boundary-next-step.md", "scripts README"),
        (SCRIPTS_README_PATH, "still return missing on current `master`", "scripts README"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-policy-dump.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-shared-tests-routes.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-abi.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-abi-support-packet.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-abi-manifest-replay-routes.py")', "selftest driver"),
        ...
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3-abi-header-family-survey.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3-policy-unsafe-survey.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3-validator-support-surface.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3-linux-zigux-header-governance.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/run-phase3-checks.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/generate-phase3-check-wrappers.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/check-phase3-selftest-surface.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, 'Path("scripts/zigux/validate-phase3-low-level-wrapper-survey.py")', "selftest driver"),
        (SELFTEST_DRIVER_PATH, "PHASE3_ABI_SUPPORT_PACKET_SELF_TEST=pass", "selftest driver"),
        (SELFTEST_DRIVER_PATH, "PHASE3_ABI_SUPPORT_PACKET_SELF_TEST_CASE_COUNT=", "selftest driver"),
        (SELFTEST_DRIVER_PATH, "PHASE3_ABI_MANIFEST_REPLAY_ROUTES_SELF_TEST=pass", "selftest driver"),
        (SELFTEST_DRIVER_PATH, "PHASE3_ABI_MANIFEST_REPLAY_ROUTES_SELF_TEST_CASE_COUNT=", "selftest driver"),
        (SELFTEST_DRIVER_PATH, "PHASE3_EXPORT_UAPI_C_HEADER_SMOKE_SELF_TEST=pass", "selftest driver"),
