...
def run_self_test() -> int:
    cases = (
        ...
        (README_PATH, "include/zigux/abi.h", "docs README"),
        ...
        (TESTS_README_PATH, "instead of presenting the broader validator, export/UAPI layout, low-level-wrapper, catalog, IDR, or IDA packet as shipped tests-root evidence", "tests README"),
        ...
        (REVIEW_CHECKLIST_PATH, "include/zigux/abi.h", "review checklist"),
        ...
        (REVIEW_CHECKLIST_PATH, "wider validator, export/UAPI layout, low-level-wrapper, catalog, IDR, and IDA routes stay explicit as repo-reality gaps", "review checklist"),
        ...
        (VALIDATOR_SUPPORT_PATH, "`zigux/tests/README.md` now keeps the returned packet-local export/UAPI survey note and validator explicit beside the starter, helper, xarray-slot, policy, and layout-replay packet, so keep any broader shared-summary follow-through parked unless a fresh reread reopens same-packet drift on current `master`.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "`Documentation/zigux/phase3-shared-reminder-gap.md` now records the partially aligned docs-root, tests-root, and scripts-root summaries, keeps the returned header-family survey follow-through explicit as a same-family companion, and still parks the remaining same-lane gap on narrower docs-root and tests-root helper-slice truthfulness plus separate scripts-root inventory follow-through.", "validator-support note"),
        (VALIDATOR_SUPPORT_PATH, "broader validator, export/UAPI layout, catalog, or shared Phase 3 replay packet", "validator-support note"),
        ...
        (SCRIPTS_README_PATH, "include/zigux/abi.h", "scripts README"),
