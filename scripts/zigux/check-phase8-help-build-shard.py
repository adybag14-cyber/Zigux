...
SCRIPT_PATH = "scripts/zigux/check-phase8-help-build-shard.py"
BUILD_PATH = "zigux/tests/phase8_help_only_build.zig"
...
def run_self_test() -> int:
    cases = 1
    with tempfile.TemporaryDirectory(prefix="zigux_phase8_help_build_shard_") as tmp:
    ...
    print("PHASE8_HELP_BUILD_SHARD_SELF_TEST=pass")
    print(f"PHASE8_HELP_BUILD_SHARD_SELF_TEST_CASE_COUNT={cases}")
    return 0
...
def main(argv: list[str]) -> int:
    ...
    problems = validate(root)
    if problems:
        print("PHASE8_HELP_BUILD_SHARD=fail")
        print("PHASE8_HELP_BUILD_SHARD_PROBLEMS_START")
        for problem in problems:
            print(problem)
        print("PHASE8_HELP_BUILD_SHARD_PROBLEMS_END")
        return 1

    print("PHASE8_HELP_BUILD_SHARD=pass")
    print(f"PHASE8_HELP_BUILD_SHARD_ROOT={root}")
    return 0
