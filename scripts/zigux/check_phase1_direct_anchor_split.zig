// Ported from check-phase1-direct-anchor-split.py by port_phase1_guards.py
...
const LANE_NOTE_LINE = "- `PHASE1_DIRECT_ANCHOR_FOLLOWUP_HELPERS=tools/lib/bitmap.zig,tools/lib/find_bit.zig,tools/lib/rbtree.zig,tools/lib/string.zig`";
