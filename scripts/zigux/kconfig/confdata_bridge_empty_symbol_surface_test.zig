...
test "confdata bridge public surface ignores empty CONFIG symbol names" {
...
test "confdata bridge public json omits empty CONFIG symbol names" {
    const input =
        \\CONFIG_=y
        \\# CONFIG_ is not set
        \\CONFIG_VALID=m
    ...
    try std.testing.expectEqualStrings(
        "{\"counts\":{\"set\":2,\"unset\":0},\"entries\":[{\"name\":\"CONFIG_VALID\",\"kind\":\"tristate\",\"value\":\"m\"},{\"name\":\"CONFIG_VALUE\",\"kind\":\"value\",\"value\":\"7\"}]}\n",
        capture.list.items,
    );
}
