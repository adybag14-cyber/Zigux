...
test "allnoconfig silent empty allconfig CLI emits explicit override packet" {
    const allocator = std.testing.allocator;
    const exe_path = ".zig-cache/tmp/conf_bridge_allnoconfig_silent_empty_allconfig_cli_surface_test_bin";
