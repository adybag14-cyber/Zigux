...
test "lane19 multi-megabyte exact-buffer split keeps a visible control tail with trimmed carriage returns and still reaches the next line beyond the old CLI cap" {
