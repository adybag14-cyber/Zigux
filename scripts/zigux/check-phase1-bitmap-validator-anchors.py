...
REQUIRED_MANIFEST_FIELDS = {
    ...
    "xor_unit_test_contract": (
        "Direct Zig unit coverage keeps xorBits() aligned with the caller-selected bit window by "
        "proving partial-word and multiword-tail replays preserve only the in-range bits that "
        "callers intentionally clamp."
    ),
