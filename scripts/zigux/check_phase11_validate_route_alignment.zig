...
pub const live_pass_marker = "PHASE11_VALIDATE_ROUTE_ALIGNMENT=pass";
pub const self_test_pass_marker = "PHASE11_VALIDATE_ROUTE_ALIGNMENT_SELF_TEST=pass";
...
fn emitCounts(io: Io) !void {
    try guard.printLine(io,"PHASE11_COMPAT_REQUIRED_FILE_COUNT=3",.{});
...
fn runSelfTest(io: Io, allocator: std.mem.Allocator) !u8 {
    ...
    try guard.printLine(io,"{s}",.{self_test_pass_marker}); try guard.printLine(io,"PHASE11_VALIDATE_ROUTE_ALIGNMENT_SELF_TEST_CASE_COUNT=10",.{}); try emitCounts(io); return 0;
}
...
// // const guard = @import("zigux_guard.zig");
// //
// // pub const pass_marker = "PHASE11_VALIDATE_ROUTE_ALIGNMENT_SELF_TEST=pass";
// //
// // const VALIDATOR_ROUTE = [_][]const u8{
// //     "scripts\zigux/validate_phase11.zig",
// // };
// //
// // pub fn checkText(text: []const u8) guard.GuardError!void {
// //     for (VALIDATOR_ROUTE) |marker| try guard.requireMarker(text, marker);
// // }
// //
// // pub fn main() !void {
