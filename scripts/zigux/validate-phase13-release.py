...
RELEASE_MARKERS = [
    ...
    "`lib/devres.c` through `zigux/tests/phase13_devres_manifest.json` lane `P13-L01`",
...
REVIEW_CHECKLIST_MARKERS = [
    ...
    "and that the shared replay still names the same eight steps?",
