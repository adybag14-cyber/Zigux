...
REQUIRED_MARKERS = [
    ...
    "`dw_wdt`: `Documentation/zigux/phase11-dw-wdt-validation-matrix.md` now rematerializes on current `master`",
...
def run_self_test() -> None:
    ...
    try:
        ...
        for index, marker in enumerate(REQUIRED_MARKERS[:7], start=1):
