...
pub const self_test_pass_marker = "PHASE15_REVIEW_CHECKLIST_STUDY_ONLY_ALIGNMENT_SELF_TEST=pass";
pub const live_pass_marker = "PHASE15_REVIEW_CHECKLIST_STUDY_ONLY_ALIGNMENT=pass";
...
fn emitCounts(io: Io) !void {
    try guard.printLine(io, "PHASE15_REVIEW_CHECKLIST_STUDY_ONLY_ALIGNMENT_REQUIRED_FILE_COUNT={d}", .{contracts.len});
    try guard.printLine(io, "PHASE15_REVIEW_CHECKLIST_STUDY_ONLY_ALIGNMENT_REQUIRED_MARKER_COUNT={d}", .{@as(usize, 12)});
}
...
pub fn main(init: std.process.Init) !void {
    ...
    if (self_test) try guard.printLine(io, "PHASE15_REVIEW_CHECKLIST_STUDY_ONLY_ALIGNMENT_SELF_TEST_CASE_COUNT=1", .{});
    try emitCounts(io);
}
