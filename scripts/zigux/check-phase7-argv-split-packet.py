...
print(
    ...
    f"{len(REQUIRED_DOC_MARKERS) + len(REQUIRED_PARITY_MARKERS) + len(REQUIRED_MAKE_MARKERS) + len(REQUIRED_BUILD_MARKERS) + len(REQUIRED_TEST_MARKERS) + len(REQUIRED_SURVEY_MARKERS) + len(REQUIRED_HELPER_MARKERS)}"
)
