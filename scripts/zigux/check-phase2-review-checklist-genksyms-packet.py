...
REVIEW_CHECKLIST_MARKERS = (
    ...
    "fixdep, genksyms-bridge, and required-make-route packet",
)
...
def run_self_test() -> int:
    checks_run = 1 + len(REVIEW_CHECKLIST_MARKERS) + len(TESTS_README_MARKERS) + len(PHASE2_TOOL_MANIFEST_MARKERS) + 3
    completed = 0
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Keep the review-checklist Phase 2 genksyms packet aligned to the shipped tests-root and manifest packet."
    )
