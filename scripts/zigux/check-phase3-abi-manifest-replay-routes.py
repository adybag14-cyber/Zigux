...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="zigux_phase3_abi_manifest_routes_") as temp_dir:
        ...
        packet_file_cases = (
            ...
            ("zigux/tests/phase3_dev_t_starter_packet.zig", "expected dev-t starter packet-file drift was not reported"),
            ...
            ("zigux/tests/phase3_policy_dump_build.zig", "expected policy-dump build packet-file drift was not reported"),
            ("zigux/tests/fixtures/phase3_policy_dump_expected.txt", "expected policy-dump expected-output packet-file drift was not reported"),
        ...
        replay_route_cases = (
            ...
            ("python3 scripts/zigux/check-phase3-policy-dump.py --self-test", "expected policy-dump self-test route drift was not reported"),
            ...
            ("make -C zigux phase3-low-level-wrappers", "expected low-level-wrapper aggregate make route drift was not reported"),
            ("make -C zigux phase3-low-level-wrappers-test", "expected low-level-wrapper focused make route drift was not reported"),
        )
    ...
    print("PHASE3_ABI_MANIFEST_REPLAY_ROUTES_SELF_TEST_CASE_COUNT=109")
    return 0
