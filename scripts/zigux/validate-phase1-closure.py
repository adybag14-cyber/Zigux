...
def run_self_test() -> int:
    cases: list[tuple[str, object | None]] = [
        ...
        ("stale_rbtree_bench_guard", lambda root: write_text(root / PHASE1_CLOSURE_REL, load_text(root, PHASE1_CLOSURE_REL).replace(EXPECTED_CLOSURE_MARKERS["rbtree_bench_guard"], "`PHASE1_RBTREE_BENCH_GUARD=drifted rbtree bench marker`", 1))),
