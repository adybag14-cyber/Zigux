...
test "runGenksymsCrc escapes visible ENQ before hiding NUL tail" {
    const visible = "enq\x05visible";
    const hidden = "hidden\x05tail";
    const next = "next";
    ...
    const expected = try std.fmt.allocPrint(
        ...
        "{{\"cases\":[{{\"input\":\"enq\\u0005visible\",\"crc_hex\":\"{s}\"}},{{\"input\":\"next\",\"crc_hex\":\"{s}\"}}]}}\n",
