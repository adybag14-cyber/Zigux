...
REQUIRED_EXACT_LINES = {
    LANE_NOTE_REL: {
        ...
        "shared_reminder_route_split": "- `PHASE1_DIRECT_OWNER_SHARED_REMINDER_ROUTE_SPLIT=Documentation/zigux/README.md, Documentation/zigux/review-checklist.md, and zigux/tests/README.md still keep the repo-reality warning explicit in a way that leaves scripts/zigux/check-phase1-bench.py inside their historical-gap wording, while scripts/zigux/README.md now carries the already-shipped bench-checker wording and scripts/zigux/check-phase1-string-review-packet.py plus scripts/zigux/check-phase1-direct-owner-markers.py carry the live self-test-versus-guard split for the shipped Phase 1 reminder packet`",
        ...
        "shared_reminder_next_step": "- `PHASE1_DIRECT_OWNER_SHARED_REMINDER_NEXT_STEP=sync zigux/tests/README.md to the restored closure-side packet first so the current direct-readback Phase 1 reminder packet names scripts/zigux/validate-phase1-closure.py together with zigux/tests/build.zig and zigux/tests/phase1_host_tools_smoke.zig; then tighten scripts/zigux/check-phase1-direct-owner-markers.py to the same wording before reopening helper-local follow-through, unless a future reread shows those surfaces already agree`",
    ...
    TESTS_README_REL: {
        ...
        "phase1_followthrough_alignment": "  * keep current Phase 1 follow-through tied to the live owner-map plus restored closure-side, string-review, and bench reminder packet instead of reconstructing the broader installer-backed closure-and-replay packet from those older missing installer, validator-first, closure-side, and replay files and routes alone",
    },
    SCRIPTS_README_REL: {
