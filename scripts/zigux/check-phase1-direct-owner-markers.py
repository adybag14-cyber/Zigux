...
EXPECTED_MANIFEST_NEXT_SAFE_STEPS = {
    ...
    "tools/lib/rbtree.zig": "If this helper lane reopens, the smallest shared-replay promotion is now wiring the already-shipped `cached_leftmost_return_serials` fixture key into the shared replay; until then, cached-root leftmost-return and singleton-erase behavior stay owned by direct helper-local anchors.",
