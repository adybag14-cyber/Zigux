...
FILE_MARKERS: dict[Path, tuple[str, ...]] = {
    ...
    HELP_TEST: (
        ...
        "help.CmdNames.init(",
        "help.DirectoryEntry",
        "help.addExecutableEntry(",
        "help.addExecutableEntries(",
        "main_cmds.uniq();",
        "excludes.addCmdName(",
        "main_cmds.excludeCmds(",
        "main_cmds.isInCmdList(",
        "main_cmds.longestNameLen()",
        "help.commandNameFromEntry(",
        "help.planPrettyPrint(",
        "help.planPrettyPrintForTerminal(",
        "help.resolveTerminalDimensions(",
        "help.loadCommandListsFromSource(",
        "help.loadCommandListsFromEnvPath(",
        "help.splitPathEntries(",
