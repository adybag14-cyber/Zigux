// Ported from check-phase1-find-bit-review-anchors.py by port_phase1_guards.py
const std = @import("std");
const Io = std.Io;
const guard = @import("zigux_guard.zig");

const ADDENDUM_REL = "zigux/tests/fixtures/phase1_find_bit_review_anchors.json";

const EXPECTED_REQUIRED_ENTRYPOINTS = [_][]const u8{
    "find_next_or_bit",
    "_find_next_or_bit",
    "find_first_clump8",
    "_find_first_clump8",
...
const EXPECTED_REQUIRED_HELPER_TESTS = [_][]const u8{
