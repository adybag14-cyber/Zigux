...
MANIFEST_SPECS = {
    ...
    "phase11_dw_wdt_manifest.json": ("P11-L10", "drivers/watchdog/dw_wdt.c", 10, ["phase11-dw-wdt-registration-handoff"], ["phase11-dw-wdt-platform-and-pm"]),
    "phase11_hvc_console_manifest.json": ("P11-L13", "drivers/tty/hvc/hvc_console.c", 8, ["phase11-hvc-console-tty-and-teardown-parity"], []),
    "phase11_uapi_header_parity_manifest.json": ("P11-L11", "include/uapi/linux/watchdog.h", 6, ["phase11-phase3-interop-followup"], []),
}
ALLOWED_STATUSES = {
    "starter_landed",
    "ready_next",
