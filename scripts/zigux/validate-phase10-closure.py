...
MARKER_LABELS = {
    ...
    "scripts/zigux/README.md": "scripts-readme",
...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="zigux_phase10_closure_") as tmp_dir:
        ...
        scripts_readme.write_text(
            scripts_readme.read_text(encoding="utf-8").replace("Documentation/zigux/phase10-virtio-input-module-slice.md\n", "", 1),
            encoding="utf-8",
        )
        expect_marker_missing(
            root,
            "scripts-readme:Documentation/zigux/phase10-virtio-input-module-slice.md",
            "phase10-closure-self-test:missing_scripts_readme_input_module_slice_not_detected",
        )
        write_fixture(root)

        scripts_readme.write_text(
            scripts_readme.read_text(encoding="utf-8").replace("zigux/tests/phase10_build.zig\n", "", 1),
            encoding="utf-8",
        )
        expect_marker_missing(
            root,
            "scripts-readme:zigux/tests/phase10_build.zig",
            "phase10-closure-self-test:missing_scripts_readme_phase10_build_not_detected",
        )
        write_fixture(root)
        ...
        closure_manifest.write_text(
            closure_manifest.read_text(encoding="utf-8").replace(
                '"phase10-virtio-input-status-drain-helper"',
                '"phase10-virtio-input-status-drain-helper-missing"',
                1,
            ),
            encoding="utf-8",
        )
        expect_marker_missing(
            root,
            'manifest:"phase10-virtio-input-status-drain-helper"',
            "phase10-closure-self-test:missing_manifest_input_status_drain_marker_not_detected",
        )
        write_fixture(root)
        ...
        closure_manifest.write_text(
            closure_manifest.read_text(encoding="utf-8").replace(
                '"zigux/tests/phase10_virtio_input_manifest.json": "phase10-virtio-input-registration-lifecycle"',
                '"zigux/tests/phase10_virtio_input_manifest.json": "phase10-virtio-input-registration-lifecycle-missing"',
                1,
            ),
            encoding="utf-8",
        )
        expect_marker_missing(
            root,
            'manifest:"zigux/tests/phase10_virtio_input_manifest.json": "phase10-virtio-input-registration-lifecycle"',
            "phase10-closure-self-test:missing_manifest_input_followup_marker_not_detected",
        )
        write_fixture(root)
