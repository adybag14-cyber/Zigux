...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        ("missing_catalog_none_gap_marker", CATALOG_PATH, "- shared `Documentation/zigux/README.md` and `Documentation/zigux/review-checklist.md` Phase 7 reminder text still omits the shipped `scripts/zigux/check-phase7-cmdline-packet.py` guard from the shared packet inventory", "- none currently"),
