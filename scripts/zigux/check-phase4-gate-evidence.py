...
MUTATIONS: list[tuple[str, str, str, Path | None]] = [
    ...
    ("gate_evidence_self_test_case_count_drift", "`PHASE4_GATE_EVIDENCE_SELF_TEST_CASE_COUNT=46`", "`PHASE4_GATE_EVIDENCE_SELF_TEST_CASE_COUNT=45`", NOTE),
    ...
    ("shared_validator_expected_self_test_case_count_drift", "`PHASE4_SHARED_VALIDATOR_EXPECTED_GATE_EVIDENCE_SELF_TEST_CASE_COUNT=46`", "`PHASE4_SHARED_VALIDATOR_EXPECTED_GATE_EVIDENCE_SELF_TEST_CASE_COUNT=45`", NOTE),
