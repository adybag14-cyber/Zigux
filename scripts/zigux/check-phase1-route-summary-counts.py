...
EXACT_LINE_MARKERS = {
    ...
    "scripts/zigux/README.md": (
        ...
        "- `scripts/zigux/check-phase1-route-summary-counts.py`, `python3 scripts/zigux/check-phase1-route-summary-counts.py --self-test`, and `python3 scripts/zigux/check-phase1-route-summary-counts.py` keep the adjacent route-summary guard explicit beside the workflow-backed closure-validator, shared-reminder, and shared tests-root smoke packet",
