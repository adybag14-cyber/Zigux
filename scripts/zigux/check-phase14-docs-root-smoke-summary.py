...
""".strip()
    ...
    missing_rcu_tree_release_boundary = validate_phase14_summary_surfaces(
        docs_root_text,
        tests_root_text,
        scripts_readme_text,
        survey_text,
    ...
    missing_skbuff_release_boundary = validate_phase14_summary_surfaces(
        docs_root_text,
        tests_root_text,
        scripts_readme_text,
        survey_text,
    ...
    if (
        ...
        or not missing_rcu_tree_release_boundary
        or not missing_skbuff_release_boundary
    ):
