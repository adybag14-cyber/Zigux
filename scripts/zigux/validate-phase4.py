...
def check_gate_matrix_alignment(phase4_matrix: str, gate_name: str, expectation: dict[str, object]) -> list[str]:
    ...
    if f"- fallback path: {expectation['fallback_path']}" not in …4455 tokens truncated…   '',
        '## Lab And CI Matrix',
        '',
