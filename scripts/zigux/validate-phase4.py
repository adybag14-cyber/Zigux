...
REQUIRED_COMMAND_OUTPUT_MARKERS = {
    ...
    "phase4-perf-threshold-matrix-self-test": (
        ...
        ("PHASE4_PERF_THRESHOLD_MATRIX_SELF_TEST_CASES", "PHASE4_PERF_THRESHOLD_MATRIX_SELF_TEST_CASES=19"),
    ),
...
def configure_workflow_route_stub(root: Path) -> None:
    build_stub_script(
        ...
        self_test_stdout_lines=(
            ...
            "PHASE4_WORKFLOW_ROUTE_COUNTS_REQUIRED_CHECK_COUNT=fixture",
        ),
        live_stdout_lines=(
...
def configure_phase4_output_stubs(root: Path) -> None:
    ...
    build_stub_script(
        ...
        self_test_stdout_lines=("PHASE4_PERF_THRESHOLD_MATRIX_SELF_TEST=pass", "PHASE4_PERF_THRESHOLD_MATRIX_SELF_TEST_CASES=19"),
...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="phase4-validate-self-test-") as tmp:
        ...
        if "output_marker_missing:phase4-workflow-route-counts-self-test:PHASE4_WORKFLOW_ROUTE_COUNTS_REQUIRED_CHECK_COUNT" not in collect_issues(root):
            print("PHASE4_VALIDATE_SELF_TEST=fail")
