...
def run_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="zigux_phase4_validator_selftest_") as tmp_dir_str:
        ...
        phase4_review_checklist_sha = _git_blob_sha1(
            (root / "Documentation/zigux/review-checklist.md").read_bytes()
        )
        ...
        manifest["phase4_review_checklist_blob_sha"] = "3333333333333333333333333333333333333333"
        _write(
            root,
            "zigux/tests/phase4_runtime_atomic64_diff_manifest.json",
            json.dumps(manifest, indent=2) + "\n",
        ...
        assert run_phase4_runtime_atomic64_packet_check(root) == [
            "phase4_runtime_atomic64_packet:unexpected_manifest_sha:phase4_review_checklist_blob_sha:"
        ...
        _write(
            ...
            "zigux/tests/phase4_runtime_atomic64_diff_survey.zig",
            survey_path.read_text(encoding="utf-8").replace(
                phase4_review_checklist_sha, "3333333333333333333333333333333333333333", 1
            ),
        )
        assert run_phase4_runtime_atomic64_packet_check(root) == [
            "phase4_runtime_atomic64_packet:survey_sha_exact_count:"
