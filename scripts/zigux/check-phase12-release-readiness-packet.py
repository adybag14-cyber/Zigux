...
REQUIRED_MARKERS = {
    ...
    RAW_GITHUB_COVERAGE_SURVEY_PATH: [
        ...
        "- exact coverage evidence checked on `2026-05-23`: the current GitHub contents bridge directly reads `scripts/zigux/check-build-only-phase12-surface.py` at blob `720442b7baa55d934a8895d8728fe60b25660448`, `scripts/zigux/check-phase12-complex-driver-lane-packet.py` at blob `50bc5556cacfee94371397a210722294711a7a4f`, `scripts/zigux/check-phase12-libbpf-snapshot.py` at blob `1417191a6c6b82e1735c83ce759c5c63224b952f`, `scripts/zigux/check-phase12-libbpf-heavy-consumer-packet.py` at blob `6a647e077c2485406ee535a0d5a0891d05471e50`, `scripts/zigux/validate-phase12.py` at blob `9261c648cedbe6f03432d1e668976d500d3d82b7`, `scripts/zigux/check-phase12-release-readiness-packet.py` at blob `9a91f673236a12e3c14829594114d9af21f63b53`, `.github/workflows/zigux-bootstrap.yml` at blob `5d07f69d341f667c96f59a26cd6957870c54997f`, `scripts/zigux/README.md` at blob `f11fa0c7f4b8f77db6cb9c7a5d2e772934b5c25a`, `zigux/Makefile` at blob `b2a4e6aa129ccedf690ad3fa10a862f6edc82ca5`, and `zigux/tests/phase12_build.zig` at blob `c338d24f4d12317c6a58d25708bbc14a5006852c`",
