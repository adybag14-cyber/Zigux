...
def run_self_test() -> int:
    ...
    try:
        ...
        expect_contains(
            check(tmp_root, source_text=MARKER),
            "The broader shared-summary packet is now closed on current `master`",
        ...
        expect_contains(
            check(tmp_root, source_text=MARKER),
            "fail-closed truthfulness guard",
        ...
        expect_contains(
            check(tmp_root, source_text=MARKER),
            "Leave this readiness companion parked unless a fresh repo-first reread finds another one-file reminder drift before widening into any new driver claims.",
