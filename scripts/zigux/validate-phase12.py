...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            "missing_virtio_scsi_fallback_commit_pin_marker",
            VIRTIO_SCSI_FALLBACK_PATH,
            "commit pin: `ee64eec272a352da1d967999c99bb3c3560c9b97`",
            "commit pin: `0000000000000000000000000000000000000000`",
            f"{VIRTIO_SCSI_FALLBACK_PATH}: commit pin: `ee64eec272a352da1d967999c99bb3c3560c9b97`",
        ),
        (
            "missing_virtio_scsi_fallback_current_authoritative_marker",
            VIRTIO_SCSI_FALLBACK_PATH,
            "current authoritative packet truth now lives in the shared-tree survey companions and validator surfaces reread for this lane",
            "current authoritative packet truth now lives in the older raw replay",
            f"{VIRTIO_SCSI_FALLBACK_PATH}: current authoritative packet truth now lives in the shared-tree survey companions and validator surfaces reread for this lane",
        ),
        (
        ...
        (
            ...
            "scripts/zigux/validate-phase12.py",
            "Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md",
            "Documentation/zigux/phase12-nvme-pci-raw-github-fallback-missing.md",
            "scripts/zigux/validate-phase12.py: Documentation/zigux/phase12-nvme-pci-raw-github-fallback-map.md",
        ),
        (
            "missing_validator_nvme_reopen_governance_marker",
            "scripts/zigux/validate-phase12.py",
            "Documentation/zigux/phase12-nvme-pci-reopen-governance.md",
            "Documentation/zigux/phase12-nvme-pci-reopen-governance-missing.md",
            "scripts/zigux/validate-phase12.py: Documentation/zigux/phase12-nvme-pci-reopen-governance.md",
        ),
        (
            "missing_validator_nvme_slice_marker",
            "scripts/zigux/validate-phase12.py",
            "Documentation/zigux/phase12-nvme-pci-slice.md",
            "Documentation/zigux/phase12-nvme-pci-slice-missing.md",
            "scripts/zigux/validate-phase12.py: Documentation/zigux/phase12-nvme-pci-slice.md",
        ),
        (
        ...
        (
            "missing_validator_nvme_direct_test_marker",
            "scripts/zigux/validate-phase12.py",
            "zigux/tests/phase12_nvme_pci.zig",
            "zigux/tests/phase12_nvme_pci_missing.zig",
            "scripts/zigux/validate-phase12.py: zigux/tests/phase12_nvme_pci.zig",
        ),
        (
            "missing_validator_nvme_manifest_marker",
            "scripts/zigux/validate-phase12.py",
            "zigux/tests/phase12_nvme_pci_manifest.json",
            "zigux/tests/phase12_nvme_pci_manifest_missing.json",
            "scripts/zigux/validate-phase12.py: zigux/tests/phase12_nvme_pci_manifest.json",
        ),
        (
            "missing_validator_nvme_survey_gate_marker",
            "scripts/zigux/validate-phase12.py",
            "zigux/tests/phase12_nvme_pci_survey.zig",
            "zigux/tests/phase12_nvme_pci_survey_missing.zig",
            "scripts/zigux/validate-phase12.py: zigux/tests/phase12_nvme_pci_survey.zig",
        ),
        (
