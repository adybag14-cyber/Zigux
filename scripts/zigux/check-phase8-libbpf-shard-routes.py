...
REQUIRED_MARKERS = {
    ...
    "Documentation/zigux/phase8-tooling-lane-sequencing.md": [
        ...
        "while authenticated contents reads for `tools/lib/subcmd/exec-cmd.zig`, `zigux/tests/phase8_exec_cmd.zig`, and `zigux/tests/phase8_exec_cmd_only_build.zig` remain intermittent from this environment.",
    ],
    "Documentation/zigux/phase8-libbpf-segment-survey.md": [
...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            ...
            "Documentation/zigux/phase8-tooling-lane-sequencing.md",
            "The next honest shared-surface reopen cue now starts with keeping this sequencing note truthful:",
            "The next honest shared-surface reopen cue now starts with keeping the sequencing note truthful:",
            "Documentation/zigux/phase8-tooling-lane-sequencing.md: The next honest shared-surface reopen cue now starts with keeping this sequencing note truthful:",
        ),
        (
            "lane_note_command_route_instability_anchor",
            "Documentation/zigux/phase8-tooling-lane-sequencing.md",
            "while authenticated contents reads for `tools/lib/subcmd/exec-cmd.zig`, `zigux/tests/phase8_exec_cmd.zig`, and `zigux/tests/phase8_exec_cmd_only_build.zig` remain intermittent from this environment.",
            "while authenticated contents reads for `tools/lib/subcmd/exec-cmd.zig` remain intermittent from this environment.",
            "Documentation/zigux/phase8-tooling-lane-sequencing.md: while authenticated contents reads for `tools/lib/subcmd/exec-cmd.zig`, `zigux/tests/phase8_exec_cmd.zig`, and `zigux/tests/phase8_exec_cmd_only_build.zig` remain intermittent from this environment.",
        ),
        (
