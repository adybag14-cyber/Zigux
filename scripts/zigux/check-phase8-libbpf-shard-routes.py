...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            "segment_survey_cpu_mask_anchor",
            "Documentation/zigux/phase8-libbpf-segment-survey.md",
            "`phase8_cpu_mask.zig`",
            "`phase8_cpu_mask_review.zig`",
        ...
        (
            ...
            "Documentation/zigux/phase8-libbpf-segment-survey.md",
            "`phase8_pin_path.zig`",
            "`phase8_pin_path_review.zig`",
            "Documentation/zigux/phase8-libbpf-segment-survey.md: `phase8_pin_path.zig`",
        ),
        (
            "segment_survey_file_path_handle_bridge_anchor",
            "Documentation/zigux/phase8-libbpf-segment-survey.md",
            "`phase8_file_path_handle_bridge.zig`",
        ...
        (
            "segment_survey_timing_boundary_anchor",
            "Documentation/zigux/phase8-libbpf-segment-survey.md",
            "this packet still keeps `standalone timer or clockevent helper behavior` and broader timeout-sensitive routing behavior out of scope",
            "this packet still keeps `standalone timer or clockevent helper behavior` and broader routing behavior out of scope",
            "Documentation/zigux/phase8-libbpf-segment-survey.md: this packet still keeps `standalone timer or clockevent helper behavior` and broader timeout-sensitive routing behavior out of scope",
        ),
        (
            "segment_survey_next_step_timeout_boundary_anchor",
            "Documentation/zigux/phase8-libbpf-segment-survey.md",
            "especially the explicit `standalone timer or clockevent helper behavior` and broader timeout-sensitive routing behavior boundaries that keep this packet smaller than the deferred interrupt-routing work.",
            "especially the explicit `standalone timer or clockevent helper behavior` and broader routing behavior boundaries that keep this packet smaller than the deferred interrupt-routing work.",
            "Documentation/zigux/phase8-libbpf-segment-survey.md: especially the explicit `standalone timer or clockevent helper behavior` and broader timeout-sensitive routing behavior boundaries that keep this packet smaller than the deferred interrupt-routing work.",
        ),
        (
        ...
        (
            "phase8_build_cpu_mask_helper_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/cpu_mask.zig"),',
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/cpu_mask_review.zig"),',
            f"{PHASE8_BUILD_PATH}: " + '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/cpu_mask.zig"),',
        ),
        (
            "phase8_build_cpu_mask_root_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("phase8_cpu_mask.zig"),',
            '.root_source_file = b.path("phase8_cpu_mask_review.zig"),',
            f"{PHASE8_BUILD_PATH}: " + '.root_source_file = b.path("phase8_cpu_mask.zig"),',
        ),
        (
            "phase8_build_logging_helper_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/logging.zig"),',
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/logging_review.zig"),',
            f"{PHASE8_BUILD_PATH}: " + '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/logging.zig"),',
        ),
        (
            "phase8_build_logging_root_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("phase8_logging.zig"),',
            '.root_source_file = b.path("phase8_logging_review.zig"),',
            f"{PHASE8_BUILD_PATH}: " + '.root_source_file = b.path("phase8_logging.zig"),',
        ),
        (
            "phase8_build_pin_path_helper_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/pin_path.zig"),',
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/pin_path_review.zig"),',
            f"{PHASE8_BUILD_PATH}: "
            + '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/pin_path.zig"),',
        ),
        (
            "phase8_build_pin_path_root_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("phase8_pin_path.zig"),',
            '.root_source_file = b.path("phase8_pin_path_review.zig"),',
            f"{PHASE8_BUILD_PATH}: " + '.root_source_file = b.path("phase8_pin_path.zig"),',
        ),
        (
            "phase8_build_type_names_helper_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/type_names.zig"),',
            '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/type_names_review.zig"),',
            f"{PHASE8_BUILD_PATH}: "
            + '.root_source_file = b.path("../../tools/lib/bpf/zigux_segments/type_names.zig"),',
        ),
        (
            "phase8_build_type_names_root_anchor",
            PHASE8_BUILD_PATH,
            '.root_source_file = b.path("phase8_bpf_type_names.zig"),',
            '.root_source_file = b.path("phase8_bpf_type_names_review.zig"),',
            f"{PHASE8_BUILD_PATH}: "
            + '.root_source_file = b.path("phase8_bpf_type_names.zig"),',
        ),
        (
