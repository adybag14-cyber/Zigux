...
def run_self_test() -> int:
    cases: list[tuple[str, object | None]] = [
        ...
        ("missing_lane_next_step", lambda root: mutate_remove_marker(root, PHASE1_LANE_NOTE_REL, EXPECTED_LANE_NOTE_MARKERS[1])),
        ...
        ("missing_tests_smoke_route", lambda root: mutate_remove_marker(root, TESTS_README_REL, EXPECTED_TESTS_README_MARKERS[11])),
