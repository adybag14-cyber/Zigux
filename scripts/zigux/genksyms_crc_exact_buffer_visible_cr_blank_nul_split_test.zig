...
test "lane19 exact-buffer visible-CR blank NUL split skips a blank visible-leading-carriage-return continuation before an embedded NUL and the next line still lands" {
