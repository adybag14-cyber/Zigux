...
test "genksyms bridge preserves repeated abbreviated version side effects before empty inline long reference arguments" {
...
test "genksyms bridge preserves repeated abbreviated version side effects before empty inline dump-types arguments" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
