...
EXPECTED_NEXT_SAFE_STEP_NOTES = {
    ...
    "tools/lib/rbtree.zig": (
        ...
        "cached-root alias, singleton-erase, replacement, detach, and reseed behavior stay owned "
        "by direct helper-local anchors until another committed cached-root field lands."
    ),
    "tools/lib/string.zig": (
