...
EXPECTED_LANE_NOTE_LINES = (
    ...
    "past-nbits, underscore-alias or Linux-style alias coverage including the shipped andnot "
    "scan entry points, or tail-word skip anchors, or for committed tail-clamped replay drift; "
