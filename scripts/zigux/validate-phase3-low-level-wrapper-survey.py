...
SELF_TEST_CASES = (
    ...
    (MMIO_PATH, "pub fn readScoped(comptime T: type, scope: abi.UnsafeScope, ptr: *const volatile T) PolicyError!T {"),
    (MMIO_PATH, "pub fn readInteropPolicy(comptime T: type, policy: abi.InteropPolicy, ptr: *const volatile T) PolicyError!T {"),
    (MMIO_PATH, 'test "phase3 mmio helper gates volatile access through typed unsafe scope" {'),
    (MMIO_PATH, 'test "phase3 mmio helper gates volatile access through interop policy records" {'),
    ...
    (NARROW_PATH, "pub fn allowsVolatileMmioInteropPolicy(policy: abi.InteropPolicy) bool {"),
    ...
    (WRAPPER_REPLAY_PATH, "mmio.writeMaskedInteropPolicyBytes("),
