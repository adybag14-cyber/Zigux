...
test "fixdep replays the concatenated-target fixture on the public entry path" {
    ...
    const expected_path = "../../zigux/tests/fixtures/fixdep/sample_concatenated_expected.txt";
