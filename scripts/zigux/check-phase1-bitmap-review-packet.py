...
EXPECTED_BITMAP_PACKET = {
    ...
    "next_safe_step_note": (
        ...
        "cross-word scnprintf, caller-window xor and or clamp, weighted tail-count clamp, empty-buffer, "
        "allocator-reset, zero-bit logical short-circuit, and Linux-style alias mirror anchors here, "
        "and if the separate bitmap closure-validator anchor-sync repair is still outstanding, treat "
