...
def run_self_test() -> int:
    ...
    bad_helper_duplicate_lines[2] = (
        ...
        'cli_help_output,cli_missing_required_args,cli_missing_actual_operand,'
        'cli_invalid_mode,invalid_mode_rejected'
    )
    expect_assertion(
        'helper_summary_duplicate_case_drift',
