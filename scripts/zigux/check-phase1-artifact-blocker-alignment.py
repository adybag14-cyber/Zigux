...
def build_sample_root(root: Path) -> None:
    ...
    (root / "zigux/tests/fixtures/phase1_helper_manifest.json").write_text(json.dumps(json.loads(read_text(root, "zigux/tests/fixtures/phase1_helper_manifest.json")), indent=2) + "\n", encoding="utf-8")
    (root / "zigux/tests/fixtures/phase1_replay_blockers.json").write_text(json.dumps(json.loads(read_text(root, "zigux/tests/fixtures/phase1_replay_blockers.json")), indent=2) + "\n", encoding="utf-8")
    (root / "zigux/tests/fixtures/phase1_helpers.json").write_text(json.dumps(json.loads(read_text(root, "zigux/tests/fixtures/phase1_helpers.json")), separators=(",", ":")) + "\n", encoding="utf-8")
