...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            "build_string_helpers_direct_step_name",
            "zigux/tests/phase7_build.zig",
            "\"phase7-string-helpers-test\",",
            "\"phase7-string-helpers-drift-test\",",
            "zigux/tests/phase7_build.zig: \"phase7-string-helpers-test\",",
        ),
        (
            "build_string_helpers_direct_step_dependson",
            "zigux/tests/phase7_build.zig",
            "string_helpers_step.dependOn(&run_string_helpers_tests.step);",
            "",
            "zigux/tests/phase7_build.zig: string_helpers_step.dependOn(&run_string_helpers_tests.step);",
        ),
        (
        ...
        (
            ...
            "zigux/Makefile",
            "PHONY += phase7-validate phase7-string-helpers-test phase7-string-helpers-survey phase7-string-helpers-sample-boundary phase7-cmdline-test phase7-cmdline-survey phase7-argv-split-test phase7-argv-split-survey phase7-rbtree-test phase7-rbtree-survey phase7-test phase7",
            "PHONY += phase7-validate phase7-string-helpers-test phase7-string-helpers-survey phase7-string-helpers-sample-boundary phase7-cmdline-test phase7-cmdline-survey phase7-argv-split-test phase7-argv-split-survey phase7-rbtree-test phase7-rbtree-survey phase7",
            "zigux/Makefile: PHONY += phase7-validate phase7-string-helpers-test phase7-string-helpers-survey phase7-string-helpers-sample-boundary phase7-cmdline-test phase7-cmdline-survey phase7-argv-split-test phase7-argv-split-survey phase7-rbtree-test phase7-rbtree-survey phase7-test phase7",
        ),
        (
            "makefile_string_helpers_test_route",
            "zigux/Makefile",
            "phase7-string-helpers-test:",
            "",
            "zigux/Makefile: phase7-string-helpers-test:",
        ),
        (
        ...
        (
            "makefile_cmdline_test_route",
            "zigux/Makefile",
            "phase7-cmdline-test:",
            "",
            "zigux/Makefile: phase7-cmdline-test:",
        ),
        (
        ...
        (
            "makefile_argv_split_test_route",
            "zigux/Makefile",
            "phase7-argv-split-test:",
            "",
            "zigux/Makefile: phase7-argv-split-test:",
        ),
        (
        ...
        (
            "makefile_rbtree_test_route",
            "zigux/Makefile",
            "phase7-rbtree-test:",
            "",
            "zigux/Makefile: phase7-rbtree-test:",
        ),
        (
