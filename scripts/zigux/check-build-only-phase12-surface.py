...
def run_self_test() -> int:
    ...
    print("PHASE12_BUILD_ONLY_SURFACE_SELF_TEST_CASE_COUNT=4")
    return 0
...
def main() -> int:
    ...
    print(
        ...
        f"{len(REQUIRED_DOCS_README_MARKERS) + len(REQUIRED_SCRIPT_README_MARKERS) + len(REQUIRED_TESTS_README_MARKERS) + len(REQUIRED_MAKEFILE_MARKERS) + len(FORBIDDEN_LITERAL_COUNTS)}"
    )
    return 0
