...
REQUIRED_MARKERS = {
    ...
    RAW_GITHUB_COVERAGE_SURVEY_PATH: [
        ...
        "`scripts/zigux/check-phase12-release-readiness-packet.py` at blob `ecacc0e59dc6e37401d74cd9e51531a98de651eb`",
        "`.github/workflows/zigux-bootstrap.yml` at blob `e07b69eaf4070b83f943e1ad41cf1a47bdc532fa`",
        "`scripts/zigux/README.md` at blob `d7b581d3be679a9251586b8ff4e3dc489111b552`",
        "`zigux/Makefile` at blob `e4808be93a31e91e0c72c3cdb1c4a48275caf3ed`",
