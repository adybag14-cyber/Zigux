...
MARKERS = {
    ...
    "lane_note": [
        ...
        "Keep the HVC delivery-gate lane honest: on current `master` the landed HVC archival packet is the teardown note, validation matrix, survey note, manifest-backed survey gate, modem-control split, poll-retry split, sysrq helper, and dedicated `phase11-hvc-survey` route, while direct `zigux/tests/phase11_hvc_console.zig`, `zigux/tests/phase11_hvc_cleanup.zig`, and `drivers/tty/hvc/hvc_console_verify.zig` remain repo-reality gaps rather than landed packet evidence.",
    ],
}
