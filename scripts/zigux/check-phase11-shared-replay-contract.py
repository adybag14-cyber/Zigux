...
MARKERS = {
    ...
    "closure_note": [
        ...
        "* DesignWare watchdog continuity now stays with `Documentation/zigux/phase11-dw-wdt-platform-registration-plan.md`, `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`, `Documentation/zigux/phase11-dw-wdt-survey.md`, `Documentation/zigux/phase11-dw-wdt-teardown-note.md`, `scripts/zigux/check-phase11-dw-wdt-packet.py`, `zigux/tests/phase11_dw_wdt_manifest.json`, `zigux/tests/phase11_dw_wdt.zig`, `zigux/tests/phase11_dw_wdt_registration_scaffold.zig`, `zigux/tests/phase11_dw_wdt_survey.zig`, and `drivers/watchdog/dw_wdt_verify.zig`, which together keep the landed starter, survey, teardown-parity, and matrix evidence explicit while platform-backed registration remains the next bounded DesignWare step rather than shared closure evidence",
    ...
    "lane_note": [
        ...
        "- DesignWare lane `P11-L05` currently owns `Documentation/zigux/phase11-dw-wdt-platform-registration-plan.md`, `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`, `Documentation/zigux/phase11-dw-wdt-survey.md`, `Documentation/zigux/phase11-dw-wdt-teardown-note.md`, `scripts/zigux/check-phase11-dw-wdt-packet.py`, `zigux/tests/phase11_dw_wdt_manifest.json`, `zigux/tests/phase11_dw_wdt.zig`, `zigux/tests/phase11_dw_wdt_registration_scaffold.zig`, `zigux/tests/phase11_dw_wdt_survey.zig`, and `drivers/watchdog/dw_wdt_verify.zig` as the landed bounded DesignWare packet; the next same-lane follow-through is platform-backed registration scaffolding rather than shared reminder churn",
        ...
        "Keep the DesignWare lane honest: on current `master` the landed DesignWare lane evidence is `Documentation/zigux/phase11-dw-wdt-platform-registration-plan.md`, `Documentation/zigux/phase11-dw-wdt-validation-matrix.md`, `Documentation/zigux/phase11-dw-wdt-survey.md`, `Documentation/zigux/phase11-dw-wdt-teardown-note.md`, `scripts/zigux/check-phase11-dw-wdt-packet.py`, `zigux/tests/phase11_dw_wdt_manifest.json`, `zigux/tests/phase11_dw_wdt.zig`, `zigux/tests/phase11_dw_wdt_registration_scaffold.zig`, `zigux/tests/phase11_dw_wdt_survey.zig`, and `drivers/watchdog/dw_wdt_verify.zig`, and the next bounded step is platform-backed registration scaffolding rather than pretending those shipped packet surfaces are still missing.",
        "Keep the HVC split honest: on current `master` the landed HVC archival packet is the teardown note, validation matrix, survey note, manifest-backed survey gate, modem-control split, poll-retry split, sysrq helper, and dedicated `phase11-hvc-survey` route, while direct driver-file follow-through now stays on `P11-Y04` inside `drivers/tty/hvc/hvc_console.zig` plus at most one directly coupled teardown-note wording repair. Do not reopen the archival survey gate, modem-control split, poll-retry split, sysrq helper, or shared reminder packet from that driver-only lane unless those exact packet surfaces are the thing moving.",
    ],
}
...
def run_self_test() -> None:
    ...
    try:
        ...
        cases = [
            ...
            (FILES["note"], "The DesignWare watchdog lane now keeps its landed bounded evidence explicit beside that shared route:"),
            ...
            (FILES["note"], "* `Documentation/zigux/phase11-dw-wdt-survey.md`"),
            (FILES["note"], "* `Documentation/zigux/phase11-dw-wdt-teardown-note.md`"),
            (FILES["note"], "* `scripts/zigux/check-phase11-dw-wdt-packet.py`"),
            (FILES["note"], "* `zigux/tests/phase11_dw_wdt_manifest.json`"),
            (FILES["note"], "* `zigux/tests/phase11_dw_wdt_survey.zig`"),
            ...
            (FILES["closure_note"], "* HVC archival continuity stays with `Documentation/zigux/phase11-hvc-console-slice.md`, `Documentation/zigux/phase11-hvc-console-validation-matrix.md`, `Documentation/zigux/phase11-hvc-console-survey.md`, `Documentation/zigux/phase11-hvc-console-teardown-note.md`, `zigux/tests/phase11_hvc_console_modem_control_split.zig`, `zigux/tests/phase11_hvc_console_poll_retry_split.zig`, `drivers/tty/hvc/hvc_console_sysrq.zig`, `scripts/zigux/check-phase11-hvc-survey-packet.py`, `zigux/tests/phase11_hvc_console_manifest.json`, `zigux/tests/phase11_hvc_console_survey.zig`, and `make -C zigux phase11-hvc-survey`, while direct `zigux/tests/phase11_hvc_console.zig`, `zigux/tests/phase11_hvc_cleanup.zig`, and `drivers/tty/hvc/hvc_console_verify.zig` stay framed as the remaining repo-reality gaps rather than shared closure evidence"),
            ...
            (FILES["lane_note"], "Keep the HVC split honest: on current `master` the landed HVC archival packet is the teardown note, validation matrix, survey note, manifest-backed survey gate, modem-control split, poll-retry split, sysrq helper, and dedicated `phase11-hvc-survey` route, while direct driver-file follow-through now stays on `P11-Y04` inside `drivers/tty/hvc/hvc_console.zig` plus at most one directly coupled teardown-note wording repair. Do not reopen the archival survey gate, modem-control split, poll-retry split, sysrq helper, or shared reminder packet from that driver-only lane unless those exact packet surfaces are the thing moving."),
            ...
            ("Documentation/zigux/phase11-dw-wdt-validation-matrix.md", "Documentation/zigux/phase11-dw-wdt-validation-matrix.md"),
            ...
            ("zigux/tests/phase11_dw_wdt_survey.zig", "zigux/tests/phase11_dw_wdt_survey.zig"),
