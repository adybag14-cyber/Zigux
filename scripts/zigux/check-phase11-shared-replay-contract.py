...
def run_self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="zigux_phase11_shared_contract_") as tmp:
        ...
        mutations = (
            ...
            ("phase11-note", NOTE_PATH, "* `zigux/tests/phase11_hvc_cleanup.zig`"),
            ("phase11-note", NOTE_PATH, "* `drivers/tty/hvc/hvc_console_verify.zig`"),
            ("phase11-note", NOTE_PATH, "* `make -C zigux phase11-hvc-survey`"),
