...
- `make -C zigux phase4-validate` reruns the validator-first Phase 4 route, including `scripts/zigux/check-artifact-diff-contract.py` and `scripts/zigux/check-phase4-gate-evidence.py`, before the shared `zigux/tests/phase4_build.zig` replay.
