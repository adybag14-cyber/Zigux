...
- `phase3_catalog.py --suggest-slug-merge-plans` groups those rename candidates by canonical slice and reports the slice docs plus any extra docs, wrapper scripts, fixture artifacts, dump entrypoints, and `zigux/tests/build.zig` references that a real family merge would need to touch.
