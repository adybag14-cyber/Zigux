...
test "first 32-bit ELF header stays authoritative with mixed trailing header-plus-failure-plus-fragment cluster" {
    const input = elf32_header ++ elf64_header ++ invalid_class_header ++ elf64_fragment;
...
test "first 64-bit ELF header stays authoritative with mixed trailing header-plus-failure-plus-fragment cluster" {
    const input = elf64_header ++ elf32_header ++ not_elf_header ++ elf32_fragment;
...
test "first invalid-class header stays authoritative with mixed trailing header-plus-failure-plus-fragment cluster" {
    const input = invalid_class_header ++ elf32_header ++ not_elf_header ++ elf64_fragment;
...
test "first non-ELF header stays authoritative with mixed trailing header-plus-failure-plus-fragment cluster" {
    const input = not_elf_header ++ elf64_header ++ invalid_class_header ++ elf32_fragment;
