...
const EXPECTED_REPLAY_ROUTES = [_][]const u8{
    "zig run check_phase9_catalog_selftest.zig --self-test",
    "zig run check_phase9_catalog_selftest.zig",
    "zig run scripts/zigux/phase9_catalog.zig --pretty",
    "zig run validate_phase9.zig --self-test",
    "zig run validate_phase9.zig",
    "zig run check_phase9_runtime_loader_shared_packet.zig --self-test",
    "zig run check_phase9_runtime_loader_shared_packet.zig",
    "zig run check_phase9_atomic64_runtime_packet.zig --self-test",
    "zig run check_phase9_atomic64_runtime_packet.zig",
    ...
    "zig run check_phase9_kretprobe_runtime_packet.zig --self-test",
    "zig run check_phase9_kretprobe_runtime_packet.zig",
