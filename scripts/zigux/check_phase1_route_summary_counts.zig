...
const EXACT_LINE_MARKERS_ENTRIES = [_]struct { file: []const u8, marker: []const u8 }{
    ...
    .{ .file = "Documentation/zigux/README.md", .marker = "  * `zig run scripts/zigux/validate_phase1_closure.zig`, `zig run scripts/zigux/check_phase1_string_review_packet.zig -- --self-test`, `zig run scripts/zigux/check_phase1_direct_owner_markers.zig -- --self-test`, `zig run scripts/zigux/check_phase1_bench.zig -- --self-test`, and `zig run scripts/zigux/check_phase1_shared_reminder_packet.zig -- --self-test` replay the bounded current reminder checks, while the live checker routes guard the shipped Phase 1 packet without widening it back into the older closure-side or installer-companion stack." },
    .{ .file = "Documentation/zigux/phase1-closure.md", .marker = "- `PHASE1_CLOSURE_VALIDATOR=zig run scripts/zigux/validate_phase1_closure.zig`" },
    .{ .file = "Documentation/zigux/phase1-closure.md", .marker = "- `PHASE1_ROUTE_SUMMARY_GUARD=zig run scripts/zigux/check_phase1_route_summary_counts.zig`" },
    ...
    .{ .file = ".github/workflows/zigux-bootstrap.yml", .marker = "run: zig run scripts/zigux/check_phase1_route_summary_counts.zig -- --self-test" },
    .{ .file = ".github/workflows/zigux-bootstrap.yml", .marker = "run: zig run scripts/zigux/check_phase1_route_summary_counts.zig" },
    .{ .file = ".github/workflows/zigux-bootstrap.yml", .marker = "run: zig run scripts/zigux/check_phase1_bench.zig -- --self-test" },
