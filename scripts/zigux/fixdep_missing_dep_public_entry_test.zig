...
test "fixdep surfaces the shipped missing-dependency failure on the public entry path" {
    const depfile_path = "zigux/tests/fixtures/fixdep/sample_missing_dep.d";
    const target = "sample_missing_dep.o";
    const cmdline = "clang -c zigux/tests/fixtures/fixdep/sample_missing_dep_source.c -o sample_missing_dep.o";
    const expected_stdout_path = "../../zigux/tests/fixtures/fixdep/sample_missing_dep_expected.txt";
