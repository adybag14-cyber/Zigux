#!/usr/bin/env python3
"""Guard the current Phase 1 closure-gates packet against cross-surface drift."""
...
REQUIRED_EXACT_LINES = {
    PHASE1_CLOSURE_REL: {
        ...
        "shared_reminder_checker_listed": "- `scripts/zigux/check-phase1-shared-reminder-packet.py`",
        "closure_validator_listed": "- `scripts/zigux/validate-phase1-closure.py`",
        "workflow_listed": "- `.github/workflows/zigux-bootstrap.yml`",
    ...
    CLOSURE_VALIDATOR_REL: {
        "phase1_closure_rel": 'PHASE1_CLOSURE_REL = Path("Documentation/zigux/phase1-closure.md")',
        "workflow_rel": 'WORKFLOW_REL = Path(".github/workflows/zigux-bootstrap.yml")',
        "route_summary_checker_rel": 'ROUTE_SUMMARY_CHECKER_REL = Path("scripts/zigux/check-phase1-route-summary-counts.py")',
        "bench_checker_rel": 'BENCH_CHECKER_REL = Path("scripts/zigux/check-phase1-bench.py")',
        "shared_reminder_checker_rel": 'SHARED_REMINDER_CHECKER_REL = Path("scripts/zigux/check-phase1-shared-reminder-packet.py")',
        "closure_validator_marker": '"closure_validator": "`PHASE1_CLOSURE_VALIDATOR=python3 scripts/zigux/validate-phase1-closure.py`",',
        "route_summary_marker": '"route_summary_guard": "`PHASE1_ROUTE_SUMMARY_GUARD=python3 scripts/zigux/check-phase1-route-summary-counts.py`",',
        "shared_tests_marker": '"shared_tests_route": "`PHASE1_SHARED_TESTS_ROUTE=zig build phase1-host-tools-smoke --build-file zigux/tests/build.zig`",',
        "validator_state_marker": '"validator_state": "`PHASE1_CLOSURE_VALIDATOR_STATE=available_current_master`",',
        "bench_delegate": '(BENCH_CHECKER_REL, "phase1-bench"),',
        "shared_reminder_delegate": '(SHARED_REMINDER_CHECKER_REL, "phase1-shared-reminder-packet"),',
    },
    WORKFLOW_REL: {
