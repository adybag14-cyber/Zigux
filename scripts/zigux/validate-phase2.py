...
REQUIRED_PATHS = (
    ...
    "scripts/zigux/check-phase2-toolchain-policy-env-packet.py",
    "scripts/zigux/check-phase2-toolchain-route-packet.py",
    "scripts/zigux/check-phase2-toolchain-wrapper-sequence.py",
    "scripts/zigux/check-phase2-toolchain-setup-packet.py",
    "scripts/zigux/check-phase2-toolchain-verification-packet.py",
    "scripts/zigux/check-phase2-toolchain-installer-packet.py",
    "scripts/zigux/check-phase2-toolchain-installer-retry-packet.py",
    "scripts/zigux/check-phase2-toolchain-archive-resolution-packet.py",
    "scripts/zigux/check-phase2-toolchain-selftest-alignment.py",
    "scripts/zigux/check-phase2-toolchain-status-surface.py",
    "scripts/zigux/check-phase2-toolchain-zig-resolution-packet.py",
...
REQUIRED_WORKFLOW_LINES = (
    ...
    "run: python3 scripts/zigux/check-phase2-toolchain-policy-env-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-policy-env-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-route-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-route-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-wrapper-sequence.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-wrapper-sequence.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-setup-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-setup-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-verification-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-verification-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-installer-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-installer-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-installer-retry-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-installer-retry-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-archive-resolution-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-archive-resolution-packet.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-selftest-alignment.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-selftest-alignment.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-status-surface.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-status-surface.py",
    "run: python3 scripts/zigux/check-phase2-toolchain-zig-resolution-packet.py --self-test",
    "run: python3 scripts/zigux/check-phase2-toolchain-zig-resolution-packet.py",
...
REQUIRED_MAKEFILE_LINES = (
    ...
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-route-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-route-packet.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-wrapper-sequence.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-wrapper-sequence.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-setup-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-setup-packet.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-verification-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-verification-packet.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-installer-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-installer-packet.py",
    ...
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-archive-resolution-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-archive-resolution-packet.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-selftest-alignment.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-selftest-alignment.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-status-surface.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-status-surface.py",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-zig-resolution-packet.py --self-test",
    "$(PYTHON) $(PHASE2_SCRIPT_ROOT)/check-phase2-toolchain-zig-resolution-packet.py",
    "phase2-tools:",
