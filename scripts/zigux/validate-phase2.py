...
def validate_root(root: Path) -> list[str]:
    ...
    guard_issues.extend(
        run_guard(
            ...
            [
                ...
                "PHASE2_GENKSYMS_BRIDGE_SELFTEST_ALIGNMENT_SELF_TEST_CASE_COUNT=18",
            ],
        )
    )
    guard_issues.extend(
    ...
    guard_issues.extend(
        run_guard(
            ...
            ["PHASE2_TESTS_README_ALIGNMENT_SELF_TEST=pass", "PHASE2_TESTS_README_ALIGNMENT_SELF_TEST_CASE_COUNT=101"],
        )
    )
    guard_issues.extend(
        run_guard(
    ...
    guard_issues.extend(
        run_guard(
            ...
            ["PHASE2_KCONFIG_ALIGNMENT_SELF_TEST=pass", "PHASE2_KCONFIG_ALIGNMENT_SELF_TEST_CASE_COUNT=48"],
        )
    )
    guard_issues.extend(
        run_guard(
