...
DOC_MARKERS = {
    "docs_root_phase1_packet": [
        ...
        "the closure, the shared owner-map note, the installer-backed workflow-viability replay, the dedicated installer-review alignment checker, bootstrap-workflow replay, and validator-first contract explicit from the docs root",
    ],
