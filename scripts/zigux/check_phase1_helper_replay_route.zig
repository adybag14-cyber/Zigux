// Ported from check-phase1-helper-replay-route.py by port_phase1_guards.py
const std = @import("std");
const Io = std.Io;
const guard = @import("zigux_guard.zig");

pub const pass_marker = "PHASE1_HELPER_REPLAY_ROUTE_SELF_TEST=pass";
...
pub fn main(init: std.process.Init) !void {
    ...
    if (failures.items.len > 0) {
        try guard.printLine(io, "PHASE1_HELPER_REPLAY_ROUTE_SELF_TEST=fail", .{});
