...
test "caret-prefixed tokens after positionals remain request argv data" {
...
test "caret-prefixed required option values after positionals remain data" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
...
test "caret-prefixed terminator tails stay out of parser state" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
