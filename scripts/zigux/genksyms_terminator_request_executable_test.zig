...
test "genksyms executable preserves option terminator request argv" {
    ...
    const exe_path = try std.fmt.bufPrint(
        &exe_path_buffer,
        ".zig-cache/tmp/{s}/genksyms-terminator-request",
        .{tmp.sub_path},
    );
    ...
    try testing.expectEqualStrings(
        "{\"tool\":\"scripts/genksyms/genksyms\",\"stdin\":\"cpp-stream\",\"stdout\":\"symversions\",\"argv\":[\"scripts/genksyms/genksyms\",\"--debug\",\"--warnings\",\"first-input.c\",\"--\",\"--version\",\"-d\",\"tail-input.h\"],\"options\":{\"debug_level\":1,\"warnings\":true,\"dump_defs\":false,\"preserve\":false,\"reference_files\":[],\"dump_types_file\":null}}\n",
        run_result.stdout,
    );
}
