...
def collect_issues(root: Path) -> list[tuple[str, str]]:
    ...
    issues = [
        ("MISSING_BOOTSTRAP_NOTE_MARKERS", marker)
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Write a minimal passing sample tree for scratch validation",
    )
