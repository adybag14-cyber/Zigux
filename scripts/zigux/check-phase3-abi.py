...
SELF_TEST_CASES = (
    ...
    (ABI_TEST, 'test "phase3 abi keeps export-shim version validation and dev_t roundtrip relays explicit" {'),
    (ABI_TEST, 'test "phase3 abi keeps Linux-facing header-family relays aligned with the shared ABI helpers" {'),
