#!/usr/bin/env python3
"""Guard the live Phase 2 bootstrap make-route note against workflow drift."""
...
def collect_workflow_line_issues(text: str) -> list[tuple[str, str]]:
    issues: list[tuple[str, str]] = []
...
def collect_issues(root: Path) -> list[tuple[str, str]]:
    ...
    issues.extend(collect_workflow_line_issues(workflow_text))
    return issues
