...
test "repeated abbreviated version survives before rendered plan with long options" {
...
test "repeated abbreviated version survives before rendered plan with reordered positional args" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
