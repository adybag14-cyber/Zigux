...
pub const live_pass_marker = "PHASE4_GAP_SURVEY_NOTES=pass";
pub const self_test_pass_marker = "PHASE4_GAP_SURVEY_NOTES_SELF_TEST=pass";
...
fn checkRepo(io: Io, allocator: std.mem.Allocator, root: []const u8) !void {
    const text_expected_self_test_cases_path = try guard.joinPath(allocator, root, "Documentation/zigux/phase4-kprobe-example-gap-survey.md");
