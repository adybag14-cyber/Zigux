...
test "genksyms bridge preserves repeated abbreviated version side effects before lone-dash positional passthrough" {
...
test "genksyms bridge preserves repeated abbreviated version side effects before later positional passthrough" {
    var arena_state = std.heap.ArenaAllocator.init(testing.allocator);
    defer arena_state.deinit();
