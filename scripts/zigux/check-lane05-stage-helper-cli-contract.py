...
ONE_OF_NOTE = "exactly one of --source or --parts-dir is required unless --self-test is used"
...
def check_helper(root: Path) -> int:
    ...
    require_exact_count(helper_text, SELF_TEST_SOURCE_ASSERT, 3, "source self-test assertion")
