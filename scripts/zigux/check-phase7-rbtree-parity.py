...
REQUIRED_MARKERS = {
    ...
    "zigux/tests/phase7_rbtree_manifest.json": [
        ...
        '"zigux_destination": "zigux/tests/phase7_build.zig"',
        '"zigux_destination": "lib/rbtree.zig"',
        '"zigux_destination": "zigux/tests/phase7_rbtree.zig"',
        '"zigux_destination": "Documentation/zigux/phase7-rbtree-slice.md"',
        '"zigux_destination": "zigux/tests/phase7_rbtree_survey.zig"',
...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            "manifest_build_destination_marker",
            "zigux/tests/phase7_rbtree_manifest.json",
            '"zigux_destination": "zigux/tests/phase7_build.zig"',
            "",
            'zigux/tests/phase7_rbtree_manifest.json: "zigux_destination": "zigux/tests/phase7_build.zig"',
        ),
        (
            "manifest_tests_destination_marker",
            "zigux/tests/phase7_rbtree_manifest.json",
            '"zigux_destination": "zigux/tests/phase7_rbtree.zig"',
            "",
            'zigux/tests/phase7_rbtree_manifest.json: "zigux_destination": "zigux/tests/phase7_rbtree.zig"',
        ),
        (
            "manifest_slice_destination_marker",
            "zigux/tests/phase7_rbtree_manifest.json",
            '"zigux_destination": "Documentation/zigux/phase7-rbtree-slice.md"',
            "",
            'zigux/tests/phase7_rbtree_manifest.json: "zigux_destination": "Documentation/zigux/phase7-rbtree-slice.md"',
        ),
        (
            "manifest_survey_destination_marker",
            "zigux/tests/phase7_rbtree_manifest.json",
            '"zigux_destination": "zigux/tests/phase7_rbtree_survey.zig"',
            "",
            'zigux/tests/phase7_rbtree_manifest.json: "zigux_destination": "zigux/tests/phase7_rbtree_survey.zig"',
        ),
        (
        ...
        (
            "helper_impl_linked_type_marker",
            "lib/rbtree.zig",
            "pub const NodeLinked",
            "",
        ...
        (
            ...
            "pub fn clearLinkedNode",
            "",
            "lib/rbtree.zig: pub fn clearLinkedNode",
        ),
        (
            "helper_impl_add_linked_marker",
            "lib/rbtree.zig",
            "pub fn addLinked",
            "",
        ...
        (
            ...
            "pub fn eraseLinked",
            "",
            "lib/rbtree.zig: pub fn eraseLinked",
        ),
        (
