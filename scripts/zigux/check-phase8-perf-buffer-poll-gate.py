...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        (
            "bridge_note_boundary",
            "Documentation/zigux/phase8-userspace-kernel-bridge-boundary-survey.md",
            "perf-buffer-online-cpu-routing",
            "perf-buffer-routing",
            "Documentation/zigux/phase8-userspace-kernel-bridge-boundary-survey.md: perf-buffer-online-cpu-routing",
        ),
        (
            "scripts_readme_checker",
            "scripts/zigux/README.md",
            "scripts/zigux/check-phase8-perf-buffer-poll-gate.py",
            "scripts/zigux/check-phase8-perf-buffer-poll-surface.py",
            "scripts/zigux/README.md: scripts/zigux/check-phase8-perf-buffer-poll-gate.py",
        ),
        (
            "makefile_checker_selftest",
            "zigux/Makefile",
            "scripts/zigux/check-phase8-perf-buffer-poll-gate.py --self-test",
            "scripts/zigux/check-phase8-perf-buffer-poll-surface.py --self-test",
        ...
        (
            ...
            "make -C zigux phase8-perf-buffer-poll-test",
            "make -C zigux phase8-poll-test",
            "zigux/tests/README.md: make -C zigux phase8-perf-buffer-poll-test",
        ),
        (
            "poll_test_guard",
            "zigux/tests/phase8_perf_buffer_poll.zig",
        ...
        (
            "scripts_readme_phase8_section_route_once",
            "scripts/zigux/README.md",
            "make -C zigux phase8-perf-buffer-poll-test",
            "make -C zigux phase8-perf-buffer-poll-test\nmake -C zigux phase8-perf-buffer-poll-test",
            "scripts/zigux/README.md: exact_once_section_marker:make -C zigux phase8-perf-buffer-poll-test",
        ),
    ]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate the current Phase 8 perf-buffer poll review packet."
    )
    parser.add_argument(
        "--self-test",
        action="store_true",
    ...
    print(
        "PHASE8_PERF_BUFFER_POLL_REQUIRED_MARKER_COUNT="
