...
ORDERED_STEPS = (
    ...
    WORKFLOW_SLOT_SELF_TEST_STEP,
    WORKFLOW_SLOT_CHECK_STEP,
...
def run_self_test() -> int:
    cases: list[tuple[str, tuple[str, ...] | None]] = [
        ...
        ("missing_workflow_slot_self_test", ("remove", WORKFLOW_SLOT_SELF_TEST_STEP)),
        ("missing_workflow_slot_check", ("remove", WORKFLOW_SLOT_CHECK_STEP)),
        ...
        ("duplicate_workflow_slot_step", ("duplicate", WORKFLOW_SLOT_CHECK_STEP)),
        ("workflow_slot_order_swap", ("swap", WORKFLOW_SLOT_CHECK_STEP, ORDERED_STEPS[19])),
