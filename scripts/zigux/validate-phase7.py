...
REQUIRED_MARKERS = {
    ...
    "zigux/tests/phase7_string_helpers_manifest.json": [
        ...
        "\"phase7-string-helpers-helper\"",
        "\"phase7-string-helpers-dedicated-tests\"",
...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        ("string_helpers_manifest_helper_gap", "zigux/tests/phase7_string_helpers_manifest.json", "\"phase7-string-helpers-helper\"", "", "zigux/tests/phase7_string_helpers_manifest.json: \"phase7-string-helpers-helper\""),
        ("string_helpers_manifest_dedicated_tests_gap", "zigux/tests/phase7_string_helpers_manifest.json", "\"phase7-string-helpers-dedicated-tests\"", "", "zigux/tests/phase7_string_helpers_manifest.json: \"phase7-string-helpers-dedicated-tests\""),
        ("string_helpers_manifest_missing_on_master_status", "zigux/tests/phase7_string_helpers_manifest.json", "\"status\": \"missing_on_master\"", "\"status\": \"starter_landed\"", "zigux/tests/phase7_string_helpers_manifest.json: \"status\": \"missing_on_master\""),
