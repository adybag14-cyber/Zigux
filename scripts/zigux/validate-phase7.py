...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        ("argv_split_survey_vector_sizing_marker", "zigux/tests/phase7_argv_split_survey.zig", "phase 7 argvSplit keeps the exported C argv vector sized to argc plus one sentinel", "", "zigux/tests/phase7_argv_split_survey.zig: phase 7 argvSplit keeps the exported C argv vector sized to argc plus one sentinel"),
        ("argv_split_survey_final_token_marker", "zigux/tests/phase7_argv_split_survey.zig", "phase 7 argvSplit keeps the final token C-string terminator and trailing argv sentinel aligned", "", "zigux/tests/phase7_argv_split_survey.zig: phase 7 argvSplit keeps the final token C-string terminator and trailing argv sentinel aligned"),
        ("argv_split_survey_distinct_callers_marker", "zigux/tests/phase7_argv_split_survey.zig", "phase 7 non-blank argvSplit calls keep owned storage and C-argv views distinct across callers", "", "zigux/tests/phase7_argv_split_survey.zig: phase 7 non-blank argvSplit calls keep owned storage and C-argv views distinct across callers"),
        ("argv_split_survey_cross_caller_teardown_marker", "zigux/tests/phase7_argv_split_survey.zig", "phase 7 argvFree on one live split result does not disturb another caller", "", "zigux/tests/phase7_argv_split_survey.zig: phase 7 argvFree on one live split result does not disturb another caller"),
