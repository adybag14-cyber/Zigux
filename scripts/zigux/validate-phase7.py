...
def run_self_test() -> None:
    ...
    marker_cases = [
        ...
        ("review_checklist_phase7_make_wrapper_marker", "Documentation/zigux/review-checklist.md", "scripts/zigux/check-phase7-make-wrapper.py", "", "Documentation/zigux/review-checklist.md: scripts/zigux/check-phase7-make-wrapper.py"),
        ("review_checklist_phase7_argv_split_packet_marker", "Documentation/zigux/review-checklist.md", "scripts/zigux/check-phase7-argv-split-packet.py", "", "Documentation/zigux/review-checklist.md: scripts/zigux/check-phase7-argv-split-packet.py"),
        ("review_checklist_phase7_string_helpers_boundary_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_string_helpers_sample_boundary.zig", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_string_helpers_sample_boundary.zig"),
        ("review_checklist_phase7_cmdline_survey_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_cmdline_survey.zig", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_cmdline_survey.zig"),
        ("review_checklist_phase7_cmdline_fixture_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/fixtures/phase7_cmdline_next_arg_vectors.zig", "", "Documentation/zigux/review-checklist.md: zigux/tests/fixtures/phase7_cmdline_next_arg_vectors.zig"),
        ("review_checklist_phase7_argv_split_survey_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_argv_split_survey.zig", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_argv_split_survey.zig"),
        ("review_checklist_phase7_argv_split_manifest_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_argv_split_manifest.json", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_argv_split_manifest.json"),
        ("review_checklist_phase7_rbtree_survey_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_rbtree_survey.zig", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_rbtree_survey.zig"),
        ("review_checklist_phase7_rbtree_manifest_marker", "Documentation/zigux/review-checklist.md", "zigux/tests/phase7_rbtree_manifest.json", "", "Documentation/zigux/review-checklist.md: zigux/tests/phase7_rbtree_manifest.json"),
        ...
        ("review_checklist_phase7_validate_command_marker", "Documentation/zigux/review-checklist.md", "make -C zigux phase7-validate", "", "Documentation/zigux/review-checklist.md: make -C zigux phase7-validate"),
        ("review_checklist_phase7_make_command_marker", "Documentation/zigux/review-checklist.md", "make -C zigux phase7", "", "Documentation/zigux/review-checklist.md: make -C zigux phase7"),
        ...
        ("docs_readme_phase7_notes_marker", "Documentation/zigux/README.md", "Phase 7 notes -", "", "Documentation/zigux/README.md: Phase 7 notes -"),
        ("docs_readme_phase7_argv_split_slice_marker", "Documentation/zigux/README.md", "Documentation/zigux/phase7-argv-split-slice.md", "", "Documentation/zigux/README.md: Documentation/zigux/phase7-argv-split-slice.md"),
        ...
        ("docs_readme_phase7_validate_marker", "Documentation/zigux/README.md", "`make -C zigux phase7-validate`", "", "Documentation/zigux/README.md: `make -C zigux phase7-validate`"),
        ...
        ("tests_readme_phase7_docs_root_marker", "zigux/tests/README.md", "Documentation/zigux/README.md", "", "zigux/tests/README.md: Documentation/zigux/README.md"),
        ("tests_readme_phase7_scripts_root_marker", "zigux/tests/README.md", "scripts/zigux/README.md", "", "zigux/tests/README.md: scripts/zigux/README.md"),
        ("tests_readme_phase7_validator_marker", "zigux/tests/README.md", "scripts/zigux/validate-phase7.py", "", "zigux/tests/README.md: scripts/zigux/validate-phase7.py"),
        ("tests_readme_phase7_make_wrapper_marker", "zigux/tests/README.md", "scripts/zigux/check-phase7-make-wrapper.py", "", "zigux/tests/README.md: scripts/zigux/check-phase7-make-wrapper.py"),
        ("tests_readme_phase7_argv_split_packet_marker", "zigux/tests/README.md", "scripts/zigux/check-phase7-argv-split-packet.py", "", "zigux/tests/README.md: scripts/zigux/check-phase7-argv-split-packet.py"),
        ("tests_readme_phase7_rbtree_parity_marker", "zigux/tests/README.md", "scripts/zigux/check-phase7-rbtree-parity.py", "", "zigux/tests/README.md: scripts/zigux/check-phase7-rbtree-parity.py"),
        ...
        ("tests_readme_phase7_rbtree_survey_gate_wording", "zigux/tests/README.md", "and the dedicated `zigux/tests/phase7_rbtree_survey.zig` survey gate", "", "zigux/tests/README.md: and the dedicated `zigux/tests/phase7_rbtree_survey.zig` survey gate"),
    ...
    exact_count_cases = [
        ...
        ("review_checklist_phase7_make_wrapper_exact_count", "Documentation/zigux/review-checklist.md", "scripts/zigux/check-phase7-make-wrapper.py", "Documentation/zigux/review-checklist.md: scripts/zigux/check-phase7-make-wrapper.py:expected=1:actual=2"),
        ("review_checklist_phase7_argv_split_packet_exact_count", "Documentation/zigux/review-checklist.md", "scripts/zigux/check-phase7-argv-split-packet.py", "Documentation/zigux/review-checklist.md: scripts/zigux/check-phase7-argv-split-packet.py:expected=1:actual=2"),
        ("review_checklist_phase7_validate_command_exact_count", "Documentation/zigux/review-checklist.md", "`make -C zigux phase7-validate`", "Documentation/zigux/review-checklist.md: `make -C zigux phase7-validate`:expected=1:actual=2"),
        ("review_checklist_phase7_make_command_exact_count", "Documentation/zigux/review-checklist.md", "`make -C zigux phase7`", "Documentation/zigux/review-checklist.md: `make -C zigux phase7`:expected=1:actual=2"),
