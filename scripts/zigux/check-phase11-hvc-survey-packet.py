...
def run_self_test() -> None:
    ...
    try:
        ...
        missing_marker_cases = [
            ...
            (REQUIRED_FILES["verify_helper"], VERIFY_HELPER_MARKERS[12]),
            (REQUIRED_FILES["verify_helper"], VERIFY_HELPER_MARKERS[13]),
            ...
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[3]),
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[4]),
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[5]),
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[6]),
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[7]),
            (REQUIRED_FILES["survey_gate"], SURVEY_GATE_MARKERS[8]),
            ...
            (REQUIRED_FILES["poll_retry_split"], POLL_RETRY_SPLIT_MARKERS[1]),
            (REQUIRED_FILES["poll_retry_split"], POLL_RETRY_SPLIT_MARKERS[2]),
            (REQUIRED_FILES["poll_retry_split"], POLL_RETRY_SPLIT_MARKERS[3]),
            (REQUIRED_FILES["poll_retry_split"], POLL_RETRY_SPLIT_MARKERS[4]),
            (REQUIRED_FILES["poll_retry_split"], POLL_RETRY_SPLIT_MARKERS[5]),
