...
test "lane19 multi-megabyte exact-buffer split keeps a visible CR-led control chunk, trims carriage returns, truncates at NUL, and still reaches the next tail line beyond the old CLI cap" {
