...
def run_self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="zigux_phase8_exec_cmd_packet_") as tmp:
        ...
        mutations = (
            ...
            (EXEC_CMD_SOURCE_PATH, 'test "captureArgv0Path keeps rooted argv0 packets from injecting empty PATH entries" {'),
            (EXEC_CMD_SOURCE_PATH, 'test "buildSearchPath skips the rooted argv0 empty-path edge without double separators" {'),
