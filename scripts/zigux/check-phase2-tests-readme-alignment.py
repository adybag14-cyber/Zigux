...
SCRIPTS_PHASE2_LIVE_SENTENCE = (
    ...
    "`check-phase2-confdata-helper-anchor-alignment.py`, and `check-kconfig-bridge.py` are the live shared scripts-root "
    "Phase 2 helpers on current `master`; the broader `phase2-toolchain`, `phase2-validate`, "
    "`phase2-tools`, `phase2-kconfig`, `phase2-cross`, and `phase2` route inventory plus the "
    "dedicated fixdep, genksyms, manifest, cross-target, confdata-helper-anchor, and bridge checker "
    "packet should stay documented through `Documentation/zigux/phase2-toolchain-bootstrap-notes.md`, "
...
SCRIPTS_PHASE2_KCONFIG_SENTENCE = (
    ...
    "`check-phase2-confdata-helper-anchor-alignment.py`, `Documentation/zigux/phase2-toolchain-bootstrap-notes.md`, "
