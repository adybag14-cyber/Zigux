...
SCRIPTS_PHASE2_LIVE_SENTENCE = (
    ...
    "and `check-phase2-tool-manifest-packets.py` are the live shared scripts-root Phase 2 helpers "
    "on current `master`; the broader `phase2-toolchain`, `phase2-validate`, `phase2-tools`, "
    "`phase2-kconfig`, `phase2-cross`, and `phase2` route inventory plus the dedicated fixdep, "
    "genksyms, manifest, cross-target, and bridge checker packet should stay documented through "
