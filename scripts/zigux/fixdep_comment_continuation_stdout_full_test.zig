...
const target = "sample_comment_continuation_stdout_full.o";
const cmdline = "clang -c zigux/tests/fixtures/fixdep/sample_comment_continuation_source.c -o sample_comment_continuation_stdout_full.o";

const expected_stdout =
    "savedcmd_sample_comment_continuation_stdout_full.o := clang -c zigux/tests/fixtures/fixdep/sample_comment_continuation_source.c -o sample_comment_continuation_stdout_full.o\n\n" ++
    "source_sample_comment_continuation_stdout_full.o := zigux/tests/fixtures/fixdep/sample_comment_continuation_source.rmeta\n\n" ++
    "deps_sample_comment_continuation_stdout_full.o := \\\n" ++
    "  zigux/tests/fixtures/fixdep/sample_comment_continuation_dep.so \\\n" ++
    "\n" ++
    "sample_comment_continuation_stdout_full.o: $(deps_sample_comment_continuation_stdout_full.o)\n\n" ++
    "$(deps_sample_comment_continuation_stdout_full.o):\n";
...
test "runFixdep replays the comment-continuation fixture on the stdout-full target" {
...
test "fixdep main keeps the shared output-write stderr for the comment-continuation fixture" {
