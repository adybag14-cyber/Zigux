...
PHASE9_GAP_SURVEY_NOTE_MODULE_SYMVERS_MARKER = "`Module.symvers`"
PHASE9_GAP_SURVEY_NOTE_CONTRACT_BOUNDARY_MARKER = "`module_symvers_path`, and `depmod_aliases` outside the shared `LoadPlan`"
...
REQUIRED_MARKERS = {
    ...
    PHASE9_GAP_SURVEY_NOTE_PATH: [
        ...
        PHASE9_GAP_SURVEY_NOTE_MODULE_SYMVERS_MARKER,
        PHASE9_GAP_SURVEY_NOTE_CONTRACT_BOUNDARY_MARKER,
    ],
    REVIEW_CHECKLIST_PATH: [
        "`scripts/zigux/check-phase9-build-only-surface.py`",
...
SELF_TEST_REMOVALS = [
    ...
    (PHASE9_GAP_SURVEY_NOTE_PATH, PHASE9_GAP_SURVEY_NOTE_MODULE_SYMVERS_MARKER, 1),
    (PHASE9_GAP_SURVEY_NOTE_PATH, PHASE9_GAP_SURVEY_NOTE_CONTRACT_BOUNDARY_MARKER, 1),
    ...
    (TESTS_README_PATH, DOCS_ROOT_SELFTEST_COMPLETE_EXIT_PARITY_MARKER, 1),
    (TESTS_README_PATH, DOCS_ROOT_LIFECYCLE_BOUNDARY_GUARD_MARKER, 1),
    (TESTS_README_PATH, DOCS_ROOT_TRACE_EVENTS_SUBSTRATE_DRIFT_MARKER, 1),
