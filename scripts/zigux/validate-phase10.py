...
SURVEY_MARKERS = [
    ...
    "keep the current `virtio_input` packet fail-closed around the landed lab-only driver validation evidence while risky transport remains blocked",
    "the roadmap's dual implementations for risky areas stay parked at `blocked_on_risky_transport`",
    "the adjacent shared build-graph follow-through stays parked in `P10-L15`",
    "drivers/virtio/virtio_input.zig",
    "drivers/virtio/virtio_input_probe_preflight.zig",
    "drivers/virtio/virtio_input_verify.zig",
