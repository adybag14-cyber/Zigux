...
def main() -> int:
    ...
    parser.add_argument(
        "--write-sample-root",
        help="Write a minimal sample root that satisfies this checker and exit.",
    )
    ...
    if args.write_sample_root:
        ...
        print("PHASE1_FIXTURE_MANIFEST_ALIGNMENT_SAMPLE_ROOT=written")
        print(f"PHASE1_FIXTURE_MANIFEST_ALIGNMENT_SAMPLE_ROOT_PATH={Path(args.write_sample_root).resolve()}")
        return 0
