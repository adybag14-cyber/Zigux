...
const contracts = [_]FileContract{
    .{ .rel = "zigux/helpers/err_ptr.zig", .markers = &markers_0 },
    .{ .rel = "zigux/helpers/xa_value.zig", .markers = &markers_1 },
    .{ .rel = "zigux/helpers/xarray_slot_view.zig", .markers = &markers_2 },
    .{ .rel = "zigux/tests/phase3_xarray_slot_starter_packet.zig", .markers = &markers_3 },
    .{ .rel = "zigux/tests/phase3_xarray_slot_starter_packet_build.zig", .markers = &markers_4 },
};
