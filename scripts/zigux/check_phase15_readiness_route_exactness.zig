// Ported from check-phase15-readiness-route-exactness.py by port_phase1_guards.py
const std = @import("std");
const Io = std.Io;
const guard = @import("zigux_guard.zig");

pub const pass_marker = "PHASE15_READINESS_ROUTE_EXACTNESS_SELF_TEST=pass";
...
const MANIFEST_REL = "zigux/tests/phase15_readiness_gate_manifest.json";
...
const NOTE_MARKERS = [_][]const u8{
    ...
    "scripts\\zigux/check_phase15_readiness_route_exactness.zig",
};

const NOTE_REL = "Documentation/zigux/phase15-readiness-route-exactness-gap.md";
...
const SURVEY_REL = "Documentation/zigux/phase15-readiness-gate-survey.md";
...
fn collectFailures(
    ...
    {
        const relative_path = "Documentation/zigux/phase15-readiness-route-exactness-gap.md";
        const full_path = try guard.joinPath(allocator, root, relative_path);
        defer allocator.free(full_path);
...
pub fn runSelfTest(io: Io, allocator: std.mem.Allocator) !u8 {
    ...
    try guard.printLine(io, "PHASE15_READINESS_ROUTE_EXACTNESS_SELF_TEST_CASES={d}", .{@as(usize, 1)});
    return 0;
}
...
pub fn main(init: std.process.Init) !void {
    ...
    if (failures.items.len > 0) {
        try guard.printLine(io, "PHASE15_READINESS_ROUTE_EXACTNESS_SELF_TEST=fail", .{});
