...
test "genksyms bridge preserves version side effect before reference limit failure" {
...
test "genksyms bridge counts repeated versions before reference limit failure" {
    const args = [_][]const u8{
        "-VV",
        "--reference",
        "01.symref",
