...
DOCS_README_MARKERS = (
    ...
    "scripts-root kbuild and toolchain reminder set plus the live kconfig bridge helpers and fixture roster",
    ...
    "`make -C zigux phase2`",
    "keep the fixture-backed cross-target, tool-manifest, artifact-tools, and kconfig bridge packet visible from the docs root",
)
...
REVIEW_CHECKLIST_MARKERS = (
    ...
    "`zigux/tests/fixtures/kconfig_bridge/confdata_manifest.json`",
    "`zigux/tests/fixtures/kconfig_bridge/cases.json`",
    "same current directly readable Phase 2 packet",
