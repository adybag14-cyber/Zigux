...
DOCS_README_FORBIDDEN_MARKERS: tuple[str, ...] = ()
...
def collect_issues(root: Path) -> list[tuple[str, str]]:
    ...
    issues.extend(collect_missing_markers(phase2_notes_text, PHASE2_NOTES_MARKERS, "MISSING_PHASE2_NOTES_MARKERS"))
    issues.extend(collect_exact_count_markers(phase2_notes_text, PHASE2_NOTES_EXACT_COUNT_MARKERS, "EXACT_COUNT_PHASE2_NOTES_MARKERS"))
    issues.extend(collect_forbidden_markers(phase2_notes_text, PHASE2_NOTES_FORBIDDEN_MARKERS, "FORBIDDEN_PHASE2_NOTES_MARKERS"))
    issues.extend(collect_missing_markers(review_checklist_text, REVIEW_CHECKLIST_MARKERS, "MISSING_REVIEW_CHECKLIST_MARKERS"))
    issues.extend(collect_exact_count_markers(review_checklist_text, REVIEW_CHECKLIST_EXACT_COUNT_MARKERS, "EXACT_COUNT_REVIEW_CHECKLIST_MARKERS"))
    ...
    issues.extend(collect_exact_count_markers(tests_readme_text, TESTS_README_EXACT_COUNT_MARKERS, "EXACT_COUNT_TESTS_README_MARKERS"))
    issues.extend(collect_forbidden_markers(tests_readme_text, TESTS_README_FORBIDDEN_MARKERS, "FORBIDDEN_TESTS_README_MARKERS"))
    issues.extend(collect_missing_markers(third_party_readme_text, THIRD_PARTY_README_MARKERS, "MISSING_THIRD_PARTY_README_MARKERS"))
    issues.extend(collect_exact_count_markers(third_party_readme_text, THIRD_PARTY_README_EXACT_COUNT_MARKERS, "EXACT_COUNT_THIRD_PARTY_README_MARKERS"))
    issues.extend(collect_forbidden_markers(third_party_readme_text, THIRD_PARTY_README_FORBIDDEN_MARKERS, "FORBIDDEN_THIRD_PARTY_README_MARKERS"))
    return issues
