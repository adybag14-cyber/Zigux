...
MARKERS = {
    "plan_note": [
        ...
        "Keep the already-landed survey, manifest, validation matrix, and teardown companion explicit while the next implementation step stays inside `zigux/tests/phase11_dw_wdt_registration_scaffold.zig` and `drivers/watchdog/dw_wdt.zig`.",
    ],
    "lane_sequencing": [
