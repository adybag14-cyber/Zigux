...
NOTE_MARKERS = [
    ...
    "- the next substantive non-doc move should now remain the manifest-backed live-MMIO validation step, still without widening beyond the bounded platform-backed probe, remove, suspend, resume, and shutdown edges already named by the current packet",
]
