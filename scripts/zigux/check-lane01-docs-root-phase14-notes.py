...
SECTION_ORDER = ("Phase 12 notes", "Phase 14 notes", "## Footer")
...
def check_section_order(root: Path) -> str | None:
    ...
    if positions != sorted(positions):
        return "section_order:Phase12->Phase14->Footer"
    return None
...
def run_self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="zigux_lane01_phase14_") as tmp_dir:
        ...
        order_error = check_section_order(root)
        if order_error != "section_order:Phase12->Phase14->Footer":
...
def main() -> int:
    ...
    print("LANE01_DOCS_ROOT_PHASE14_NOTES_SECTION_ORDER=Phase12->Phase14->Footer")
    return 0
